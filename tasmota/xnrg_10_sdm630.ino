...
const uint16_t sdm630_start_addresses[] {
  ...
  0x0166,  //  +   +   +   kWh  Phase 1 total active energy
  0x0168,  //  +   +   +   kWh  Phase 2 total active energy
  0x016A,  //  +   +   +   kWh  Phase 3 total active energy
  ...
  if (data_ready) {
    ...
    if (error) {
      ...
      switch(Sdm630.read_state) {
        ...
        case 16:
          Energy.imp_active[0] = value;
          break;

        case 17:
          Energy.imp_active[1] = value;
          break;

        case 18:
          Energy.imp_active[2] = value;
          break;

        case 19:
          Energy.exp_active[0] = value;
          break;

        case 20:
          Energy.exp_active[1] = value;
          break;

        case 21:
          Energy.exp_active[2] = value;
          break;

        case 22:
          Energy.tot_active[0] = value;
          break;

        case 23:
          Energy.tot_active[1] = value;
          break;

        case 24:
          Energy.tot_active[2] = value;
          break;
