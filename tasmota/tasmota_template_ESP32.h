...
enum UserSelectablePins {
  ...
  GPIO_MAX6675CS, GPIO_MAX6675CLK, GPIO_MAX6675DO,  // MAX6675 Serial interface
...
#endif
#ifdef USE_MAX6675
  AGPIO(GPIO_MAX6675CS),     // MAX6675 Serial interface
  AGPIO(GPIO_MAX6675CLK),    // MAX6675 Serial interface
  AGPIO(GPIO_MAX6675DO),     // MAX6675 Serial interface
#endif
#ifdef USE_MAX31855
