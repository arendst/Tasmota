...
enum Z_offsets {
  ...
  Zo_Panic = 4619,
  Zo_GlassBreak = 4625,
  Zo_CurrentSummDelivered = 4636,
  Zo_CompanyName = 4657,
  Zo_MeterTypeID = 4669,
  Zo_DataQualityID = 4681,
  Zo_CustomerName = 4695,
  Zo_Model = 4708,
  Zo_PartNumber = 4714,
  Zo_ProductRevision = 4725,
  Zo_SoftwareRevision = 4741,
  Zo_UtilityName = 4758,
  Zo_POD = 4770,
  Zo_AvailablePower = 4774,
  Zo_PowerThreshold = 4789,
  Zo_RMSVoltage = 4804,
  Zo_RMSCurrent = 4815,
  Zo_ActivePower = 4826,
  Zo_NumberOfResets = 4838,
  Zo_PersistentMemoryWrites = 4853,
  Zo_LastMessageLQI = 4876,
