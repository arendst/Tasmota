...
enum Z_offsets {
  ...
  Zo_Leak = 4582,
  Zo_CO = 4587,
  Zo_PersonalAlarm = 4590,
  Zo_Movement = 4604,
  Zo_Panic = 4613,
  Zo_GlassBreak = 4619,
  Zo_CurrentSummDelivered = 4630,
  Zo_CompanyName = 4651,
  Zo_MeterTypeID = 4663,
  Zo_DataQualityID = 4675,
  Zo_CustomerName = 4689,
  Zo_Model = 4702,
  Zo_PartNumber = 4708,
  Zo_ProductRevision = 4719,
  Zo_SoftwareRevision = 4735,
  Zo_UtilityName = 4752,
  Zo_POD = 4764,
  Zo_AvailablePower = 4768,
  Zo_PowerThreshold = 4783,
  Zo_RMSVoltage = 4798,
  Zo_RMSCurrent = 4809,
  Zo_ActivePower = 4820,
  Zo_NumberOfResets = 4832,
  Zo_PersistentMemoryWrites = 4847,
  Zo_LastMessageLQI = 4870,
  Zo_LastMessageRSSI = 4885,
  Zo_TuyaScheduleWorkdays = 4901,
  Zo_TuyaScheduleHolidays = 4922,
  Zo_TuyaChildLock = 4943,
  Zo_TuyaWindowDetection = 4957,
  Zo_TuyaValveDetection = 4977,
  Zo_TuyaAutoLock = 4996,
  Zo_TuyaTempTarget = 5009,
  Zo_TuyaBattery = 5024,
  Zo_TuyaMinTemp = 5036,
  Zo_TuyaMaxTemp = 5048,
  Zo_TuyaBoostTime = 5060,
  Zo_TuyaComfortTemp = 5074,
  Zo_TuyaEcoTemp = 5090,
  Zo_TuyaValvePosition = 5102,
  Zo_TuyaAwayTemp = 5120,
  Zo_TuyaAwayDays = 5133,
  Zo_TuyaPreset = 5146,
  Zo_TuyaFanMode = 5157,
  Zo_TuyaForceMode = 5169,
  Zo_TuyaWeekSelect = 5183,
  Zo_TerncyDuration = 5198,
  Zo_TerncyRotate = 5213,
  Zo_Identify = 5226,
  Zo_xxxx = 5235,
  Zo_IdentifyQuery = 5240,
  Zo_AddGroup = 5254,
  Zo_xxxx00 = 5263,
  Zo_ViewGroup = 5270,
  Zo_GetGroup = 5280,
  Zo_01xxxx = 5289,
  Zo_GetAllGroups = 5296,
  Zo_00 = 5309,
  Zo_RemoveGroup = 5312,
  Zo_RemoveAllGroups = 5324,
  Zo_ViewScene = 5340,
  Zo_xxxxyy = 5350,
  Zo_RemoveScene = 5357,
  Zo_RemoveAllScenes = 5369,
  Zo_RecallScene = 5385,
  Zo_GetSceneMembership = 5397,
  Zo_PowerOffEffect = 5416,
  Zo_xxyy = 5431,
  Zo_PowerOnRecall = 5436,
  Zo_PowerOnTimer = 5450,
  Zo_xxyyyyzzzz = 5463,
  Zo_xx0A00 = 5474,
  Zo_DimmerUp = 5481,
  Zo_00190200 = 5490,
  ...
  Zo_ResetAlarm = 5530,
  Zo_xxyyyy = 5541,
  Zo_ResetAllAlarms = 5548,
  Zo_xx000A00 = 5563,
  Zo_HueSat = 5572,
  Zo_xxyy0A00 = 5579,
  Zo_Color = 5588,
  Zo_xxxxyyyy0A00 = 5594,
  Zo_xxxx0A00 = 5607,
  Zo_ShutterOpen = 5616,
  Zo_ShutterClose = 5628,
  Zo_ShutterStop = 5641,
  Zo_ShutterLift = 5653,
  Zo_xx = 5665,
  Zo_ShutterTilt = 5668,
  ...
  Zo_DimmerMove = 5688,
  Zo_xx0A = 5699,
  Zo_DimmerStepUp = 5704,
  Zo_00xx0A00 = 5717,
  Zo_DimmerStepDown = 5726,
  Zo_01xx0A00 = 5741,
  Zo_DimmerStep = 5750,
  Zo_xx190A00 = 5761,
  Zo_01 = 5770,
  ...
  Zo_xxxxyyyy = 5858,
  Zo_ColorStep = 5867,
  Zo_ColorTempMoveUp = 5877,
  Zo_01xxxx000000000000 = 5893,
  Zo_ColorTempMoveDown = 5912,
  Zo_03xxxx000000000000 = 5930,
  Zo_ColorTempMoveStop = 5949,
  Zo_00xxxx000000000000 = 5967,
  Zo_ColorTempMove = 5986,
  Zo_xxyyyy000000000000 = 6000,
  Zo_ColorTempStepUp = 6019,
  Zo_01xxxx0A0000000000 = 6035,
  Zo_ColorTempStepDown = 6054,
  Zo_03xxxx0A0000000000 = 6072,
  Zo_ColorTempStep = 6091,
  Zo_xxyyyy0A0000000000 = 6105,
  Zo_ArrowClick = 6124,
  Zo_ArrowHold = 6135,
  Zo_ArrowRelease = 6145,
  Zo_ZoneStatusChange = 6158,
  Zo_xxxxyyzz = 6175,
  Zo_xxyyzzzz = 6184,
  Zo_AddScene = 6193,
  Zo_xxyyyyzz = 6202,
