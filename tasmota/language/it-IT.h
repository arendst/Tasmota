...
#define D_RESTORE_CONFIGURATION "Ripristino backup impostazioni"
...
#define D_START_UPGRADE "Aggiorna firmware"
#define D_UPGRADE_BY_FILE_UPLOAD "Aggiornamento con file locale"
