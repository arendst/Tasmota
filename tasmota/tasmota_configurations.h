...
#define USE_WE517                                 // Add support for ORNO WE517-Modbus energy monitor (+0k6 code)
...
#undef USE_ENERGY_SENSOR                         // Disable energy sensors (-14k code)
  ...
  #undef USE_WE517                               // Disable support for ORNO WE517-Modbus energy monitor (+0k6 code)
