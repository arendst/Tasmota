...
void DS3231EverySecond(void)
{
  ...
  if (!ds3231WriteStatus && Rtc.utc_time > START_VALID_TIME && abs((int32_t)(Rtc.utc_time - ReadFromDS3231())) > 60) {//if time is valid and is drift from RTC in more that 60 second
  #else
