...
const char ZB_WEB_U[] PROGMEM =
    ...
    // +++++++++++++++++++++++++++++++++++++++++++++++++++++++
    // index 1
    // Thin horizontal line to separate devices
    //=ZB_WEB_HR_THIN
    "<tr><td colspan=4 style='font-size:2px'><hr size=1></td></tr>"
...
enum {
  ZB_WEB_CSS=0,
  ZB_WEB_HR_THIN=495,
  ZB_WEB_VIS_JS_BEFORE=557,
  ZB_WEB_VIS_JS_AFTER=1030,
  ZB_WEB_AUTO_REFRESH=1094,
  ZB_WEB_MAP_REFRESH=1160,
  ZB_WEB_STATUS_LINE=1226,
  ZB_WEB_BATTERY=1334,
  ZB_WEB_GP=1406,
  ZB_WEB_LAST_SEEN=1462,
  ZB_WEB_COLOR_RGB=1510,
  ZB_WEB_LINE_START=1570,
  ZB_WEB_LIGHT_CT=1608,
  ZB_WEB_END_STATUS=1663,
  ZB_WEB_LINE_END=1680,
};

// Compressed from 1692 to 1150, -32.0%
const char ZB_WEB[] PROGMEM = "\x00\x6A\x3D\x0E\xCA\xB1\xC1\x33\xF0\xF4\xF5\x19\x04\xCF\xC3\xA1\xB6\x84\x54\x21"
                             ...
                             "\x3C\xCE\x87\x2C\xF7\x1E\x87\x61\x02\x0F\x27\x07\xB6\x8F\x74\xE1\x7C\xF4\xAF\x9F"
                             "\x87\xA5\x08\x83\xC0\xBC\x32\xF8\xF8\x73\x0E\xE1\x7A\x8C\x82\x67\xC3\xEC\x11\x79"
                             "\x30\x39\x44\x30\xD8\x7D\x9F\x87\xA0\xAF\xAF\x69\xB5\x9F\x0E\x43\xF0\xF4\x3B\x0A"
                             "\x84\x3F\x0F\x43\xB2\xBE\x7E\x4E\x17\xCF\x4F\x07\xFD\x19\x4A\x8C\x86\x33\xE1\xEC"
                             "\xA6\x6C\xA3\xB0\xD7\x66\x76\x08\x34\x8F\x62\xF7\xC3\x3E\x1E\xC1\x55\x43\x3C\x79"
                             "\x9D\x87\x60\xBE\x18\x68\x3C\x74\x0F\x06\x9D\x86\x7B\xE3\xAF\x9D\x0F\xE7\xCD\x0E"
                             "\xCF\x55\xF0\x96\x16\x73\x3B\x05\x8D\x10\x11\xEB\x9D\x06\xEF\x1D\x0D\x7E\x3D\x87"
                             "\xE1\xE8\x76\x02\x0E\x58\x7E\x1E\x82\x69\x9A\xD1\x0F\x87\xB0\x69\x90\x21\x60\x07"
                             "\xB0\x10\xB8\x0A\x3D\x80\x99\xC4\xF9\xE4\x60\xC1\x83\xC0\x21\x47\x38\xDB\x20\x42"
                             "\xE6\x40\xE7\xDB\x21\x86\xC0\x43\xE4\x44\xE6\x36\x40\x89\xC7\x58\x23\x73\x12\x16"
                             "\x8F\x0A\xA1\xEF\xD9\x91\xE3\xEF\xDA\x6D\x67\x98\xEC\xA1\x47\x83\xD8\x7E\x10\xBE"
                             "\xB1\xC1\x35\x58\x82\xCB\x11\x19\xEF\x8E\x86\xBF\x1E\x87\x60\x9A\x66\x7E\x02\xCF"
                             "\x0C\x67\xE1\x9D\xFD\x07\x9D\x57\xBC\xFE\x7C\x13\x03\x16\x35\xF5\x1D\x07\x9D\x13"
                             "\x09\x8D\x7D\x44\x38\xC8\xB4\x43\xBA\x08\xDC\x19\x1D\xE3\xC1\x9D\xFD\x60\xCA\xDC"
                             "\xEF\x1F\x0F\x68\xF7\xF0\x58\xCF\x1E\x67\xB7\x0F\x33\xDB\xE1\x56\x31\x9E\x67\xB0"
                             "\x3D\xF8\x61\x33\xD8\x75\x02\x0F\x07\xA7\xB0\xF2\x10\xE6\xE9\xEC\x3D\xC7\x51\x7C"
                             "\x11\x2E\x0E\xC3\x60\x22\xD9\x30\x38\xE7\x8F\x61\xEE\x3A\x89\x82\x25\x96\x10\x5A"
                             "\x33\xC0\x8D\x8D\x58\x86\x0F\x61\xEE\x3D\xC7\xB8\xF0\x67\x7F\x42\x5D\x59\xF0\xF6"
                             "\xCE\x17\xC1\x06\x48\x21\x6D\x87\xCE\x63\xE8\xCF\x7C\x74\x2E\x04\x19\x87\x74\x11"
                             "\x38\x29\x3A\x84\xBA\xB3\xA8\x10\xB8\x05\x3B\xC7\x80\x44\xE4\x18\x10\xF9\x75\x3F"
                             "\x3C\xE8\xAB\x46\xBC\x17\x47\x74\xC0\xBE\x0E\xB7\x38\xEE\x9D\xE3\xDA\x16\x07\x75"
                             "\xB9\xC7\x4F\xB0\xB2\xC4\x3B\xA7\x78\xF0\x7B\x8E\xA3\x91\x26\x40\x91\x8F\x0C\x3F"
                             "\x0F\x43\xB0\x61\xF8\x7A\x18\xCF\x8D\x56\x1D\x6E\x71\xF0\xFB\x36\x8E\xF9\xF6\x86"
                             "\xBA\x15\x82\x1F\x0F\xB1\xE7\x47\xD9\xF8\x7A\x0E\x17\x55\x9C\x7E\x1F\x5E\x3D\x0E"
                             "\xC0\x42\x8E\x7A\x1D\x86\x33\xE3\x4F\xC9\xC2\xF9\xE9\x5F\x41\x85\x7E\xF1\xF0\xFB"
                             "\x36\xD0\x88\x55\x7C\xFB\x3F\x0F\x4A\x10\xFC\x3D\x07\x2A\x2B\xDA\x09\x9F\x0F\xB3"
                             "\x8C\x8D\x87\xD1\xC7\x84\x46\xC4\x7D\x79\x1D\x68\xFA\xF1\xF6\x08\x39\x08\x21\x74"
                             "\x0F\x28\x43\xF0\xFA\xF0\x22\x47\x3D\x04\xD3\x30\x43\xC4\x88\x22\x35\x16\xA3\xEB"
                             "\xC7\xD8\x21\xE7\x1E\xD3\xEC\xFC\x9C\x2F\x9E\x9A\x08\x52\xCF\x60\xEA\x3D\x80\x85"
                             "\x82\x9E\xC3\xE8\x43\xE8\xFA\x3E\xBC\x08\x9D\x2A\x01\x03\xAC\xEB\x1C\x11\xE6\x7D"
                             "\x08\x30\xD8\x08\x7C\xFA\x1F\x47\x1D\x11\xB0\xFA\x38\xE8\x8D\x87\xD1\xC7\x44\x6C"
                             "\x3D\x87\xE1\xE8\x76\x69\xF9\x38\x5F\x3D\x3C\x32\xF8\x10\xF4\x52\x1E\xFB\x7C\x88"
                             "\x66\x0F\xBF\x9F\x60\x87\xD0\xF3\x04\x2C\x5C\xE6\x11\x18\x39\x87\x83\xEC\xFC\x22"
                             "\x1E\x21\x87\xA1\xD9\xE1\x97\xC7\xE4\xE1\x7C\xF4\xA1\x01\x0F\x43\x05\x0C\xE4\xFD"
                             "\x1E\x46\xC3\x90\x88\xC1\xCD\xDF\x1E\x0F\xA7\x44\x21\xF4\x1C\xE1\x7D\x02\x37\x01"
                             "\xA6\xC0\x46\xDF\x83\x08\xF3\x3C\x8F\xA3\x8E\x88\x8D\x87\xD1\xC7\x44\x46\xC3\xE8"
                             "\xE3\xA2\x23\x60\x20\xEE\x60\x91\x3C\x11\xF8\xB4\x04\x3E\x2C\x01\x17\xA3\x36\x7E"
                             "\x1F\xA3\xC8\xE2\xCF\x7C\xF0\x53\x85\xF4\x08\xFC\x13\x9E\xC2\x0C\xA9\x1F\x42\x1E"
                             "\xC3\xF0\xF4\xF0\xDB\x08\x23\xF0\xFD\x1E\x47\x17\xD7\xCF\x07\x70\xF4\x3B\x08\x10"
                             "\x66\x1F\x42\x11\xA0\x22\x70\x4A\x08\x3D\x0A\xD3\xB2\x84\x3F\x0F\xAF\x1E\xD6\x7B"
                             "\xA7\x0B\xE0\x87\xD3\xEC\x3D\xB4\x7B\xA7\x0B\xE6";
  ...
  if (json) {
    ...
    if ((zigbee_num > 0) && (!zigbee.init_phase)) {     // don't displays devices on UI if still in initialization phase
      ...
      for (uint32_t i = 0; i < zigbee_num; i++) {
        ...
        WSContentSend_P(msg[ZB_WEB_HR_THIN]);
