...
const char ZB_WEB_U[] PROGMEM =
    ...
    // +++++++++++++++++++++++++++++++++++++++++++++++++++++++
    //=ZB_WEB_BATTERY
    "<div title=\"%d%%%s\"><i class=\"bt\" style=\"--bl:%dpx;color:#%02x%02x%02x\"></i></div>"
    "\0"
    // +++++++++++++++++++++++++++++++++++++++++++++++++++++++
    //=ZB_WEB_GP
...
enum {
  ...
  ZB_WEB_BATTERY=1457,
  ZB_WEB_GP=1540,
  ZB_WEB_LAST_SEEN=1596,
  ZB_WEB_COLOR_RGB=1644,
  ZB_WEB_LINE_START=1705,
  ZB_WEB_LIGHT_CT=1743,
  ZB_WEB_END_STATUS=1799,
  ZB_WEB_LINE_END=1816,
};

// Compressed from 1828 to 1211, -33.8%
const char ZB_WEB[] PROGMEM = "\x00\x73\x3D\x0E\xCA\xB1\xC1\x33\xF0\xF4\xF5\x19\x04\xCF\xC1\xC2\xEA\xB3\x8F\x31"
                             ...
                             "\xF4\x1C\xAB\x68\x26\x7C\x3E\xCE\x32\x36\x1F\x47\x1E\x11\x1B\x11\xF5\xE3\x71\xF5"
                             "\xE3\xEC\x10\x71\xF3\xF0\xF4\x3B\x28\x43\xF0\xF4\xA1\x0F\xC3\xEB\xC0\x89\x1C\xF4"
                             "\x13\x4C\xC1\x0F\x10\x20\x88\xD4\x5A\x8F\xAF\x1F\x60\x87\x9B\x7B\x4F\xB3\xF2\x70"
                             "\xBE\x08\xD7\x0F\x61\xF4\x21\xF4\x7D\x1F\x5E\x3D\x87\xE1\xE9\xA0\x85\x7C\xF6\x0E"
                             "\xA3\xD8\x08\x5D\x0A\x63\xD8\x75\x9D\x63\x82\x3C\xCF\xA1\x06\x1B\x01\x0B\xA1\x24"
                             "\x79\x1F\x47\x1D\x11\xB0\xFA\x38\xE8\x8D\x87\xD1\xC7\x44\x6C\x3D\x87\xE1\xE8\x76"
                             "\x69\xF8\x08\x3D\x04\x69\xC2\xF9\xE9\xE1\x97\xC0\x87\xA8\x10\xF7\xDB\xE4\x43\x30"
                             "\x7D\xFC\x11\x3A\x1E\x20\x85\x8E\x9C\xC2\x23\x07\x30\xF0\x7D\x9F\x84\x43\xC4\x30"
                             "\xF4\x3B\x3C\x32\xF8\xFC\x9C\x2F\x9E\x94\x20\x21\xE9\x20\xA1\x9F\x9F\xA3\xC8\xD8"
                             "\x72\x11\x18\x39\xBB\xE3\xC1\xF4\xE8\x84\x3E\x83\x9C\x2F\xA0\x46\xE0\x10\xD8\x08"
                             "\xDC\x02\x06\x11\xE6\x79\x1F\x47\x1D\x11\x1B\x0F\xA3\x8E\x88\x8D\x87\xD1\xC7\x44"
                             "\x46\xC0\x41\xDE\x50\x24\x50\x04\x7E\x2F\x81\x0F\x8B\xA4\x1E\x05\xE1\x97\xC7\xC3"
                             "\x98\x7E\x1F\xA3\xC9\x67\xBE\x78\x29\xC2\xFA\x04\x7E\x0A\x0F\x61\x06\x54\x8F\xA1"
                             "\x0F\x61\xF8\x7A\x78\x6D\x84\x11\xF8\x7E\x8F\x23\x8B\xEB\xE7\x83\xB8\x7A\x1D\x84"
                             "\x08\x33\x0F\xA1\x0F\xAF\x02\x27\x04\xE0\x83\xD1\x50\x3B\x28\x43\xF0\xFA\xF1\xED"
                             "\x67\xBA\x70\xBE\x08\x7D\x47\x43\xDB\x47\xBA\x70\xBE";
