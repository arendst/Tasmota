...
/* rework 2022-04-03 SH:
  ...
  2/ try to observe to 'tuya' state macine as per thier documentation.
...
void TuyaDump(unsigned char *buffer, int len){
  ...
  AddLog(LOG_LEVEL_DEBUG, 
    PSTR("TYA: Raw Data: %s"), ToHex_P(buffer, len, hex_char, sizeof(hex_char)));
}
