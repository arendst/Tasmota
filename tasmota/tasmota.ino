...
float global_temperature = NAN;             // Provide a global temperature (Celsius) to be used by some sensors
float global_humidity = 0.0f;               // Provide a global humidity to be used by some sensors
float global_pressure = 0.0f;               // Provide a global pressure (hPa) to be used by some sensors
