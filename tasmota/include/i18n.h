...
const char HTTP_SNS_CUBIC_METER[]   PROGMEM = "{s}%s "  D_TOTAL_USAGE         "{m}%s " D_UNIT_CUBIC_METER         "{e}";
const char HTTP_SNS_CPH[]           PROGMEM = "{s}%s "  D_FLOW_RATE           "{m}%s " D_UNIT_CUBICMETER_PER_HOUR "{e}";
