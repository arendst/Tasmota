...
typedef struct {
  ...
  uint8_t       shutter_options[MAX_SHUTTERS];       // E78 (ESP8266 only) – bit1: INVERT (1)  bit2: LOCK (2)  bit3: ExtraOpenEndStopTime (4)  bit4: INVert WebButtons (8)  bit4: ExtraCloseEndStopTime (16)
