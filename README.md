...
Verify source and upload once to sonoff using the serial connection as shown in [Peter Scargill's blog](http://tech.scargill.net/itead-slampher-and-sonoff) ![Connection diagram](https://github.com/arendst/arendst.hithub.io/blob/master/media/ProgramESP8266.jpg). **Do not connect AC power during the flash cable connection**. 
