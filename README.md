...
- Automatic set of MQTT_MAX_PACKET_SIZE (on compiling time) so there is no need of modifying another library. (#1) Thanks @ascillato (in Tasmota since 5.12.0d, default to 1000)
