...
void br_x509_decoder_run_libmail(void *t0ctx);
...
/* see bearssl_x509.h */
void
br_x509_decoder_init_libmail(br_x509_decoder_context_libmail *ctx,
	...
	void *append_dn_ctx)
{
	...
	*/
	...
	br_x509_decoder_run_libmail(&ctx->cpu);
}

/* see bearssl_x509.h */
void
br_x509_decoder_push_libmail(br_x509_decoder_context_libmail *ctx,
...
static const unsigned char t0_codeblock[] = {
	...
	T0_INT2(offsetof(br_x509_decoder_context_libmail, pkey_data)), 0x01,
...
T0_DEFENTRY(br_x509_decoder_init_main_libmail, 92)

#define T0_NEXT(t0ipp)   (*(*(t0ipp)) ++)

void
br_x509_decoder_run_libmail(void *t0ctx)
{
	uint32_t *dp, *rp;
	const unsigned char *ip;
