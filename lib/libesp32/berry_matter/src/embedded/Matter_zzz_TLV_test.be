...
var TLV = matter.TLV
assert(TLV.create_TLV(0x08 #-TLV.BOOL-#, 1).tlv2raw() == bytes("09"))
assert(TLV.create_TLV(0x08 #-TLV.BOOL-#, true).tlv2raw() == bytes("09"))
assert(TLV.create_TLV(0x08 #-TLV.BOOL-#, 0).tlv2raw() == bytes("08"))
assert(TLV.create_TLV(0x08 #-TLV.BOOL-#, false).tlv2raw() == bytes("08"))
