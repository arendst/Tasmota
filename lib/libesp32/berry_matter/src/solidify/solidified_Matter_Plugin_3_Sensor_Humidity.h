...
// compact class 'Matter_Plugin_Sensor_Humidity' ktab size: 14, total: 16 (saved 16 bytes)
static const bvalue be_ktab_class_Matter_Plugin_Sensor_Humidity[14] = {
  ...
  /* K13  */  be_nested_str_weak(_X26_X23x1F4A7_X3B_X20_X252_X2E0f_X25_X25),
};
...
be_local_closure(class_Matter_Plugin_Sensor_Humidity_read_attribute,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[39]) {  /* code */
      ...
      0x5426270F,  //  001B  LDINT	R9	10000
