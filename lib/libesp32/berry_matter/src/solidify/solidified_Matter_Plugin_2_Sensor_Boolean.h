...
static const bvalue be_ktab_class_Matter_Plugin_Sensor_Boolean[21] = {
  ...
  /* K2   */  be_nested_str_weak(JSON_NAME),
  /* K3   */  be_nested_str_weak(value_updated),
  ...
  /* K11  */  be_nested_str_weak(Status_X2010),
  /* K12  */  be_nested_str_weak(find),
  /* K13  */  be_nested_str_weak(StatusSNS),
  /* K14  */  be_nested_str_weak(contains),
  /* K15  */  be_nested_str_weak(ON),
  /* K16  */  be_nested_str_weak(init),
  /* K17  */  be_nested_str_weak(parse_configuration),
  /* K18  */  be_nested_str_weak(switch),
  /* K19  */  be_const_int(1),
  /* K20  */  be_const_int(0),
};
...
be_local_closure(class_Matter_Plugin_Sensor_Boolean_update_shadow,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[41]) {  /* code */
      ...
      0xB80A1200,  //  000B  GETNGBL	R2	K9
      0x8C08050A,  //  000C  GETMET	R2	R2	K10
      0x5810000B,  //  000D  LDCONST	R4	K11
      ...
      0x8C0C050C,  //  0013  GETMET	R3	R2	K12
...
be_local_closure(class_Matter_Plugin_Sensor_Boolean_parse_status,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[26]) {  /* code */
      ...
      0x8C10030C,  //  0004  GETMET	R4	R1	K12
      0x60180008,  //  0005  GETGBL	R6	G8
      0x881C0108,  //  0006  GETMBR	R7	R0	K8
      0x7C180200,  //  0007  CALL	R6	1
      0x001A0E06,  //  0008  ADD	R6	K7	R6
      0x7C100400,  //  0009  CALL	R4	2
      0x1C10090F,  //  000A  EQ	R4	R4	K15
      ...
      0x90020003,  //  0018  SETMBR	R0	K0	R3
...
be_local_closure(class_Matter_Plugin_Sensor_Boolean_parse_configuration,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[18]) {  /* code */
      ...
      0x58140012,  //  0008  LDCONST	R5	K18
      0x58180013,  //  0009  LDCONST	R6	K19
      0x7C0C0600,  //  000A  CALL	R3	3
      0x7C080200,  //  000B  CALL	R2	1
      0x90021002,  //  000C  SETMBR	R0	K8	R2
      0x88080108,  //  000D  GETMBR	R2	R0	K8
      0x18080514,  //  000E  LE	R2	R2	K20
      0x780A0000,  //  000F  JMPF	R2	#0011
      0x90021113,  //  0010  SETMBR	R0	K8	K19
      0x80000000,  //  0011  RET	0
    })
  )
);
...
be_local_class(Matter_Plugin_Sensor_Boolean,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key_weak(SCHEMA, 7), be_nested_str_weak(switch_X7Cl_X3ASwitch_X7Ct_X3Ai_X7Ch_X3ASwitch_X3Cx_X3E_X20number_X7Cr_X3A1) },
        ...
        { be_const_key_weak(init, -1), be_const_closure(class_Matter_Plugin_Sensor_Boolean_init_closure) },
