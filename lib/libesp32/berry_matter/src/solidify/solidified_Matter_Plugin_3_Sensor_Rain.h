...
// compact class 'Matter_Plugin_Sensor_Rain' ktab size: 18, total: 23 (saved 40 bytes)
static const bvalue be_ktab_class_Matter_Plugin_Sensor_Rain[18] = {
  ...
  /* K9   */  be_nested_str_weak(Rain_X25i_X20_X25s),
