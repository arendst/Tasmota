...
be_local_class(Matter_Plugin,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key_weak(read_event, 17), be_const_closure(Matter_Plugin_read_event_closure) },
        { be_const_key_weak(invoke_request, 12), be_const_closure(Matter_Plugin_invoke_request_closure) },
        { be_const_key_weak(tick, 18), be_const_var(4) },
        { be_const_key_weak(write_attribute, 37), be_const_closure(Matter_Plugin_write_attribute_closure) },
        ...
        { be_const_key_weak(contains_cluster, 20), be_const_closure(Matter_Plugin_contains_cluster_closure) },
        { be_const_key_weak(ack_request, 27), be_const_closure(Matter_Plugin_ack_request_closure) },
        ...
        { be_const_key_weak(set_name, 26), be_const_closure(Matter_Plugin_set_name_closure) },
    ...
    ( (struct bvalue*) &(const bvalue[]) {
        ...
        { be_const_key_weak(get_cluster_list, 32), be_const_closure(Matter_Plugin_get_cluster_list_closure) },
        ...
        { be_const_key_weak(contains_attribute, 34), be_const_closure(Matter_Plugin_contains_attribute_closure) },
        ...
        { be_const_key_weak(update_shadow, 39), be_const_closure(Matter_Plugin_update_shadow_closure) },
        ...
        { be_const_key_weak(is_local_device, -1), be_const_closure(Matter_Plugin_is_local_device_closure) },
        { be_const_key_weak(attribute_updated, -1), be_const_closure(Matter_Plugin_attribute_updated_closure) },
        { be_const_key_weak(clusters, 4), be_const_var(3) },
    })),
