...
// compact class 'Matter_Commisioning_Context' ktab size: 184, total: 361 (saved 1416 bytes)
static const bvalue be_ktab_class_Matter_Commisioning_Context[184] = {
  ...
  /* K125 */  be_nested_str_weak(MTR_X3A_X20Sigma3_X20verified_X2C_X20computing_X20new_X20keys),
  /* K126 */  be_nested_str_weak(Msg3),
  /* K127 */  be_nested_str_weak(close),
  /* K128 */  be_nested_str_weak(_breadcrumb),
  /* K129 */  be_nested_str_weak(counter_snd_next),
  /* K130 */  be_nested_str_weak(set_persist),
  /* K131 */  be_nested_str_weak(set_no_expiration),
  /* K132 */  be_nested_str_weak(persist_to_fabric),
  /* K133 */  be_nested_str_weak(save),
  /* K134 */  be_nested_str_weak(is_commissioning_open),
  /* K135 */  be_nested_str_weak(MTR_X3A_X20commissioning_X20not_X20open),
  /* K136 */  be_nested_str_weak(parse_PBKDFParamRequest),
  /* K137 */  be_nested_str_weak(parse_Pake1),
  /* K138 */  be_nested_str_weak(parse_Pake3),
  /* K139 */  be_nested_str_weak(parse_Sigma1),
  /* K140 */  be_nested_str_weak(parse_Sigma3),
  /* K141 */  be_nested_str_weak(parse_StatusReport),
  /* K142 */  be_nested_str_weak(MTR_X3A_X20_X3E_X3F_X3F_X3F_X3F_X3F_X3F_X3F_X3F_X3F_X20Unknown_X20OpCode_X20_X28secure_X20channel_X29_X20_X2502X),
  /* K143 */  be_nested_str_weak(Sigma1),
  /* K144 */  be_nested_str_weak(initiatorEphPubKey),
  /* K145 */  be_nested_str_weak(resumptionID),
  /* K146 */  be_nested_str_weak(initiatorResumeMIC),
  /* K147 */  be_nested_str_weak(find_session_by_resumption_id),
  /* K148 */  be_nested_str_weak(_fabric),
  ...
  /* K171 */  be_nested_str_weak(B2),
  /* K172 */  be_nested_str_weak(get_noc),
  /* K173 */  be_nested_str_weak(get_icac),
  /* K174 */  be_nested_str_weak(ecdsa_sign_sha256),
  /* K175 */  be_nested_str_weak(get_pk),
  /* K176 */  be_nested_str_weak(Msg1),
  /* K177 */  be_nested_str_weak(S2K_Info),
  /* K178 */  be_nested_str_weak(TBEData2_Nonce),
  /* K179 */  be_nested_str_weak(encrypt),
  /* K180 */  be_nested_str_weak(Sigma2),
  /* K181 */  be_nested_str_weak(responderEphPubKey),
  /* K182 */  be_nested_str_weak(encrypted2),
  /* K183 */  be_nested_str_weak(MTR_X3A_X20New_X20Connection_X20_X28CASE_X20id_X3D_X25i_X29_X20from_X20_X5B_X25s_X5D_X3A_X25i),
};
...
be_local_closure(class_Matter_Commisioning_Context_parse_Sigma3,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[286]) {  /* code */
      ...
      0x58640023,  //  00C3  LDCONST	R25	K35
      0x58680022,  //  00C4  LDCONST	R26	K34
      0x7C600400,  //  00C5  CALL	R24	2
      0x8C600124,  //  00C6  GETMET	R24	R0	K36
      0x5C680200,  //  00C7  MOVE	R26	R1
      0x586C0025,  //  00C8  LDCONST	R27	K37
      0x5870001F,  //  00C9  LDCONST	R28	K31
      0x58740022,  //  00CA  LDCONST	R29	K34
      0x50780000,  //  00CB  LDBOOL	R30	0	0
      0x7C600C00,  //  00CC  CALL	R24	6
      0x50600000,  //  00CD  LDBOOL	R24	0	0
      0x80043000,  //  00CE  RET	1	R24
      0xB8620A00,  //  00CF  GETNGBL	R24	K5
      0x5864007D,  //  00D0  LDCONST	R25	K125
      0x58680008,  //  00D1  LDCONST	R26	K8
      0x7C600400,  //  00D2  CALL	R24	2
      0x8C60054D,  //  00D3  GETMET	R24	R2	K77
      0x7C600200,  //  00D4  CALL	R24	1
      0x8C603116,  //  00D5  GETMET	R24	R24	K22
      0x8868072A,  //  00D6  GETMBR	R26	R3	K42
      0x7C600400,  //  00D7  CALL	R24	2
      0x8C603116,  //  00D8  GETMET	R24	R24	K22
      0x8868073F,  //  00D9  GETMBR	R26	R3	K63
      0x7C600400,  //  00DA  CALL	R24	2
      0x8C603116,  //  00DB  GETMET	R24	R24	K22
      0x8868097E,  //  00DC  GETMBR	R26	R4	K126
      0x7C600400,  //  00DD  CALL	R24	2
      0x8C603117,  //  00DE  GETMET	R24	R24	K23
      0x7C600200,  //  00DF  CALL	R24	1
      0x5C143000,  //  00E0  MOVE	R5	R24
      0x4C600000,  //  00E1  LDNIL	R24
      0x900E5418,  //  00E2  SETMBR	R3	K42	R24
      0x4C600000,  //  00E3  LDNIL	R24
      0x900E7E18,  //  00E4  SETMBR	R3	K63	R24
      0x8C600560,  //  00E5  GETMET	R24	R2	K96
      0x7C600200,  //  00E6  CALL	R24	1
      0x8C603161,  //  00E7  GETMET	R24	R24	K97
      0x88680766,  //  00E8  GETMBR	R26	R3	K102
      0x8C6C0714,  //  00E9  GETMET	R27	R3	K20
      0x7C6C0200,  //  00EA  CALL	R27	1
      0x006C3605,  //  00EB  ADD	R27	R27	R5
      0x60700015,  //  00EC  GETGBL	R28	G21
      0x7C700000,  //  00ED  CALL	R28	0
      0x8C70394E,  //  00EE  GETMET	R28	R28	K78
      0x88780162,  //  00EF  GETMBR	R30	R0	K98
      0x7C700400,  //  00F0  CALL	R28	2
      0x5476002F,  //  00F1  LDINT	R29	48
      0x7C600A00,  //  00F2  CALL	R24	5
      0x5466000E,  //  00F3  LDINT	R25	15
      0x40663E19,  //  00F4  CONNECT	R25	K31	R25
      ...
      0xB8721400,  //  00FE  GETNGBL	R28	K10
      0x8C70395F,  //  00FF  GETMET	R28	R28	K95
      0x7C700200,  //  0100  CALL	R28	1
      0x8C740124,  //  0101  GETMET	R29	R0	K36
      0x5C7C0200,  //  0102  MOVE	R31	R1
      0x5880001F,  //  0103  LDCONST	R32	K31
      0x5884001F,  //  0104  LDCONST	R33	K31
      0x5888001F,  //  0105  LDCONST	R34	K31
      0x508C0200,  //  0106  LDBOOL	R35	1	0
      0x7C740C00,  //  0107  CALL	R29	6
      0x8C74077F,  //  0108  GETMET	R29	R3	K127
      0x7C740200,  //  0109  CALL	R29	1
      0x8C74071C,  //  010A  GETMET	R29	R3	K28
      ...
      0x900F011F,  //  0110  SETMBR	R3	K128	K31
      0x8C740781,  //  0111  GETMET	R29	R3	K129
      0x7C740200,  //  0112  CALL	R29	1
      0x8C740782,  //  0113  GETMET	R29	R3	K130
      0x507C0200,  //  0114  LDBOOL	R31	1	0
      0x7C740400,  //  0115  CALL	R29	2
      0x8C740783,  //  0116  GETMET	R29	R3	K131
      0x7C740200,  //  0117  CALL	R29	1
      0x8C740784,  //  0118  GETMET	R29	R3	K132
      0x7C740200,  //  0119  CALL	R29	1
      0x8C740785,  //  011A  GETMET	R29	R3	K133
...
be_local_closure(class_Matter_Commisioning_Context_process_incoming,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[89]) {  /* code */
      ...
      0x8C080586,  //  0002  GETMET	R2	R2	K134
      ...
      0x580C0087,  //  000E  LDCONST	R3	K135
      ...
      0x8C080188,  //  001C  GETMET	R2	R0	K136
      ...
      0x8C080189,  //  0025  GETMET	R2	R0	K137
      ...
      0x8C08018A,  //  002E  GETMET	R2	R0	K138
      ...
      0x8C08018B,  //  0037  GETMET	R2	R0	K139
      ...
      0x8C08018C,  //  0040  GETMET	R2	R0	K140
      ...
      0x8C08018D,  //  0049  GETMET	R2	R0	K141
      ...
      0x5810008E,  //  0050  LDCONST	R4	K142
...
be_local_closure(class_Matter_Commisioning_Context_parse_Sigma1,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[495]) {  /* code */
      ...
      0xB8124C00,  //  0019  GETNGBL	R4	K38
      0x8C10098F,  //  001A  GETMET	R4	R4	K143
      0x7C100200,  //  001B  CALL	R4	1
      0x8C100928,  //  001C  GETMET	R4	R4	K40
      0x88180301,  //  001D  GETMBR	R6	R1	K1
      0x881C0302,  //  001E  GETMBR	R7	R1	K2
      0x7C100600,  //  001F  CALL	R4	3
      0x88140990,  //  0020  GETMBR	R5	R4	K144
      0x900EF005,  //  0021  SETMBR	R3	K120	R5
      0x88140991,  //  0022  GETMBR	R5	R4	K145
      0x4C180000,  //  0023  LDNIL	R6
      0x20140A06,  //  0024  NE	R5	R5	R6
      0x78160003,  //  0025  JMPF	R5	#002A
      0x88140992,  //  0026  GETMBR	R5	R4	K146
      ...
      0x8C1C0F93,  //  0030  GETMET	R7	R7	K147
      0x88240991,  //  0031  GETMBR	R9	R4	K145
      ...
      0x881C0D94,  //  0037  GETMBR	R7	R6	K148
      ...
      0x88280991,  //  003E  GETMBR	R10	R4	K145
      ...
      0x88200991,  //  0049  GETMBR	R8	R4	K145
      ...
      0x88400D94,  //  0076  GETMBR	R16	R6	K148
      0x900F2810,  //  0077  SETMBR	R3	K148	R16
      ...
      0x90572216,  //  00B4  SETMBR	R21	K145	R22
      ...
      0x8C7C077F,  //  00E4  GETMET	R31	R3	K127
      ...
      0x88300990,  //  014A  GETMBR	R12	R4	K144
      ...
      0x88341BAB,  //  0155  GETMBR	R13	R13	K171
      0x8C380FAC,  //  0156  GETMET	R14	R7	K172
      ...
      0x88341BAB,  //  015D  GETMBR	R13	R13	K171
      0x8C380FAD,  //  015E  GETMET	R14	R7	K173
      ...
      0x88341BAB,  //  0165  GETMBR	R13	R13	K171
      ...
      0x88341BAB,  //  016C  GETMBR	R13	R13	K171
      0x88380990,  //  016D  GETMBR	R14	R4	K144
      0x7C280800,  //  016E  CALL	R10	4
      0x8C28057A,  //  016F  GETMET	R10	R2	K122
      0x7C280200,  //  0170  CALL	R10	1
      0x8C2815AE,  //  0171  GETMET	R10	R10	K174
      0x8C300FAF,  //  0172  GETMET	R12	R7	K175
      ...
      0x883C1FAB,  //  017F  GETMBR	R15	R15	K171
      0x8C400FAC,  //  0180  GETMET	R16	R7	K172
      ...
      0x883C1FAB,  //  0187  GETMBR	R15	R15	K171
      0x8C400FAD,  //  0188  GETMET	R16	R7	K173
      ...
      0x883C1FAB,  //  018F  GETMBR	R15	R15	K171
      ...
      0x883C1FAB,  //  0196  GETMBR	R15	R15	K171
      0x8840079C,  //  0197  GETMBR	R16	R3	K156
      0x7C300800,  //  0198  CALL	R12	4
      0x883009B0,  //  0199  GETMBR	R12	R4	K176
      ...
      0x883C01B1,  //  01A5  GETMBR	R15	R0	K177
      ...
      0x885801B2,  //  01BC  GETMBR	R22	R0	K178
      ...
      0x8C4823B3,  //  01C5  GETMET	R18	R17	K179
      ...
      0x8C4C27B4,  //  01CC  GETMET	R19	R19	K180
      ...
      0x904F6A14,  //  01D2  SETMBR	R19	K181	R20
      0x904F6C12,  //  01D3  SETMBR	R19	K182	R18
      ...
      0x586400B7,  //  01E0  LDCONST	R25	K183
