...
be_local_class(Matter_Fabric,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key_weak(no_private_key, -1), be_const_var(3) },
        { be_const_key_weak(tojson, 11), be_const_closure(Matter_Fabric_tojson_closure) },
        { be_const_key_weak(fabric_label, -1), be_const_var(11) },
        { be_const_key_weak(get_fabric_compressed, 33), be_const_closure(Matter_Fabric_get_fabric_compressed_closure) },
        { be_const_key_weak(_sessions, -1), be_const_var(2) },
        ...
        { be_const_key_weak(_store, 29), be_const_var(0) },
        { be_const_key_weak(_GROUP_KEY, -1), be_nested_str_weak(GroupKey_X20v1_X2E0) },
        { be_const_key_weak(icac, 32), be_const_var(6) },
        { be_const_key_weak(ipk_epoch_key, 34), be_const_var(7) },
        { be_const_key_weak(get_newest_session, -1), be_const_closure(Matter_Fabric_get_newest_session_closure) },
        { be_const_key_weak(get_fabric_label, 30), be_const_closure(Matter_Fabric_get_fabric_label_closure) },
        { be_const_key_weak(add_session, -1), be_const_closure(Matter_Fabric_add_session_closure) },
        { be_const_key_weak(admin_subject, 7), be_const_var(12) },
        { be_const_key_weak(get_device_id, -1), be_const_closure(Matter_Fabric_get_device_id_closure) },
        { be_const_key_weak(get_oldest_session, 12), be_const_closure(Matter_Fabric_get_oldest_session_closure) },
        { be_const_key_weak(get_ca_pub, 14), be_const_closure(Matter_Fabric_get_ca_pub_closure) },
        ...
        { be_const_key_weak(fabric_id, 15), be_const_var(8) },
        { be_const_key_weak(_MAX_CASE, 9), be_const_int(5) },
        ...
        { be_const_key_weak(get_noc, 17), be_const_closure(Matter_Fabric_get_noc_closure) },
        { be_const_key_weak(root_ca_certificate, 20), be_const_var(4) },
        ...
        { be_const_key_weak(admin_vendor, -1), be_const_var(13) },
        { be_const_key_weak(noc, -1), be_const_var(5) },
...
be_local_class(Matter_Session_Store,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key_weak(remove_session, 2), be_const_closure(Matter_Session_Store_remove_session_closure) },
        ...
        { be_const_key_weak(add_session, 3), be_const_closure(Matter_Session_Store_add_session_closure) },
        { be_const_key_weak(gen_local_session_id, -1), be_const_closure(Matter_Session_Store_gen_local_session_id_closure) },
        { be_const_key_weak(fabrics, 15), be_const_var(1) },
        { be_const_key_weak(add_fabric, -1), be_const_closure(Matter_Session_Store_add_fabric_closure) },
        { be_const_key_weak(remove_redundant_fabric, 5), be_const_closure(Matter_Session_Store_remove_redundant_fabric_closure) },
        { be_const_key_weak(_FABRICS, 12), be_nested_str_weak(_matter_fabrics_X2Ejson) },
        { be_const_key_weak(save_fabrics, 6), be_const_closure(Matter_Session_Store_save_fabrics_closure) },
