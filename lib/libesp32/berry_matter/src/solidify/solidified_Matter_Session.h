...
be_local_closure(Matter_Session_set_keys,   /* name */
  be_nested_proto(
    ...
    /* K1   */  be_nested_str_weak(r2ikey),
    /* K2   */  be_nested_str_weak(attestation_challenge),
    /* K3   */  be_nested_str_weak(session_timestamp),
    }),
...
be_local_closure(Matter_Session_close,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[56]) {  /* code */
      ...
      0xA40A1800,  //  0013  IMPORT	R2	K12
      0x600C0010,  //  0014  GETGBL	R3	G16
      0x8C10050D,  //  0015  GETMET	R4	R2	K13
      0x5C180000,  //  0016  MOVE	R6	R0
      0x7C100400,  //  0017  CALL	R4	2
      0x7C0C0200,  //  0018  CALL	R3	1
      0xA8020018,  //  0019  EXBLK	0	#0033
      0x5C100600,  //  001A  MOVE	R4	R3
      0x7C100000,  //  001B  CALL	R4	0
      0x8C14050E,  //  001C  GETMET	R5	R2	K14
      0x5C1C0000,  //  001D  MOVE	R7	R0
      0x5C200800,  //  001E  MOVE	R8	R4
      0x7C140600,  //  001F  CALL	R5	3
      0x60180004,  //  0020  GETGBL	R6	G4
      0x5C1C0A00,  //  0021  MOVE	R7	R5
      0x7C180200,  //  0022  CALL	R6	1
      0x20180D0F,  //  0023  NE	R6	R6	K15
      0x781A000C,  //  0024  JMPF	R6	#0032
      0x60180004,  //  0025  GETGBL	R6	G4
      0x5C1C0A00,  //  0026  MOVE	R7	R5
      0x7C180200,  //  0027  CALL	R6	1
      0x20180D10,  //  0028  NE	R6	R6	K16
      0x781A0007,  //  0029  JMPF	R6	#0032
      0x94180911,  //  002A  GETIDX	R6	R4	K17
      0x1C180D12,  //  002B  EQ	R6	R6	K18
      0x781A0004,  //  002C  JMPF	R6	#0032
      0x94180913,  //  002D  GETIDX	R6	R4	K19
      0x20180D12,  //  002E  NE	R6	R6	K18
      0x781A0001,  //  002F  JMPF	R6	#0032
      0x4C180000,  //  0030  LDNIL	R6
      0x90000806,  //  0031  SETMBR	R0	R4	R6
      0x7001FFE6,  //  0032  JMP		#001A
      0x580C0014,  //  0033  LDCONST	R3	K20
      0xAC0C0200,  //  0034  CATCH	R3	1	0
      0xB0080000,  //  0035  RAISE	2	R0	R0
      0x90020001,  //  0036  SETMBR	R0	K0	R1
...
be_local_class(Matter_Session,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key_weak(root_ca_certificate, -1), be_const_var(18) },
        { be_const_key_weak(ipk_epoch_key, -1), be_const_var(21) },
        ...
        { be_const_key_weak(resumption_id, 11), be_const_var(22) },
        { be_const_key_weak(expiration, -1), be_const_var(32) },
        { be_const_key_weak(get_pk, 41), be_const_closure(Matter_Session_get_pk_closure) },
        { be_const_key_weak(_Msg2, -1), be_const_var(30) },
        { be_const_key_weak(init, -1), be_const_closure(Matter_Session_init_closure) },
        { be_const_key_weak(get_ac, 29), be_const_closure(Matter_Session_get_ac_closure) },
        ...
        { be_const_key_weak(save, 47), be_const_closure(Matter_Session_save_closure) },
        { be_const_key_weak(_persist, 61), be_const_var(31) },
        { be_const_key_weak(no_private_key, -1), be_const_var(17) },
        ...
        { be_const_key_weak(set_ipk_epoch_key, 64), be_const_closure(Matter_Session_set_ipk_epoch_key_closure) },
        { be_const_key_weak(tojson, -1), be_const_closure(Matter_Session_tojson_closure) },
        { be_const_key_weak(mode, -1), be_const_var(1) },
        { be_const_key_weak(_Msg1, 28), be_const_var(29) },
        { be_const_key_weak(__store, 15), be_const_var(0) },
        { be_const_key_weak(fabric, -1), be_const_var(24) },
        { be_const_key_weak(get_noc, 54), be_const_closure(Matter_Session_get_noc_closure) },
        { be_const_key_weak(get_icac, -1), be_const_closure(Matter_Session_get_icac_closure) },
        { be_const_key_weak(has_expired, 12), be_const_closure(Matter_Session_has_expired_closure) },
        ...
        { be_const_key_weak(breadcrumb, -1), be_const_var(16) },
        { be_const_key_weak(_counter_insecure_snd, -1), be_const_var(11) },
        { be_const_key_weak(peer_node_id, -1), be_const_var(15) },
        ...
        { be_const_key_weak(noc, -1), be_const_var(19) },
        { be_const_key_weak(counter_snd, 53), be_const_var(9) },
        { be_const_key_weak(_counter_insecure_rcv, -1), be_const_var(10) },
        { be_const_key_weak(set_mode, 60), be_const_closure(Matter_Session_set_mode_closure) },
        { be_const_key_weak(set_noc, -1), be_const_closure(Matter_Session_set_noc_closure) },
        { be_const_key_weak(set_ca, 57), be_const_closure(Matter_Session_set_ca_closure) },
        { be_const_key_weak(__GROUP_KEY, 3), be_nested_str_weak(GroupKey_X20v1_X2E0) },
        { be_const_key_weak(icac, 56), be_const_var(20) },
        ...
        { be_const_key_weak(shared_secret, -1), be_const_var(23) },
        { be_const_key_weak(deviceid, 49), be_const_var(26) },
        ...
        { be_const_key_weak(admin_subject, -1), be_const_var(27) },
        { be_const_key_weak(get_fabric, 34), be_const_closure(Matter_Session_get_fabric_closure) },
        { be_const_key_weak(attestation_challenge, 0), be_const_var(14) },
        { be_const_key_weak(set_fabric_device, -1), be_const_closure(Matter_Session_set_fabric_device_closure) },
        { be_const_key_weak(fabric_compressed, 26), be_const_var(25) },
        { be_const_key_weak(get_mode, 21), be_const_closure(Matter_Session_get_mode_closure) },
        ...
        { be_const_key_weak(admin_vendor, -1), be_const_var(28) },
        { be_const_key_weak(_future_local_session_id, 8), be_const_var(7) },
        { be_const_key_weak(set_expire_in_seconds, -1), be_const_closure(Matter_Session_set_expire_in_seconds_closure) },
        { be_const_key_weak(i2rkey, 2), be_const_var(12) },
...
be_local_class(Matter_Session_Store,
    ...
    be_nested_map(15,
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key_weak(every_second, 14), be_const_closure(Matter_Session_Store_every_second_closure) },
        { be_const_key_weak(remove_redundant_session, 9), be_const_closure(Matter_Session_Store_remove_redundant_session_closure) },
        { be_const_key_weak(get_session_by_source_node_id, 5), be_const_closure(Matter_Session_Store_get_session_by_source_node_id_closure) },
        ...
        { be_const_key_weak(FILENAME, 11), be_nested_str_weak(_matter_sessions_X2Ejson) },
