...
be_local_class(Matter_Plugin,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key_weak(send_ack_now, 22), be_const_closure(Matter_Plugin_send_ack_now_closure) },
        ...
        { be_const_key_weak(NAME, 19), be_nested_str_weak() },
        { be_const_key_weak(parse_configuration, 32), be_const_closure(Matter_Plugin_parse_configuration_closure) },
        { be_const_key_weak(ui_conf_to_string, 34), be_const_static_closure(Matter_Plugin_ui_conf_to_string_closure) },
        { be_const_key_weak(device, -1), be_const_var(1) },
        { be_const_key_weak(read_attribute, 18), be_const_closure(Matter_Plugin_read_attribute_closure) },
        ...
        { be_const_key_weak(CLUSTERS, 33), be_const_simple_instance(be_nested_simple_instance(&be_class_map, {
    ...
    ( (struct bvalue*) &(const bvalue[]) {
        ...
        { be_const_key_weak(every_250ms, 0), be_const_closure(Matter_Plugin_every_250ms_closure) },
        ...
        { be_const_key_weak(ARG, 3), be_nested_str_weak() },
        { be_const_key_weak(consolidate_clusters, 8), be_const_closure(Matter_Plugin_consolidate_clusters_closure) },
