...
static const bvalue be_ktab_class_Matter_Plugin_Sensor[37] = {
  ...
  /* K7   */  be_nested_str_weak(get_name),
  /* K8   */  be_nested_str_weak(filter_name_html),
  /* K9   */  be_nested_str_weak(content_send),
  /* K10  */  be_nested_str_weak(PREFIX),
  /* K11  */  be_nested_str_weak(html_escape),
  /* K12  */  be_nested_str_weak(),
  /* K13  */  be_nested_str_weak(contains),
  /* K14  */  be_nested_str_weak(TempUnit),
  /* K15  */  be_nested_str_weak(temp_unit),
  /* K16  */  be_nested_str_weak(PressureUnit),
  /* K17  */  be_nested_str_weak(pressure_unit),
  /* K18  */  be_nested_str_weak(tasmota_sensor_matcher),
  /* K19  */  be_nested_str_weak(pre_value),
  /* K20  */  be_nested_str_weak(match),
  /* K21  */  be_nested_str_weak(parse_configuration),
  /* K22  */  be_nested_str_weak(tasmota_sensor_filter),
  /* K23  */  be_nested_str_weak(filter),
  /* K24  */  be_nested_str_weak(tasmota),
  /* K25  */  be_nested_str_weak(Rule_Matcher),
  /* K26  */  be_nested_str_weak(parse),
  /* K27  */  be_nested_str_weak(TEMP_C),
  /* K28  */  be_nested_str_weak(PRESSURE_HPA),
  /* K29  */  be_nested_str_weak(init),
  /* K30  */  be_nested_str_weak(add_read_sensors_schedule),
  /* K31  */  be_nested_str_weak(UPDATE_TIME),
  /* K32  */  be_nested_str_weak(VIRTUAL),
  /* K33  */  be_nested_str_weak(string),
  /* K34  */  be_nested_str_weak(split),
  /* K35  */  be_nested_str_weak(_X23),
  /* K36  */  be_const_int(0),
};
...
be_local_closure(class_Matter_Plugin_Sensor_parse_status,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[35]) {  /* code */
      ...
      0x8C0C030D,  //  0003  GETMET	R3	R1	K13
      0x5814000E,  //  0004  LDCONST	R5	K14
      0x7C0C0400,  //  0005  CALL	R3	2
      0x780E0001,  //  0006  JMPF	R3	#0009
      0x940C030E,  //  0007  GETIDX	R3	R1	K14
      0x90021E03,  //  0008  SETMBR	R0	K15	R3
      0x8C0C030D,  //  0009  GETMET	R3	R1	K13
      0x58140010,  //  000A  LDCONST	R5	K16
      0x7C0C0400,  //  000B  CALL	R3	2
      0x780E0001,  //  000C  JMPF	R3	#000F
      0x940C0310,  //  000D  GETIDX	R3	R1	K16
      0x90022203,  //  000E  SETMBR	R0	K17	R3
      0x880C0112,  //  000F  GETMBR	R3	R0	K18
      0x780E0010,  //  0010  JMPF	R3	#0022
      0x8C0C0113,  //  0011  GETMET	R3	R0	K19
      0x6014000A,  //  0012  GETGBL	R5	G10
      0x88180112,  //  0013  GETMBR	R6	R0	K18
      0x8C180D14,  //  0014  GETMET	R6	R6	K20
...
be_local_closure(class_Matter_Plugin_Sensor_parse_configuration,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[23]) {  /* code */
      ...
      0x58100017,  //  0007  LDCONST	R4	K23
      ...
      0x88080519,  //  000D  GETMBR	R2	R2	K25
      0x8C08051A,  //  000E  GETMET	R2	R2	K26
      0x88100116,  //  000F  GETMBR	R4	R0	K22
      0x7C080400,  //  0010  CALL	R2	2
      0x90022402,  //  0011  SETMBR	R0	K18	R2
      0x8808011B,  //  0012  GETMBR	R2	R0	K27
      0x90021E02,  //  0013  SETMBR	R0	K15	R2
      0x8808011C,  //  0014  GETMBR	R2	R0	K28
      0x90022202,  //  0015  SETMBR	R0	K17	R2
...
be_local_closure(class_Matter_Plugin_Sensor_init,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[12]) {  /* code */
      ...
      0x8C10091D,  //  0003  GETMET	R4	R4	K29
...
be_local_closure(class_Matter_Plugin_Sensor_parse_sensors,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[33]) {  /* code */
      ...
      0x88080112,  //  0002  GETMBR	R2	R0	K18
      0x780A001B,  //  0003  JMPF	R2	#0020
      0x88080112,  //  0004  GETMBR	R2	R0	K18
      0x8C080514,  //  0005  GETMET	R2	R2	K20
...
be_local_closure(class_Matter_Plugin_Sensor_filter_name_html,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[13]) {  /* code */
      ...
      0xA4064200,  //  0002  IMPORT	R1	K33
      0xA40A0C00,  //  0003  IMPORT	R2	K6
      0x8C0C050B,  //  0004  GETMET	R3	R2	K11
      0x8C140322,  //  0005  GETMET	R5	R1	K34
      0x881C0116,  //  0006  GETMBR	R7	R0	K22
      0x58200023,  //  0007  LDCONST	R8	K35
      0x7C140600,  //  0008  CALL	R5	3
      0x94140B24,  //  0009  GETIDX	R5	R5	K36
      0x7C0C0400,  //  000A  CALL	R3	2
      0x80040600,  //  000B  RET	1	R3
      0x80061800,  //  000C  RET	1	K12
    })
  )
);
/*******************************************************************/
...
be_local_class(Matter_Plugin_Sensor,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key_weak(JSON_NAME, 5), be_nested_str_weak() },
        { be_const_key_weak(SCHEMA, 14), be_nested_str_weak(filter_X7Cl_X3AFilter_X7Ch_X3AFilter_X20pattern) },
        ...
        { be_const_key_weak(init, 11), be_const_closure(class_Matter_Plugin_Sensor_init_closure) },
        { be_const_key_weak(TEMP_C, -1), be_nested_str_weak(C) },
        { be_const_key_weak(PRESSURE_HPA, 6), be_nested_str_weak(hPa) },
