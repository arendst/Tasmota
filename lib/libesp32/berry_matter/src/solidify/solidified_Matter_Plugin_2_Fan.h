...
// compact class 'Matter_Plugin_Fan' ktab size: 26, total: 60 (saved 272 bytes)
static const bvalue be_ktab_class_Matter_Plugin_Fan[26] = {
  /* K0   */  be_const_int(0),
...
be_local_closure(class_Matter_Plugin_Fan_write_attribute,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[76]) {  /* code */
      ...
      0x541E0086,  //  0025  LDINT	R7	135
      0x900A2C07,  //  0026  SETMBR	R2	K22	R7
      0x501C0000,  //  0027  LDBOOL	R7	0	0
      0x80040E00,  //  0028  RET	1	R7
      0x7002001F,  //  0029  JMP		#004A
      0x1C1C0D07,  //  002A  EQ	R7	R6	K7
      0x781E001D,  //  002B  JMPF	R7	#004A
      0x601C0004,  //  002C  GETGBL	R7	G4
      0x5C200600,  //  002D  MOVE	R8	R3
      0x7C1C0200,  //  002E  CALL	R7	1
      0x1C1C0F14,  //  002F  EQ	R7	R7	K20
      0x781E0014,  //  0030  JMPF	R7	#0046
      0x8C1C010C,  //  0031  GETMET	R7	R0	K12
      0x5C240600,  //  0032  MOVE	R9	R3
      0x7C1C0400,  //  0033  CALL	R7	2
      0x8C1C0115,  //  0034  GETMET	R7	R0	K21
      0x58240009,  //  0035  LDCONST	R9	K9
      0x88280101,  //  0036  GETMBR	R10	R0	K1
      0x582C000D,  //  0037  LDCONST	R11	K13
      0x88300103,  //  0038  GETMBR	R12	R0	K3
      0x5834000B,  //  0039  LDCONST	R13	K11
      0xB83A0A00,  //  003A  GETNGBL	R14	K5
      0x8C381D06,  //  003B  GETMET	R14	R14	K6
      0x88400103,  //  003C  GETMBR	R16	R0	K3
      0x58440000,  //  003D  LDCONST	R17	K0
      0x544A0063,  //  003E  LDINT	R18	100
      0x584C0000,  //  003F  LDCONST	R19	K0
      0x545200FE,  //  0040  LDINT	R20	255
      0x7C380C00,  //  0041  CALL	R14	6
      0x7C1C0E00,  //  0042  CALL	R7	7
      0x501C0200,  //  0043  LDBOOL	R7	1	0
      0x80040E00,  //  0044  RET	1	R7
      0x70020003,  //  0045  JMP		#004A
      0x541E0086,  //  0046  LDINT	R7	135
      0x900A2C07,  //  0047  SETMBR	R2	K22	R7
...
be_local_closure(class_Matter_Plugin_Fan_read_attribute,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[47]) {  /* code */
      ...
      0x1C180B0E,  //  000F  EQ	R6	R5	K14
      0x781A0005,  //  0010  JMPF	R6	#0017
      0x8C180718,  //  0011  GETMET	R6	R3	K24
      ...
      0x1C180B07,  //  0017  EQ	R6	R5	K7
      0x781A0005,  //  0018  JMPF	R6	#001F
      0x8C180718,  //  0019  GETMET	R6	R3	K24
      0x54220003,  //  001A  LDINT	R8	4
      0x88240103,  //  001B  GETMBR	R9	R0	K3
      0x7C180600,  //  001C  CALL	R6	3
      0x80040C00,  //  001D  RET	1	R6
      0x70020006,  //  001E  JMP		#0026
      0x1C180B04,  //  001F  EQ	R6	R5	K4
      0x781A0004,  //  0020  JMPF	R6	#0026
      0x8C180718,  //  0021  GETMET	R6	R3	K24
      0x54220003,  //  0022  LDINT	R8	4
      0x88240103,  //  0023  GETMBR	R9	R0	K3
      0x7C180600,  //  0024  CALL	R6	3
      0x80040C00,  //  0025  RET	1	R6
      0x60180003,  //  0026  GETGBL	R6	G3
      0x5C1C0000,  //  0027  MOVE	R7	R0
      0x7C180200,  //  0028  CALL	R6	1
      0x8C180D19,  //  0029  GETMET	R6	R6	K25
...
be_local_class(Matter_Plugin_Fan,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key_int(43, -1), be_const_int(3) },
    }))    ) } )) },
    })),
