...
be_define_const_str(_X2Eautoconf, ".autoconf", 2524679088u, 0, 9, &be_const_str_value);
...
be_define_const_str(_X2Ep1, ".p1", 249175686u, 0, 3, &be_const_str_scan);
be_define_const_str(_X2Ep2, ".p2", 232398067u, 0, 3, &be_const_str_add_header);
be_define_const_str(_X2Esize, ".size", 1965188224u, 0, 5, NULL);
be_define_const_str(_X2Etapp, ".tapp", 1363391594u, 0, 5, &be_const_str__archive);
be_define_const_str(_X2Ew, ".w", 1255414514u, 0, 2, &be_const_str__X2F);
be_define_const_str(_X2F, "/", 705468254u, 0, 1, &be_const_str_widget_constructor);
be_define_const_str(_X2F_X2Eautoconf, "/.autoconf", 2212074393u, 0, 10, &be_const_str__X3C_X2Fselect_X3E_X3Cp_X3E_X3C_X2Fp_X3E);
be_define_const_str(_X2F_X3Frst_X3D, "/?rst=", 580074707u, 0, 6, &be_const_str_setrange);
be_define_const_str(_X2Fac, "/ac", 3904651978u, 0, 3, &be_const_str_classname);
be_define_const_str(_X3A, ":", 1057798253u, 0, 1, &be_const_str_get_size);
be_define_const_str(_X3C, "<", 957132539u, 0, 1, &be_const_str_argument_X20must_X20be_X20a_X20function);
be_define_const_str(_X3C_X2Fform_X3E_X3C_X2Fp_X3E, "</form></p>", 3546571739u, 0, 11, &be_const_str_set_style_bg_color);
...
be_define_const_str(_X3Cbutton_X20name_X3D_X27zipapply_X27_X20class_X3D_X27button_X20bgrn_X27_X3EApply_X20configuration_X3C_X2Fbutton_X3E, "<button name='zipapply' class='button bgrn'>Apply configuration</button>", 1205771629u, 0, 72, &be_const_str_set_useragent);
...
be_define_const_str(_X3Cinstance_X3A_X20_X25s_X28_X25s_X2C_X20_X25s_X2C_X20_X25s_X29, "<instance: %s(%s, %s, %s)", 257363333u, 0, 25, &be_const_str_AXP192);
be_define_const_str(_X3Clabel_X3EChoose_X20a_X20device_X20configuration_X3A_X3C_X2Flabel_X3E_X3Cbr_X3E, "<label>Choose a device configuration:</label><br>", 1336654704u, 0, 49, &be_const_str_lv_obj_class);
be_define_const_str(_X3Clambda_X3E, "<lambda>", 607256038u, 0, 8, NULL);
be_define_const_str(_X3Clegend_X3E_X3Cb_X20title_X3D_X27Autoconfiguration_X27_X3E_X26nbsp_X3BCurrent_X20auto_X2Dconfiguration_X3C_X2Fb_X3E_X3C_X2Flegend_X3E, "<legend><b title='Autoconfiguration'>&nbsp;Current auto-configuration</b></legend>", 4212500780u, 0, 82, &be_const_str_COLOR_BLACK);
be_define_const_str(_X3Clegend_X3E_X3Cb_X20title_X3D_X27New_X20autoconf_X27_X3E_X26nbsp_X3BSelect_X20new_X20auto_X2Dconfiguration_X3C_X2Fb_X3E_X3C_X2Flegend_X3E, "<legend><b title='New autoconf'>&nbsp;Select new auto-configuration</b></legend>", 1926223891u, 0, 80, &be_const_str_SERIAL_6E1);
be_define_const_str(_X3Coption_X20value_X3D_X27_X25s_X27_X3E_X25s_X3C_X2Foption_X3E, "<option value='%s'>%s</option>", 510303524u, 0, 30, &be_const_str_SERIAL_7O2);
...
be_define_const_str(_X3Cp_X20style_X3D_X27width_X3A340px_X3B_X27_X3E_X3Cb_X3EException_X3A_X3C_X2Fb_X3E_X3Cbr_X3E_X27_X25s_X27_X3Cbr_X3E_X25s_X3C_X2Fp_X3E, "<p style='width:340px;'><b>Exception:</b><br>'%s'<br>%s</p>", 4252565082u, 0, 59, &be_const_str_write8);
be_define_const_str(_X3Cp_X3E_X3C_X2Fp_X3E_X3C_X2Ffieldset_X3E_X3Cp_X3E_X3C_X2Fp_X3E, "<p></p></fieldset><p></p>", 2052843416u, 0, 25, &be_const_str_EC_C25519);
...
be_define_const_str(_X3Cp_X3E_X3Cform_X20id_X3Dreapply_X20style_X3D_X27display_X3A_X20block_X3B_X27_X20action_X3D_X27_X2Fac_X27_X20method_X3D_X27post_X27_X20, "<p><form id=reapply style='display: block;' action='/ac' method='post' ", 546993478u, 0, 71, &be_const_str_add_event_cb);
be_define_const_str(_X3Cp_X3E_X3Cform_X20id_X3Dzip_X20style_X3D_X27display_X3A_X20block_X3B_X27_X20action_X3D_X27_X2Fac_X27_X20method_X3D_X27post_X27_X20, "<p><form id=zip style='display: block;' action='/ac' method='post' ", 4033622166u, 0, 67, &be_const_str_CFG_X3A_X20downloading_X20_X27_X25s_X27);
...
be_define_const_str(_X3Cp_X3ECurrent_X20configuration_X3A_X20_X3C_X2Fp_X3E_X3Cp_X3E_X3Cb_X3E_X25s_X3C_X2Fb_X3E_X3C_X2Fp_X3E, "<p>Current configuration: </p><p><b>%s</b></p>", 4115655761u, 0, 46, &be_const_str_Wire);
be_define_const_str(_X3Cselect_X20name_X3D_X27zip_X27_X3E, "<select name='zip'>", 4247924536u, 0, 19, &be_const_str_SERIAL_7N1);
be_define_const_str(_X3D, "=", 940354920u, 0, 1, &be_const_str_lv);
be_define_const_str(_X3D_X3C_X3E_X21, "=<>!", 2664470277u, 0, 4, &be_const_str_signal_arcs);
be_define_const_str(_X3D_X3D, "==", 2431966415u, 0, 2, &be_const_str__energy);
be_define_const_str(_X3E, ">", 990687777u, 0, 1, &be_const_str_publish_result);
be_define_const_str(_X3E_X3D, ">=", 284975636u, 0, 2, &be_const_str_get_coords);
be_define_const_str(_X3F, "?", 973910158u, 0, 1, &be_const_str_PART_MAIN);
...
be_define_const_str(AudioFileSource, "AudioFileSource", 2959980058u, 0, 15, &be_const_str_exists);
be_define_const_str(AudioFileSourceFS, "AudioFileSourceFS", 1839147653u, 0, 17, &be_const_str_due);
be_define_const_str(AudioGenerator, "AudioGenerator", 1839297342u, 0, 14, &be_const_str_point_arr);
be_define_const_str(AudioGeneratorMP3, "AudioGeneratorMP3", 2199818488u, 0, 17, &be_const_str_draw_ctx);
be_define_const_str(AudioGeneratorWAV, "AudioGeneratorWAV", 2746509368u, 0, 17, &be_const_str_onsubmit_X3D_X27return_X20confirm_X28_X22This_X20will_X20cause_X20a_X20restart_X2E_X22_X29_X3B_X27_X3E);
be_define_const_str(AudioOutput, "AudioOutput", 3257792048u, 0, 11, &be_const_str_pow);
be_define_const_str(AudioOutputI2S, "AudioOutputI2S", 638031784u, 0, 14, &be_const_str_if);
be_define_const_str(Auto_X2Dconfiguration, "Auto-configuration", 1665006109u, 0, 18, &be_const_str_file_X20extension_X20is_X20not_X20_X27_X2Ebe_X27_X20or_X20_X27_X2Ebec_X27);
be_define_const_str(BRY_X3A_X20ERROR_X2C_X20bad_X20json_X3A_X20, "BRY: ERROR, bad json: ", 2715135809u, 0, 22, &be_const_str_LVG_X3A_X20call_X20to_X20unsupported_X20callback);
be_define_const_str(BRY_X3A_X20Exception_X3E_X20_X27_X25s_X27_X20_X2D_X20_X25s, "BRY: Exception> '%s' - %s", 2246990964u, 0, 25, &be_const_str_SERIAL_6N2);
be_define_const_str(BRY_X3A_X20argument_X20must_X20be_X20a_X20function, "BRY: argument must be a function", 3917068408u, 0, 32, &be_const_str_Tele);
...
be_define_const_str(BRY_X3A_X20failed_X20to_X20load_X20_persist_X2Ejson, "BRY: failed to load _persist.json", 2991913445u, 0, 33, &be_const_str_hex);
...
be_define_const_str(CFG_X3A_X20_X27init_X2Ebat_X27_X20done_X2C_X20restarting, "CFG: 'init.bat' done, restarting", 1569670677u, 0, 32, &be_const_str_get_cb_list);
be_define_const_str(CFG_X3A_X20Exception_X3E_X20_X27_X25s_X27_X20_X2D_X20_X25s, "CFG: Exception> '%s' - %s", 1228874553u, 0, 25, &be_const_str_INTERNAL_PDM);
be_define_const_str(CFG_X3A_X20No_X20_X27_X2A_X2Eautoconf_X27_X20file_X20found, "CFG: No '*.autoconf' file found", 755798501u, 0, 31, &be_const_str_w);
be_define_const_str(CFG_X3A_X20could_X20not_X20run_X20_X25s_X20_X28_X25s_X20_X2D_X20_X25s_X29, "CFG: could not run %s (%s - %s)", 1428829580u, 0, 31, &be_const_str___lower__);
be_define_const_str(CFG_X3A_X20downloading_X20_X27_X25s_X27, "CFG: downloading '%s'", 589480701u, 0, 21, &be_const_str_argument_X20must_X20be_X20a_X20list);
be_define_const_str(CFG_X3A_X20exception_X20_X27_X25s_X27_X20_X2D_X20_X27_X25s_X27, "CFG: exception '%s' - '%s'", 4095407913u, 0, 26, &be_const_str_false);
be_define_const_str(CFG_X3A_X20loaded_X20_X20, "CFG: loaded  ", 3710273538u, 0, 13, &be_const_str_EVENT_DELETE);
be_define_const_str(CFG_X3A_X20loaded_X20_X27_X25s_X27, "CFG: loaded '%s'", 1699028828u, 0, 16, NULL);
be_define_const_str(CFG_X3A_X20loading_X20, "CFG: loading ", 4010361503u, 0, 13, &be_const_str_lv_signal_arcs);
be_define_const_str(CFG_X3A_X20loading_X20_X27_X25s_X27, "CFG: loading '%s'", 2285306097u, 0, 17, &be_const_str_chars_in_string);
be_define_const_str(CFG_X3A_X20multiple_X20autoconf_X20files_X20found_X2C_X20aborting_X20_X28_X27_X25s_X27_X20_X2B_X20_X27_X25s_X27_X29, "CFG: multiple autoconf files found, aborting ('%s' + '%s')", 197663371u, 0, 58, &be_const_str_eth);
be_define_const_str(CFG_X3A_X20ran_X20_X20, "CFG: ran  ", 3579570472u, 0, 10, &be_const_str_read8);
be_define_const_str(CFG_X3A_X20removed_X20file_X20_X27_X25s_X27, "CFG: removed file '%s'", 2048602473u, 0, 22, &be_const_str_add_anim);
be_define_const_str(CFG_X3A_X20removing_X20autoconf_X20files, "CFG: removing autoconf files", 4014704970u, 0, 28, &be_const_str_content_flush);
be_define_const_str(CFG_X3A_X20removing_X20first_X20time_X20marker, "CFG: removing first time marker", 2125556683u, 0, 31, &be_const_str__lvgl);
...
be_define_const_str(COLOR_WHITE, "COLOR_WHITE", 2536871270u, 0, 11, &be_const_str_widget_dtor_cb);
be_define_const_str(CT, "CT", 1792671826u, 0, 2, NULL);
be_define_const_str(DIMMER, "DIMMER", 4049308363u, 0, 6, NULL);
be_define_const_str(EC_C25519, "EC_C25519", 95492591u, 0, 9, &be_const_str_tasmota_X2Eset_light_X28_X29_X20is_X20deprecated_X2C_X20use_X20light_X2Eset_X28_X29);
be_define_const_str(EVENT_DELETE, "EVENT_DELETE", 282828603u, 0, 12, &be_const_str_bool);
be_define_const_str(EVENT_DRAW_MAIN, "EVENT_DRAW_MAIN", 1955620614u, 0, 15, &be_const_str_cos);
be_define_const_str(EVENT_DRAW_PART_BEGIN, "EVENT_DRAW_PART_BEGIN", 3391865024u, 0, 21, &be_const_str_fromstring);
be_define_const_str(EVENT_DRAW_PART_END, "EVENT_DRAW_PART_END", 3301625292u, 0, 19, &be_const_str_obj_class_create_obj);
be_define_const_str(EXTERNAL_I2S, "EXTERNAL_I2S", 4067456169u, 0, 12, &be_const_str_bri);
be_define_const_str(False, "False", 2541049336u, 0, 5, &be_const_str_unknown_X20instruction);
be_define_const_str(GET, "GET", 2531704439u, 0, 3, &be_const_str_widget_instance_size);
be_define_const_str(HTTP_GET, "HTTP_GET", 1722467738u, 0, 8, &be_const_str_get_pixel_color);
be_define_const_str(HTTP_POST, "HTTP_POST", 1999554144u, 0, 9, NULL);
be_define_const_str(I2C_X3A, "I2C:", 813483371u, 0, 4, &be_const_str_start);
be_define_const_str(I2C_Driver, "I2C_Driver", 1714501658u, 0, 10, &be_const_str_addr);
be_define_const_str(INTERNAL_DAC, "INTERNAL_DAC", 1097623719u, 0, 12, &be_const_str_size);
be_define_const_str(INTERNAL_PDM, "INTERNAL_PDM", 3043685628u, 0, 12, &be_const_str_init_draw_arc_dsc);
...
be_define_const_str(LVG_X3A_X20object_X3A, "LVG: object:", 3824079937u, 0, 12, &be_const_str_compress);
be_define_const_str(Leds, "Leds", 2709245275u, 0, 4, &be_const_str_add);
be_define_const_str(MD5, "MD5", 1935726387u, 0, 3, &be_const_str_write_bytes);
be_define_const_str(None, "None", 810547195u, 0, 4, &be_const_str_SERIAL_5E1);
be_define_const_str(OPTION_A, "OPTION_A", 1133299440u, 0, 8, &be_const_str_percentage);
be_define_const_str(OneWire, "OneWire", 2298990722u, 0, 7, &be_const_str_name);
be_define_const_str(OpusDecoder, "OpusDecoder", 3618742074u, 0, 11, &be_const_str_matrix);
be_define_const_str(PART_MAIN, "PART_MAIN", 2473491508u, 0, 9, &be_const_str_get_height);
be_define_const_str(POST, "POST", 1929554311u, 0, 4, &be_const_str_super);
be_define_const_str(Parameter_X20error, "Parameter error", 3840042038u, 0, 15, &be_const_str_coord_arr);
be_define_const_str(RES_OK, "RES_OK", 1233817284u, 0, 6, &be_const_str_remove);
be_define_const_str(RGB, "RGB", 3386082140u, 0, 3, NULL);
be_define_const_str(RGBCT, "RGBCT", 8076251u, 0, 5, NULL);
be_define_const_str(RGBW, "RGBW", 3270986321u, 0, 4, &be_const_str_set_bits_per_sample);
be_define_const_str(Restart_X201, "Restart 1", 3504455855u, 0, 9, &be_const_str_null_cb);
...
be_define_const_str(SERIAL_5N1, "SERIAL_5N1", 3313031680u, 0, 10, &be_const_str_lv_point);
be_define_const_str(SERIAL_5N2, "SERIAL_5N2", 3363364537u, 0, 10, &be_const_str_set);
...
be_define_const_str(SERIAL_6E1, "SERIAL_6E1", 334249486u, 0, 10, &be_const_str_set_pixel_color);
...
be_define_const_str(SERIAL_6N2, "SERIAL_6N2", 148562844u, 0, 10, &be_const_str_clear_first_time);
be_define_const_str(SERIAL_6O1, "SERIAL_6O1", 266153272u, 0, 10, &be_const_str_atleast1);
...
be_define_const_str(SERIAL_7E2, "SERIAL_7E2", 97385204u, 0, 10, &be_const_str_json_append);
be_define_const_str(SERIAL_7N1, "SERIAL_7N1", 1891060246u, 0, 10, &be_const_str_list_handlers);
be_define_const_str(SERIAL_7N2, "SERIAL_7N2", 1874282627u, 0, 10, &be_const_str_fast_loop);
be_define_const_str(SERIAL_7O1, "SERIAL_7O1", 1823802675u, 0, 10, &be_const_str_arc_dsc);
...
be_define_const_str(SERIAL_8N1, "SERIAL_8N1", 2369297235u, 0, 10, &be_const_str_serial);
be_define_const_str(SERIAL_8N2, "SERIAL_8N2", 2386074854u, 0, 10, NULL);
be_define_const_str(SERIAL_8O1, "SERIAL_8O1", 289122742u, 0, 10, &be_const_str_from_to);
be_define_const_str(SERIAL_8O2, "SERIAL_8O2", 272345123u, 0, 10, &be_const_str_gamma10);
be_define_const_str(SK6812_GRBW, "SK6812_GRBW", 81157857u, 0, 11, &be_const_str_back_forth);
...
be_define_const_str(_X5B, "[", 3725336506u, 0, 1, &be_const_str__available);
be_define_const_str(_X5D, "]", 3624670792u, 0, 1, NULL);
be_define_const_str(_, "_", 3658226030u, 0, 1, &be_const_str_code);
be_define_const_str(__iterator__, "__iterator__", 3884039703u, 0, 12, &be_const_str_deregister_obj);
...
be_define_const_str(_anonymous_, "_anonymous_", 1957281476u, 0, 11, &be_const_str_lv_event_cb);
be_define_const_str(_archive, "_archive", 4004559404u, 0, 8, &be_const_str_set_percentage);
be_define_const_str(_available, "_available", 1306196581u, 0, 10, &be_const_str_draw_line);
...
be_define_const_str(_ccmd, "_ccmd", 2163421413u, 0, 5, &be_const_str_line_dsc);
be_define_const_str(_class, "_class", 2732146350u, 0, 6, &be_const_str__debug_present);
be_define_const_str(_cmd, "_cmd", 3419822142u, 0, 4, &be_const_str_event_cb);
be_define_const_str(_debug_present, "_debug_present", 4063411725u, 0, 14, &be_const_str_clear_to);
be_define_const_str(_def, "_def", 1985022181u, 0, 4, &be_const_str_autoexec);
be_define_const_str(_dirty, "_dirty", 283846766u, 0, 6, &be_const_str_deg);
...
be_define_const_str(_energy, "_energy", 535372070u, 0, 7, &be_const_str_lv_solidified);
be_define_const_str(_error, "_error", 1132109656u, 0, 6, NULL);
be_define_const_str(_filename, "_filename", 1430813195u, 0, 9, NULL);
be_define_const_str(_fl, "_fl", 4042564892u, 0, 3, &be_const_str__p);
...
be_define_const_str(_lvgl, "_lvgl", 2689219483u, 0, 5, &be_const_str_add_rule);
be_define_const_str(_p, "_p", 1594591802u, 0, 2, NULL);
be_define_const_str(_persist_X2Ejson, "_persist.json", 2008425138u, 0, 13, &be_const_str_compile);
be_define_const_str(_ptr, "_ptr", 306235816u, 0, 4, &be_const_str_real);
be_define_const_str(_read, "_read", 346717030u, 0, 5, &be_const_str_imax);
be_define_const_str(_request_from, "_request_from", 3965148604u, 0, 13, &be_const_str__X7Bs_X7DBatt_X20Voltage_X7Bm_X7D_X25_X2E3f_X20V_X7Be_X7D);
be_define_const_str(_rules, "_rules", 4266217105u, 0, 6, &be_const_str_font_seg7);
be_define_const_str(_settings_def, "_settings_def", 3775560307u, 0, 13, &be_const_str_draw_arc_dsc);
...
be_define_const_str(_timers, "_timers", 2600100916u, 0, 7, &be_const_str_value_error);
...
be_define_const_str(add_anim, "add_anim", 3980662668u, 0, 8, &be_const_str_instance_size);
be_define_const_str(add_cmd, "add_cmd", 3361630879u, 0, 7, &be_const_str_traceback);
be_define_const_str(add_driver, "add_driver", 1654458371u, 0, 10, NULL);
be_define_const_str(add_event_cb, "add_event_cb", 633097693u, 0, 12, &be_const_str_create_matrix);
...
be_define_const_str(addr, "addr", 1087856498u, 0, 4, &be_const_str_ctypes_bytes);
...
be_define_const_str(animate, "animate", 3885786800u, 0, 7, &be_const_str_register_button_encoder);
be_define_const_str(animators, "animators", 279858213u, 0, 9, &be_const_str_read_bytes);
be_define_const_str(arc_dsc, "arc_dsc", 2768816310u, 0, 7, &be_const_str_connection_error);
be_define_const_str(arch, "arch", 2952804297u, 0, 4, NULL);
be_define_const_str(area, "area", 2601460036u, 0, 4, &be_const_str_content_stop);
be_define_const_str(arg, "arg", 1047474471u, 0, 3, &be_const_str_draw_line_dsc_init);
...
be_define_const_str(arg_size, "arg_size", 3310243257u, 0, 8, &be_const_str_decode);
...
be_define_const_str(assert, "assert", 2774883451u, 0, 6, &be_const_str_ip);
be_define_const_str(asstring, "asstring", 1298225088u, 0, 8, &be_const_str_pixel_count);
be_define_const_str(atan, "atan", 108579519u, 0, 4, &be_const_str_tolower);
be_define_const_str(atan2, "atan2", 3173440503u, 0, 5, &be_const_str_get_bat_current);
be_define_const_str(atleast1, "atleast1", 1956331672u, 0, 8, &be_const_str_remote_port);
...
be_define_const_str(autorun, "autorun", 1447527407u, 0, 7, &be_const_str_load_freetype_font);
...
be_define_const_str(base_class, "base_class", 1107737279u, 0, 10, &be_const_str__X7B);
be_define_const_str(battery_present, "battery_present", 3588397058u, 0, 15, NULL);
be_define_const_str(before_del, "before_del", 815924436u, 0, 10, &be_const_str_get_warning_level);
be_define_const_str(begin, "begin", 1748273790u, 0, 5, &be_const_str_resolvecmnd);
be_define_const_str(begin_multicast, "begin_multicast", 57647915u, 0, 15, &be_const_str_set_xy);
...
be_define_const_str(call, "call", 3018949801u, 0, 4, &be_const_str_h);
be_define_const_str(call_native, "call_native", 1389147405u, 0, 11, &be_const_str_set_auth);
...
be_define_const_str(cb_do_nothing, "cb_do_nothing", 1488730702u, 0, 13, &be_const_str_couldn_X27t_X20not_X20initialize_X20noepixelbus);
be_define_const_str(cb_event_closure, "cb_event_closure", 3828267325u, 0, 16, &be_const_str_get_bri);
be_define_const_str(cb_obj, "cb_obj", 1195696482u, 0, 6, &be_const_str_y1);
be_define_const_str(ceil, "ceil", 1659167240u, 0, 4, &be_const_str_last_modified);
...
be_define_const_str(check_privileged_access, "check_privileged_access", 3692933968u, 0, 23, &be_const_str_read13);
...
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_ins_time);
be_define_const_str(classof, "classof", 1796577762u, 0, 7, NULL);
be_define_const_str(clear, "clear", 1550717474u, 0, 5, &be_const_str_https_X3A_X2F_X2Fraw_X2Egithubusercontent_X2Ecom_X2Ftasmota_X2Fautoconf_X2Fmain_X2F_X25s_X2F_X25s_X2Eautoconf);
be_define_const_str(clear_first_time, "clear_first_time", 632769909u, 0, 16, &be_const_str_target);
be_define_const_str(clear_to, "clear_to", 3528002130u, 0, 8, &be_const_str_geti);
be_define_const_str(clock_icon, "clock_icon", 544669651u, 0, 10, &be_const_str_y);
be_define_const_str(close, "close", 667630371u, 0, 5, NULL);
be_define_const_str(closure, "closure", 1548407746u, 0, 7, &be_const_str_setmember);
be_define_const_str(cmd, "cmd", 4136785899u, 0, 3, &be_const_str_event);
be_define_const_str(cmd_res, "cmd_res", 921166762u, 0, 7, &be_const_str_connect);
be_define_const_str(code, "code", 4180765940u, 0, 4, &be_const_str_min);
be_define_const_str(codedump, "codedump", 1786337906u, 0, 8, &be_const_str_i2c_enabled);
...
be_define_const_str(concat, "concat", 4124019837u, 0, 6, &be_const_str_font_montserrat);
be_define_const_str(connect, "connect", 2866859257u, 0, 7, &be_const_str_contains);
...
be_define_const_str(constructor_cb, "constructor_cb", 2489105297u, 0, 14, &be_const_str_sinh);
be_define_const_str(consume_mono, "consume_mono", 3577563453u, 0, 12, NULL);
be_define_const_str(consume_silence, "consume_silence", 1445390925u, 0, 15, &be_const_str_log10);
be_define_const_str(consume_stereo, "consume_stereo", 1834661098u, 0, 14, &be_const_str_create_custom_widget);
be_define_const_str(contains, "contains", 1825239352u, 0, 8, NULL);
be_define_const_str(content_button, "content_button", 1956476087u, 0, 14, &be_const_str_format);
be_define_const_str(content_flush, "content_flush", 214922475u, 0, 13, &be_const_str_list);
be_define_const_str(content_send, "content_send", 1673733649u, 0, 12, &be_const_str_montserrat_font);
...
be_define_const_str(content_stop, "content_stop", 658554751u, 0, 12, &be_const_str_set_dcdc_enable);
be_define_const_str(continue, "continue", 2977070660u, 59, 8, NULL);
be_define_const_str(coord_arr, "coord_arr", 4189963658u, 0, 9, &be_const_str_day);
be_define_const_str(copy, "copy", 3848464964u, 0, 4, &be_const_str_internal_error);
be_define_const_str(cos, "cos", 4220379804u, 0, 3, &be_const_str_every_100ms);
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, &be_const_str_digital_write);
...
be_define_const_str(count, "count", 967958004u, 0, 5, &be_const_str_loop);
...
be_define_const_str(create_segment, "create_segment", 3863522719u, 0, 14, &be_const_str_lv_obj);
...
be_define_const_str(decrypt, "decrypt", 2886974618u, 0, 7, &be_const_str_energy_struct);
be_define_const_str(def, "def", 3310976652u, 55, 3, NULL);
be_define_const_str(deg, "deg", 3327754271u, 0, 3, &be_const_str_get_light);
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, &be_const_str_tan);
be_define_const_str(delay, "delay", 1322381784u, 0, 5, &be_const_str_instance_X20required);
be_define_const_str(delete_all_configs, "delete_all_configs", 2382067578u, 0, 18, &be_const_str_get_bat_voltage);
be_define_const_str(depower, "depower", 3563819571u, 0, 7, &be_const_str_resp_cmnd);
be_define_const_str(deregister_obj, "deregister_obj", 3909966993u, 0, 14, &be_const_str_touch_update);
be_define_const_str(destructor_cb, "destructor_cb", 1930283190u, 0, 13, &be_const_str_running);
...
be_define_const_str(digital_write, "digital_write", 3435877979u, 0, 13, &be_const_str_scale_uint);
be_define_const_str(dimmer, "dimmer", 794270539u, 0, 6, &be_const_str_erase);
be_define_const_str(dirty, "dirty", 2667581083u, 0, 5, &be_const_str_select);
be_define_const_str(display, "display", 1164572437u, 0, 7, &be_const_str_readline);
...
be_define_const_str(draw_arc_dsc_init, "draw_arc_dsc_init", 402724044u, 0, 17, &be_const_str_toptr);
be_define_const_str(draw_ctx, "draw_ctx", 953366593u, 0, 8, &be_const_str_height_def);
be_define_const_str(draw_line, "draw_line", 1634465686u, 0, 9, &be_const_str_send);
be_define_const_str(draw_line_dsc, "draw_line_dsc", 4220676203u, 0, 13, &be_const_str_srand);
be_define_const_str(draw_line_dsc_init, "draw_line_dsc_init", 3866693646u, 0, 18, &be_const_str_get_battery_chargin_status);
...
be_define_const_str(duration, "duration", 799079693u, 0, 8, &be_const_str_isrunning);
...
be_define_const_str(engine, "engine", 3993360443u, 0, 6, &be_const_str_escape);
be_define_const_str(erase, "erase", 1010949589u, 0, 5, &be_const_str_is_first_time);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, NULL);
be_define_const_str(eth, "eth", 2191266556u, 0, 3, NULL);
be_define_const_str(event, "event", 4264611999u, 0, 5, &be_const_str_seti);
be_define_const_str(event_cb, "event_cb", 3128698017u, 0, 8, &be_const_str_resp_cmnd_failed);
...
be_define_const_str(every_50ms, "every_50ms", 2383884008u, 0, 10, &be_const_str_widget_struct_default);
be_define_const_str(every_second, "every_second", 2075451465u, 0, 12, &be_const_str_raise);
...
be_define_const_str(exists, "exists", 1002329533u, 0, 6, &be_const_str_json_fdump_map);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_register_obj);
...
be_define_const_str(fast_loop_enabled, "fast_loop_enabled", 2567964376u, 0, 17, &be_const_str_set_style_line_color);
...
be_define_const_str(files, "files", 1055342736u, 0, 5, &be_const_str_gen_cb);
be_define_const_str(find, "find", 3186656602u, 0, 4, &be_const_str_remove_cmd);
be_define_const_str(find_key_i, "find_key_i", 850136726u, 0, 10, NULL);
be_define_const_str(find_op, "find_op", 3766713376u, 0, 7, NULL);
be_define_const_str(finish, "finish", 1494643858u, 0, 6, &be_const_str_target_search);
be_define_const_str(floor, "floor", 3102149661u, 0, 5, &be_const_str_tele);
be_define_const_str(flush, "flush", 3002334877u, 0, 5, &be_const_str_while);
be_define_const_str(font_embedded, "font_embedded", 1623675143u, 0, 13, &be_const_str_rounded);
be_define_const_str(font_montserrat, "font_montserrat", 3790091262u, 0, 15, &be_const_str_reset);
be_define_const_str(font_seg7, "font_seg7", 1551771835u, 0, 9, &be_const_str_has);
...
be_define_const_str(fromptr, "fromptr", 666189689u, 0, 7, &be_const_str_set_huesat);
be_define_const_str(fromstring, "fromstring", 610302344u, 0, 10, NULL);
be_define_const_str(function, "function", 2664841801u, 0, 8, &be_const_str_is_running);
be_define_const_str(gamma, "gamma", 3492353034u, 0, 5, &be_const_str_hs2rgb);
...
be_define_const_str(get_alternate, "get_alternate", 1450148894u, 0, 13, &be_const_str_set_style_pad_right);
be_define_const_str(get_aps_voltage, "get_aps_voltage", 2293036435u, 0, 15, &be_const_str_lower);
...
be_define_const_str(get_bri, "get_bri", 2041809895u, 0, 7, &be_const_str_ins_ramp);
...
be_define_const_str(get_current_module_name, "get_current_module_name", 2379270740u, 0, 23, &be_const_str_get_width);
be_define_const_str(get_current_module_path, "get_current_module_path", 3206673408u, 0, 23, &be_const_str_save_before_restart);
be_define_const_str(get_free_heap, "get_free_heap", 625069757u, 0, 13, &be_const_str_minute);
be_define_const_str(get_height, "get_height", 3571755523u, 0, 10, NULL);
be_define_const_str(get_input_power_status, "get_input_power_status", 4102829177u, 0, 22, &be_const_str_time_dump);
be_define_const_str(get_light, "get_light", 381930476u, 0, 9, NULL);
be_define_const_str(get_log, "get_log", 3524441898u, 0, 7, NULL);
be_define_const_str(get_object_from_ptr, "get_object_from_ptr", 2345019201u, 0, 19, &be_const_str_read_sensors);
...
be_define_const_str(get_power, "get_power", 3009799377u, 0, 9, &be_const_str_push_path);
be_define_const_str(get_size, "get_size", 2803644713u, 0, 8, NULL);
be_define_const_str(get_string, "get_string", 4195847969u, 0, 10, &be_const_str_set_style_text_font);
be_define_const_str(get_style_bg_color, "get_style_bg_color", 964794381u, 0, 18, &be_const_str_response_append);
...
be_define_const_str(get_switch, "get_switch", 164821028u, 0, 10, &be_const_str_time_reached);
be_define_const_str(get_temp, "get_temp", 3370919486u, 0, 8, &be_const_str_keys);
be_define_const_str(get_vbus_current, "get_vbus_current", 1205347942u, 0, 16, &be_const_str_set_ct);
be_define_const_str(get_vbus_voltage, "get_vbus_voltage", 2398210401u, 0, 16, NULL);
be_define_const_str(get_warning_level, "get_warning_level", 1737834441u, 0, 17, &be_const_str_r);
...
be_define_const_str(group_def, "group_def", 1524213328u, 0, 9, &be_const_str_wire2);
be_define_const_str(h, "h", 3977000791u, 0, 1, &be_const_str_settings);
be_define_const_str(has, "has", 3988721635u, 0, 3, &be_const_str_lv_module_init);
be_define_const_str(has_X20already_X20an_X20event_X20callback, "has already an event callback", 2421565249u, 0, 29, &be_const_str_lv_signal_bars);
be_define_const_str(has_arg, "has_arg", 424878688u, 0, 7, &be_const_str_tcpclient);
be_define_const_str(height_def, "height_def", 2348238838u, 0, 10, NULL);
be_define_const_str(hex, "hex", 4273249610u, 0, 3, &be_const_str_lv_wifi_bars_icon);
...
be_define_const_str(https_X3A_X2F_X2Fraw_X2Egithubusercontent_X2Ecom_X2Ftasmota_X2Fautoconf_X2Fmain_X2F_X25s_manifest_X2Ejson, "https://raw.githubusercontent.com/tasmota/autoconf/main/%s_manifest.json", 3657552045u, 0, 72, &be_const_str_json_fdump_any);
be_define_const_str(i2c_enabled, "i2c_enabled", 218388101u, 0, 11, &be_const_str_set_y);
be_define_const_str(id, "id", 926444256u, 0, 2, &be_const_str_else);
...
be_define_const_str(ins_ramp, "ins_ramp", 1068049360u, 0, 8, &be_const_str_wire_scan);
be_define_const_str(ins_time, "ins_time", 2980245553u, 0, 8, NULL);
be_define_const_str(insert, "insert", 3332609576u, 0, 6, NULL);
be_define_const_str(instance, "instance", 193386898u, 0, 8, &be_const_str_json_fdump_list);
...
be_define_const_str(introspect, "introspect", 164638290u, 0, 10, &be_const_str_set_mode_rgb);
...
be_define_const_str(ip, "ip", 1261996636u, 0, 2, &be_const_str_reverse);
...
be_define_const_str(ismethod, "ismethod", 3513438880u, 0, 8, &be_const_str_uuid4);
...
be_define_const_str(json, "json", 916562499u, 0, 4, &be_const_str_skip);
...
be_define_const_str(leds, "leds", 558858555u, 0, 4, &be_const_str_module);
...
be_define_const_str(list, "list", 217798785u, 0, 4, &be_const_str_read12);
be_define_const_str(list_handlers, "list_handlers", 593774371u, 0, 13, &be_const_str_readbytes);
be_define_const_str(listdir, "listdir", 2005220720u, 0, 7, &be_const_str_widget_group_def);
be_define_const_str(load, "load", 3859241449u, 0, 4, NULL);
be_define_const_str(load_freetype_font, "load_freetype_font", 2368447592u, 0, 18, &be_const_str_web_add_console_button);
be_define_const_str(load_templates, "load_templates", 3513870133u, 0, 14, NULL);
be_define_const_str(local, "local", 2621662984u, 0, 5, &be_const_str_wire);
...
be_define_const_str(lv_obj, "lv_obj", 4257833149u, 0, 6, &be_const_str_p1);
be_define_const_str(lv_obj_class, "lv_obj_class", 4039656294u, 0, 12, NULL);
be_define_const_str(lv_point, "lv_point", 4120221790u, 0, 8, &be_const_str_valuer_error);
...
be_define_const_str(lv_solidified, "lv_solidified", 2274121310u, 0, 13, &be_const_str_quality);
be_define_const_str(lv_wifi_arcs, "lv_wifi_arcs", 2082091963u, 0, 12, &be_const_str_top);
be_define_const_str(lv_wifi_arcs_icon, "lv_wifi_arcs_icon", 1507982909u, 0, 17, &be_const_str_web_add_main_button);
be_define_const_str(lv_wifi_bars, "lv_wifi_bars", 2109539196u, 0, 12, &be_const_str_write_bit);
...
be_define_const_str(make_cb, "make_cb", 71252785u, 0, 7, &be_const_str_set_timeouts);
be_define_const_str(map, "map", 3751997361u, 0, 3, &be_const_str_redirect);
be_define_const_str(math, "math", 4001929615u, 0, 4, &be_const_str_import);
...
be_define_const_str(memory, "memory", 2229924270u, 0, 6, &be_const_str_widget_dtor_impl);
be_define_const_str(millis, "millis", 1214679063u, 0, 6, &be_const_str_webserver);
be_define_const_str(min, "min", 3381609815u, 0, 3, &be_const_str_set_ldo_voltage);
be_define_const_str(minute, "minute", 954666857u, 0, 6, NULL);
be_define_const_str(module, "module", 3617558685u, 0, 6, NULL);
be_define_const_str(month, "month", 3598321157u, 0, 5, &be_const_str_set_matrix_pixel_color);
...
be_define_const_str(no_X20GPIO_X20specified_X20for_X20neopixelbus, "no GPIO specified for neopixelbus", 42078528u, 0, 33, &be_const_str_strip);
be_define_const_str(null_cb, "null_cb", 2333536460u, 0, 7, &be_const_str_width);
be_define_const_str(number, "number", 467038368u, 0, 6, NULL);
be_define_const_str(obj_class_create_obj, "obj_class_create_obj", 3304390632u, 0, 20, &be_const_str_persist_X2E_p_X20is_X20not_X20a_X20map);
...
be_define_const_str(onsubmit_X3D_X27return_X20confirm_X28_X22This_X20will_X20change_X20the_X20current_X20configuration_X20and_X20cause_X20a_X20restart_X2E_X22_X29_X3B_X27_X3E, "onsubmit='return confirm(\"This will change the current configuration and cause a restart.\");'>", 3792412559u, 0, 94, &be_const_str_tag);
be_define_const_str(open, "open", 3546203337u, 0, 4, NULL);
be_define_const_str(out_X20of_X20range, "out of range", 2236631477u, 0, 12, &be_const_str_web_add_handler);
be_define_const_str(p1, "p1", 2689521274u, 0, 2, &be_const_str_widget_event_cb);
...
be_define_const_str(page_autoconf_mgr, "page_autoconf_mgr", 3643937031u, 0, 17, &be_const_str_webclient);
...
be_define_const_str(pc_rel, "pc_rel", 991921176u, 0, 6, &be_const_str_true);
be_define_const_str(percentage, "percentage", 2538831285u, 0, 10, &be_const_str_pin);
...
be_define_const_str(pin, "pin", 1866532500u, 0, 3, &be_const_str_state);
be_define_const_str(pin_mode, "pin_mode", 3258314030u, 0, 8, NULL);
be_define_const_str(pin_used, "pin_used", 4033854612u, 0, 8, &be_const_str_upper);
...
be_define_const_str(pixels_buffer, "pixels_buffer", 1229555807u, 0, 13, &be_const_str_web_sensor);
...
be_define_const_str(public_key, "public_key", 4169142980u, 0, 10, &be_const_str_set_text);
be_define_const_str(publish, "publish", 264247304u, 0, 7, &be_const_str_wire1);
be_define_const_str(publish_result, "publish_result", 2013351252u, 0, 14, &be_const_str_set_x);
be_define_const_str(push, "push", 2272264157u, 0, 4, &be_const_str_run);
be_define_const_str(push_path, "push_path", 1155254157u, 0, 9, &be_const_str_reapply);
be_define_const_str(quality, "quality", 2597670950u, 0, 7, &be_const_str_try_rule);
...
be_define_const_str(read12, "read12", 4291076970u, 0, 6, &be_const_str_web_add_config_button);
be_define_const_str(read13, "read13", 12887293u, 0, 6, &be_const_str_set_exten);
...
be_define_const_str(real, "real", 3604983901u, 0, 4, &be_const_str_widget_event);
...
be_define_const_str(remove_cmd, "remove_cmd", 3832315702u, 0, 10, &be_const_str_setbits);
...
be_define_const_str(reset, "reset", 1695364032u, 0, 5, &be_const_str_widget_width_def);
...
be_define_const_str(resp_cmnd_done, "resp_cmnd_done", 2601874875u, 0, 14, &be_const_str_for);
...
be_define_const_str(resp_cmnd_str, "resp_cmnd_str", 737845590u, 0, 13, &be_const_str_url_encode);
...
be_define_const_str(return_X20code_X3D_X25i, "return code=%i", 2127454401u, 0, 14, &be_const_str_toupper);
...
be_define_const_str(rounded, "rounded", 1920734138u, 0, 7, &be_const_str_wifi_bars);
...
be_define_const_str(scan, "scan", 3974641896u, 0, 4, &be_const_str_set_ldo_enable);
...
be_define_const_str(send_multicast, "send_multicast", 812185870u, 0, 14, &be_const_str_zero);
be_define_const_str(serial, "serial", 3687697785u, 0, 6, &be_const_str_widget_ctor_cb);
be_define_const_str(set, "set", 3324446467u, 0, 3, NULL);
be_define_const_str(set_alternate, "set_alternate", 1709680562u, 0, 13, &be_const_str_do);
be_define_const_str(set_auth, "set_auth", 1057170930u, 0, 8, &be_const_str_set_rgb);
...
be_define_const_str(set_channels, "set_channels", 1370190620u, 0, 12, &be_const_str_set_first_time);
...
be_define_const_str(set_dc_voltage, "set_dc_voltage", 2181981936u, 0, 14, &be_const_str_split);
be_define_const_str(set_dcdc_enable, "set_dcdc_enable", 1594690786u, 0, 15, NULL);
be_define_const_str(set_exten, "set_exten", 1721782768u, 0, 9, &be_const_str_set_timer);
...
be_define_const_str(set_height, "set_height", 1080207399u, 0, 10, &be_const_str_width_def);
...
be_define_const_str(set_ldo_voltage, "set_ldo_voltage", 4090501160u, 0, 15, &be_const_str_widget_cb);
...
be_define_const_str(set_mode_ct, "set_mode_ct", 665073295u, 0, 11, &be_const_str_signal_bars);
...
be_define_const_str(set_pixel_color, "set_pixel_color", 1275248356u, 0, 15, &be_const_str__X7Bs_X7DTemp_X20AXP_X7Bm_X7D_X25_X2E1f_X20_X26deg_X3BC_X7Be_X7D);
...
be_define_const_str(set_style_bg_color, "set_style_bg_color", 1689513089u, 0, 18, &be_const_str_udp);
...
be_define_const_str(set_timer, "set_timer", 2135414533u, 0, 9, &be_const_str_web_send);
...
be_define_const_str(seti, "seti", 1500556254u, 0, 4, &be_const_str_type_error);
be_define_const_str(setitem, "setitem", 1554834596u, 0, 7, NULL);
be_define_const_str(setmember, "setmember", 1432909441u, 0, 9, &be_const_str_show);
...
be_define_const_str(show, "show", 2840060476u, 0, 4, &be_const_str_tomap);
be_define_const_str(signal_arcs, "signal_arcs", 1505996127u, 0, 11, &be_const_str_tanh);
...
be_define_const_str(sqrt, "sqrt", 2112764879u, 0, 4, &be_const_str_the_X20second_X20argument_X20is_X20not_X20a_X20function);
be_define_const_str(srand, "srand", 465518633u, 0, 5, NULL);
be_define_const_str(start, "start", 1697318111u, 0, 5, &be_const_str__X7Bs_X7DBatt_X20Current_X7Bm_X7D_X25_X2E1f_X20mA_X7Be_X7D);
...
be_define_const_str(super, "super", 4152230356u, 0, 5, &be_const_str_widget_editable);
...
be_define_const_str(udp, "udp", 1253872004u, 0, 3, &be_const_str_wifi_arcs);
...
be_define_const_str(widget_editable, "widget_editable", 3821793286u, 0, 15, &be_const_str_year);
be_define_const_str(widget_event, "widget_event", 1951408186u, 0, 12, &be_const_str__X7B_X7D);
...
be_define_const_str(wifi_arcs, "wifi_arcs", 3838492904u, 0, 9, &be_const_str_yield);
...
be_define_const_str(wire, "wire", 4082753944u, 0, 4, &be_const_str_as);
be_define_const_str(wire1, "wire1", 3212721419u, 0, 5, &be_const_str_write);
...
be_define_const_str(x1, "x1", 274927234u, 0, 2, &be_const_str_class);
be_define_const_str(y, "y", 4228665076u, 0, 1, NULL);
be_define_const_str(y1, "y1", 2355101727u, 0, 2, &be_const_str_def);
be_define_const_str(year, "year", 2927578396u, 0, 4, &be_const_str_try);
...
be_define_const_str(_X7Bs_X7DVBus_X20Voltage_X7Bm_X7D_X25_X2E3f_X20V_X7Be_X7D, "{s}VBus Voltage{m}%.3f V{e}", 165651270u, 0, 27, &be_const_str_nil);
