...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(_rules, 58), be_const_var(1) },
    { be_const_key(get_switch, 29), be_const_func(l_getswitch) },
    { be_const_key(_debug_present, 38), be_const_var(2) },
    { be_const_key(find_op, 4), be_const_closure(Tasmota_find_op_closure) },
    { be_const_key(wire1, -1), be_const_var(3) },
    { be_const_key(resp_cmnd_failed, 24), be_const_func(l_respCmndFailed) },
    { be_const_key(exec_cmd, 57), be_const_closure(Tasmota_exec_cmd_closure) },
    { be_const_key(time_reached, -1), be_const_func(l_timereached) },
    { be_const_key(resp_cmnd_done, -1), be_const_func(l_respCmndDone) },
    { be_const_key(hs2rgb, 41), be_const_closure(Tasmota_hs2rgb_closure) },
    { be_const_key(gc, -1), be_const_closure(Tasmota_gc_closure) },
    { be_const_key(kv, -1), be_const_closure(Tasmota_kv_closure) },
    { be_const_key(add_rule, -1), be_const_closure(Tasmota_add_rule_closure) },
    { be_const_key(scale_uint, -1), be_const_func(l_scaleuint) },
    { be_const_key(event, 40), be_const_closure(Tasmota_event_closure) },
    { be_const_key(rtc, 23), be_const_func(l_rtc) },
    { be_const_key(cmd_res, -1), be_const_var(4) },
    ...
    { be_const_key(read_sensors, 16), be_const_func(l_read_sensors) },
    ...
    { be_const_key(run_deferred, 26), be_const_closure(Tasmota_run_deferred_closure) },
    { be_const_key(init, -1), be_const_closure(Tasmota_init_closure) },
    { be_const_key(remove_cmd, 67), be_const_closure(Tasmota_remove_cmd_closure) },
    { be_const_key(random_byte, 14), be_const_func(t_random_byte) },
    { be_const_key(_cmd, 70), be_const_func(l_cmd) },
    ...
    { be_const_key(_settings_ptr, 56), be_const_comptr(&Settings) },
    ...
    { be_const_key(wire_scan, 68), be_const_closure(Tasmota_wire_scan_closure) },
    { be_const_key(strptime, -1), be_const_func(l_strptime) },
    { be_const_key(_global_addr, 55), be_const_comptr(&TasmotaGlobal) },
    ...
    { be_const_key(set_power, 21), be_const_func(l_setpower) },
    ...
    { be_const_key(wd, -1), be_const_var(9) },
