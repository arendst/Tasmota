...
static be_define_const_map_slots(be_class_bytes_map) {
    ...
    { be_const_key(add, 21), be_const_func(m_add) },
    { be_const_key(geti, 6), be_const_func(m_geti) },
    ...
    { be_const_key(appendhex, 34), be_const_func(m_appendhex) },
    ...
    { be_const_key(deinit, 14), be_const_func(m_deinit) },
    { be_const_key(init, 8), be_const_func(m_init) },
    { be_const_key(setbytes, 32), be_const_func(m_setbytes) },
    ...
    { be_const_key(item, 16), be_const_func(m_item) },
    { be_const_key(addfloat, 35), be_const_func(m_addfloat) },
    { be_const_key(_X2E_X2E, -1), be_const_func(m_connect) },
    { be_const_key(tostring, -1), be_const_func(m_tostring) },
    { be_const_key(_X2Ep, -1), be_const_var(0) },
    { be_const_key(setfloat, 25), be_const_func(m_setfloat) },
    { be_const_key(setitem, 36), be_const_func(m_setitem) },
    { be_const_key(append, -1), be_const_func(m_connect) },
    { be_const_key(seti, 12), be_const_func(m_set) },
    { be_const_key(get, -1), be_const_func(m_getu) },
    { be_const_key(tobool, 15), be_const_func(m_tobool) },
