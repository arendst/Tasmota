/********************************************************************
 * Berry module `partition_core`
 * 
 * To use: `import partition_core`
 * 
 *******************************************************************/
...
be_local_class(Partition_otadata,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key(seq1, 0), be_const_var(5) },
        ...
        { be_const_key(init, 13), be_const_closure(Partition_otadata_init_closure) },
        { be_const_key(has_factory, -1), be_const_var(1) },
        { be_const_key(load, 11), be_const_closure(Partition_otadata_load_closure) },
        { be_const_key(seq0, 9), be_const_var(4) },
        { be_const_key(offset, -1), be_const_var(2) },
        { be_const_key(active_otadata, 8), be_const_var(3) },
...
be_local_class(Partition,
    ...
    be_nested_map(19,
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key(raw, 18), be_const_var(0) },
        { be_const_key(otadata, 11), be_const_var(3) },
        { be_const_key(tostring, 3), be_const_closure(Partition_tostring_closure) },
        ...
        { be_const_key(set_active, 6), be_const_closure(Partition_set_active_closure) },
        { be_const_key(get_factory_slot, 17), be_const_closure(Partition_get_factory_slot_closure) },
        { be_const_key(parse, -1), be_const_closure(Partition_parse_closure) },
        { be_const_key(get_ota_slot, 15), be_const_closure(Partition_get_ota_slot_closure) },
        { be_const_key(tobytes, -1), be_const_closure(Partition_tobytes_closure) },
        { be_const_key(slots, 1), be_const_var(2) },
        { be_const_key(save, 12), be_const_closure(Partition_save_closure) },
...
be_local_class(Partition_info,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key(subtype_to_string, 4), be_const_closure(Partition_info_subtype_to_string_closure) },
        { be_const_key(init, -1), be_const_closure(Partition_info_init_closure) },
        { be_const_key(type_to_string, 10), be_const_closure(Partition_info_type_to_string_closure) },
        ...
        { be_const_key(is_spiffs, 14), be_const_closure(Partition_info_is_spiffs_closure) },
        { be_const_key(subtype, 11), be_const_var(1) },
        { be_const_key(label, -1), be_const_var(4) },
        { be_const_key(flags, 6), be_const_var(5) },
        { be_const_key(type, 2), be_const_var(0) },
        { be_const_key(remove_trailing_zeroes, -1), be_const_static_closure(Partition_info_remove_trailing_zeroes_closure) },
