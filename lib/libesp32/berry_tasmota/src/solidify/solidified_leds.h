...
// compact class 'Leds' ktab size: 38, total: 68 (saved 240 bytes)
static const bvalue be_ktab_class_Leds[38] = {
  /* K0   */  be_nested_str(call_native),
  /* K1   */  be_nested_str(can_show),
  /* K2   */  be_nested_str(tasmota),
  /* K3   */  be_nested_str(yield),
  /* K4   */  be_nested_str(bri),
  /* K5   */  be_nested_str(to_gamma),
  /* K6   */  be_nested_str(animate),
  /* K7   */  be_nested_str(pixel_size),
  /* K8   */  be_nested_str(pixel_count),
  /* K9   */  be_nested_str(_change_buffer),
  /* K10  */  be_nested_str(leds),
  /* K11  */  be_const_int(0),
  /* K12  */  be_nested_str(value_error),
  /* K13  */  be_nested_str(out_X20of_X20range),
  /* K14  */  be_const_class(be_class_Leds_segment),
  /* K15  */  be_const_int(2),
  /* K16  */  be_nested_str(gamma),
  /* K17  */  be_nested_str(apply_bri_gamma),
  /* K18  */  be_nested_str(WS2812_GRB),
  /* K19  */  be_const_int(3),
  /* K20  */  be_nested_str(gpio),
  /* K21  */  be_nested_str(pin),
  /* K22  */  be_nested_str(WS2812),
  /* K23  */  be_nested_str(ctor),
  /* K24  */  be_nested_str(light),
  /* K25  */  be_nested_str(get),
  /* K26  */  be_nested_str(global),
  /* K27  */  be_nested_str(contains),
  /* K28  */  be_nested_str(_lhw),
  /* K29  */  be_nested_str(find),
  /* K30  */  be_nested_str(number_X20of_X20leds_X20do_X20not_X20match_X20with_X20previous_X20instanciation_X20_X25s_X20vs_X20_X25s),
  /* K31  */  be_nested_str(_p),
  /* K32  */  be_nested_str(begin),
  /* K33  */  be_nested_str(internal_error),
  /* K34  */  be_nested_str(couldn_X27t_X20not_X20initialize_X20noepixelbus),
  /* K35  */  be_const_int(1),
  /* K36  */  be_nested_str(clear_to),
  /* K37  */  be_nested_str(show),
};
...
be_local_closure(class_Leds_clear_to,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[28]) {  /* code */
      ...
      0x8C200105,  //  000C  GETMET	R8	R0	K5
      ...
      0x8C200105,  //  0016  GETMET	R8	R0	K5
...
be_local_closure(class_Leds_set_pixel_color,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[13]) {  /* code */
      ...
      0x8C200105,  //  0007  GETMET	R8	R0	K5
...
be_local_closure(class_Leds_pixels_buffer,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[27]) {  /* code */
      ...
      0x8C0C0107,  //  0003  GETMET	R3	R0	K7
      0x7C0C0200,  //  0004  CALL	R3	1
      0x8C100108,  //  0005  GETMET	R4	R0	K8
      ...
      0x8C100309,  //  0016  GETMET	R4	R1	K9
...
be_local_closure(class_Leds_create_segment,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[23]) {  /* code */
      ...
      0xB006190D,  //  000E  RAISE	1	K12	K13
      0x580C000E,  //  000F  LDCONST	R3	K14
      0xB400000E,  //  0010  CLASS	K14
...
be_local_closure(class_Leds_show,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[ 4]) {  /* code */
      ...
      0x580C000F,  //  0001  LDCONST	R3	K15
      0x7C040400,  //  0002  CALL	R1	2
      0x80000000,  //  0003  RET	0
    })
  )
...
be_local_closure(class_Leds_to_gamma,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[10]) {  /* code */
      ...
      0x881C0110,  //  0007  GETMBR	R7	R0	K16
...
be_local_closure(class_Leds_can_show,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[ 4]) {  /* code */
      0x8C040100,  //  0000  GETMET	R1	R0	K0
      0x580C0013,  //  0001  LDCONST	R3	K19
      0x7C040400,  //  0002  CALL	R1	2
      0x80040200,  //  0003  RET	1	R1
    })
  )
...
be_local_closure(class_Leds_init,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[90]) {  /* code */
      0xA4162800,  //  0000  IMPORT	R5	K20
      0x50180200,  //  0001  LDBOOL	R6	1	0
      0x90022006,  //  0002  SETMBR	R0	K16	R6
      ...
      0x8C180B15,  //  0009  GETMET	R6	R5	K21
      0x88200B16,  //  000A  GETMBR	R8	R5	K22
      0x5824000B,  //  000B  LDCONST	R9	K11
      0x7C180600,  //  000C  CALL	R6	3
      0x1C180406,  //  000D  EQ	R6	R2	R6
      0x781A000A,  //  000E  JMPF	R6	#001A
      0x8C180117,  //  000F  GETMET	R6	R0	K23
      0x7C180200,  //  0010  CALL	R6	1
      0x8C180108,  //  0011  GETMET	R6	R0	K8
      0x7C180200,  //  0012  CALL	R6	1
      0x90021406,  //  0013  SETMBR	R0	K10	R6
      0xA41A3000,  //  0014  IMPORT	R6	K24
      0x8C1C0D19,  //  0015  GETMET	R7	R6	K25
      0x7C1C0200,  //  0016  CALL	R7	1
      0x941C0F04,  //  0017  GETIDX	R7	R7	K4
      0x90020807,  //  0018  SETMBR	R0	K4	R7
      ...
      0x90021401,  //  001E  SETMBR	R0	K10	R1
      0x541A007E,  //  001F  LDINT	R6	127
      0x90020806,  //  0020  SETMBR	R0	K4	R6
      0xB81A3400,  //  0021  GETNGBL	R6	K26
      0x8C180D1B,  //  0022  GETMET	R6	R6	K27
      0x5820001C,  //  0023  LDCONST	R8	K28
      0x7C180400,  //  0024  CALL	R6	2
      0x741A0003,  //  0025  JMPT	R6	#002A
      0xB81A3400,  //  0026  GETNGBL	R6	K26
      0x601C0013,  //  0027  GETGBL	R7	G19
      0x7C1C0000,  //  0028  CALL	R7	0
      0x901A3807,  //  0029  SETMBR	R6	K28	R7
      0xB81A3400,  //  002A  GETNGBL	R6	K26
      0x88180D1C,  //  002B  GETMBR	R6	R6	K28
      0x8C180D1D,  //  002C  GETMET	R6	R6	K29
      ...
      0xB81A3400,  //  0032  GETNGBL	R6	K26
      0x88180D1C,  //  0033  GETMBR	R6	R6	K28
      0x8C180D1D,  //  0034  GETMET	R6	R6	K29
      0x5C200200,  //  0035  MOVE	R8	R1
      0x7C180400,  //  0036  CALL	R6	2
      0x881C010A,  //  0037  GETMBR	R7	R0	K10
      0x88200D0A,  //  0038  GETMBR	R8	R6	K10
      0x201C0E08,  //  0039  NE	R7	R7	R8
      0x781E0005,  //  003A  JMPF	R7	#0041
      0x601C0018,  //  003B  GETGBL	R7	G24
      0x5820001E,  //  003C  LDCONST	R8	K30
      0x8824010A,  //  003D  GETMBR	R9	R0	K10
      0x88280D0A,  //  003E  GETMBR	R10	R6	K10
      0x7C1C0600,  //  003F  CALL	R7	3
      0xB0061807,  //  0040  RAISE	1	K12	R7
      0x881C0D1F,  //  0041  GETMBR	R7	R6	K31
      0x90023E07,  //  0042  SETMBR	R0	K31	R7
      0x881C0D06,  //  0043  GETMBR	R7	R6	K6
      0x90020C07,  //  0044  SETMBR	R0	K6	R7
      0xB81E3400,  //  0045  GETNGBL	R7	K26
      0x881C0F1C,  //  0046  GETMBR	R7	R7	K28
      0x981C0200,  //  0047  SETIDX	R7	R1	R0
      0x7002000A,  //  0048  JMP		#0054
      0x8C180117,  //  0049  GETMET	R6	R0	K23
      ...
      0xB81A3400,  //  004F  GETNGBL	R6	K26
      0x88180D1C,  //  0050  GETMBR	R6	R6	K28
      0x98180200,  //  0051  SETIDX	R6	R1	R0
      0x8C180120,  //  0052  GETMET	R6	R0	K32
      0x7C180200,  //  0053  CALL	R6	1
      0x8818011F,  //  0054  GETMBR	R6	R0	K31
      0x4C1C0000,  //  0055  LDNIL	R7
      0x1C180C07,  //  0056  EQ	R6	R6	R7
      0x781A0000,  //  0057  JMPF	R6	#0059
      0xB0064322,  //  0058  RAISE	1	K33	K34
...
be_local_closure(class_Leds_begin,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[ 4]) {  /* code */
      0x8C040100,  //  0000  GETMET	R1	R0	K0
      0x580C0023,  //  0001  LDCONST	R3	K35
      0x7C040400,  //  0002  CALL	R1	2
      0x80000000,  //  0003  RET	0
    })
  )
...
be_local_class(Leds,
    ...
    be_nested_map(28,
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key(get_pixel_color, 22), be_const_closure(class_Leds_get_pixel_color_closure) },
        { be_const_key(can_show_wait, -1), be_const_closure(class_Leds_can_show_wait_closure) },
        { be_const_key(clear_to, 15), be_const_closure(class_Leds_clear_to_closure) },
        { be_const_key(leds, -1), be_const_var(1) },
        { be_const_key(set_pixel_color, -1), be_const_closure(class_Leds_set_pixel_color_closure) },
        { be_const_key(dirty, 20), be_const_closure(class_Leds_dirty_closure) },
        { be_const_key(ctor, -1), be_const_closure(class_Leds_ctor_closure) },
        { be_const_key(create_segment, 12), be_const_closure(class_Leds_create_segment_closure) },
        ...
        { be_const_key(pixels_buffer, 24), be_const_closure(class_Leds_pixels_buffer_closure) },
        { be_const_key(get_animate, 14), be_const_closure(class_Leds_get_animate_closure) },
        ...
        { be_const_key(is_dirty, 16), be_const_closure(class_Leds_is_dirty_closure) },
        ...
        { be_const_key(set_bri, 23), be_const_closure(class_Leds_set_bri_closure) },
        { be_const_key(bri, 25), be_const_var(2) },
        { be_const_key(can_show, -1), be_const_closure(class_Leds_can_show_closure) },
        { be_const_key(pixel_offset, 6), be_const_closure(class_Leds_pixel_offset_closure) },
        { be_const_key(animate, -1), be_const_var(3) },
        { be_const_key(clear, -1), be_const_closure(class_Leds_clear_closure) },
        { be_const_key(set_animate, 5), be_const_closure(class_Leds_set_animate_closure) },
    })),
