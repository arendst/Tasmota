...
be_local_closure(module_lv_tasmota_init,   /* name */
  be_nested_proto(
    ...
    /* K16  */  be_nested_str_weak(set_stream_cb),
    /* K17  */  be_nested_str_weak(version),
    /* K18  */  be_nested_str_weak(version_major),
    /* K19  */  be_nested_str_weak(clock),
    /* K20  */  be_nested_str_weak(lv_clock),
    /* K21  */  be_nested_str_weak(clock_icon),
    /* K22  */  be_nested_str_weak(lv_clock_icon),
    /* K23  */  be_nested_str_weak(signal_arcs),
    /* K24  */  be_nested_str_weak(lv_signal_arcs),
    /* K25  */  be_nested_str_weak(signal_bars),
    /* K26  */  be_nested_str_weak(lv_signal_bars),
    /* K27  */  be_nested_str_weak(wifi_arcs_icon),
    /* K28  */  be_nested_str_weak(lv_wifi_arcs_icon),
    /* K29  */  be_nested_str_weak(wifi_arcs),
    /* K30  */  be_nested_str_weak(lv_wifi_arcs),
    /* K31  */  be_nested_str_weak(wifi_bars_icon),
    /* K32  */  be_nested_str_weak(lv_wifi_bars_icon),
    /* K33  */  be_nested_str_weak(wifi_bars),
    /* K34  */  be_nested_str_weak(lv_wifi_bars),
    /* K35  */  be_nested_str_weak(tasmota),
    /* K36  */  be_nested_str_weak(get_option),
    /* K37  */  be_const_int(0),
    }),
    be_str_weak(init),
    ...
    ( &(const binstruction[62]) {  /* code */
      ...
      0x90062002,  //  0020  SETMBR	R1	K16	R2
      0x8C080312,  //  0021  GETMET	R2	R1	K18
      0x7C080200,  //  0022  CALL	R2	1
      0x90062202,  //  0023  SETMBR	R1	K17	R2
      0xB80A2800,  //  0024  GETNGBL	R2	K20
      0x90062602,  //  0025  SETMBR	R1	K19	R2
      0xB80A2C00,  //  0026  GETNGBL	R2	K22
      0x90062A02,  //  0027  SETMBR	R1	K21	R2
      0xB80A3000,  //  0028  GETNGBL	R2	K24
      0x90062E02,  //  0029  SETMBR	R1	K23	R2
      0xB80A3400,  //  002A  GETNGBL	R2	K26
      0x90063202,  //  002B  SETMBR	R1	K25	R2
      0xB80A3800,  //  002C  GETNGBL	R2	K28
      0x90063602,  //  002D  SETMBR	R1	K27	R2
      0xB80A3C00,  //  002E  GETNGBL	R2	K30
      0x90063A02,  //  002F  SETMBR	R1	K29	R2
      0xB80A4000,  //  0030  GETNGBL	R2	K32
      0x90063E02,  //  0031  SETMBR	R1	K31	R2
      0xB80A4400,  //  0032  GETNGBL	R2	K34
      0x90064202,  //  0033  SETMBR	R1	K33	R2
      0xB80A4600,  //  0034  GETNGBL	R2	K35
      0x8C080524,  //  0035  GETMET	R2	R2	K36
      0x54120086,  //  0036  LDINT	R4	135
      0x7C080400,  //  0037  CALL	R2	2
      0x1C080525,  //  0038  EQ	R2	R2	K37
      0x780A0001,  //  0039  JMPF	R2	#003C
      0x8C080303,  //  003A  GETMET	R2	R1	K3
      0x7C080200,  //  003B  CALL	R2	1
      0x4C080000,  //  003C  LDNIL	R2
