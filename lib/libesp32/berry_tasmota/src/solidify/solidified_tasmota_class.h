  ...
  be_nested_proto(
    ...
    ( &(const struct bproto*[ 6]) {
      ...
      be_nested_proto(
        ...
        /* K8   */  be_nested_str(BRY_X3A_X20failed_X20to_X20load_X20compiled_X20_X27_X25s_X27_X20_X28_X25s_X29),
        }),
      ...
      be_nested_proto(
        ...
        /* K2   */  be_nested_str(BRY_X3A_X20failed_X20to_X20load_X20_X27_X25s_X27_X20_X28_X25s_X20_X2D_X20_X25s_X29),
        }),
      ...
      be_nested_proto(
        ...
        ( &(const bvalue[ 2]) {     /* constants */
        /* K0   */  be_nested_str(string),
        /* K1   */  be_nested_str(BRY_X3A_X20failed_X20to_X20run_X20compiled_X20code_X20_X27_X25s_X27_X20_X2D_X20_X25s),
        }),
...
be_local_closure(Tasmota_time_str,   /* name */
  be_nested_proto(
    ...
    /* K2   */  be_nested_str(_X2504d_X2D_X2502d_X2D_X2502dT_X2502d_X3A_X2502d_X3A_X2502d),
    /* K3   */  be_nested_str(year),
    /* K4   */  be_nested_str(month),
    /* K5   */  be_nested_str(day),
    ...
    ( &(const binstruction[14]) {  /* code */
      ...
      0x94180703,  //  0006  GETIDX	R6	R3	K3
      0x941C0704,  //  0007  GETIDX	R7	R3	K4
      0x94200705,  //  0008  GETIDX	R8	R3	K5
      0x94240706,  //  0009  GETIDX	R9	R3	K6
      0x94280707,  //  000A  GETIDX	R10	R3	K7
      0x942C0708,  //  000B  GETIDX	R11	R3	K8
      0x7C100E00,  //  000C  CALL	R4	7
      0x80040800,  //  000D  RET	1	R4
    })
  )
);
...
be_local_closure(Tasmota_event,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[109]) {  /* code */
      ...
      0x60400018,  //  0058  GETGBL	R16	G24
      0x58440012,  //  0059  LDCONST	R17	K18
      0x5C481A00,  //  005A  MOVE	R18	R13
      0x5C4C1C00,  //  005B  MOVE	R19	R14
      0x7C400600,  //  005C  CALL	R16	3
      0x7C3C0200,  //  005D  CALL	R15	1
      0x883C0113,  //  005E  GETMBR	R15	R0	K19
      0x783E0002,  //  005F  JMPF	R15	#0063
      0xA43E2800,  //  0060  IMPORT	R15	K20
      0x8C401F15,  //  0061  GETMET	R16	R15	K21
      0x7C400200,  //  0062  CALL	R16	1
      0x70020000,  //  0063  JMP		#0065
      0xB0080000,  //  0064  RAISE	2	R0	R0
      0x00281516,  //  0065  ADD	R10	R10	K22
      0x7001FFCA,  //  0066  JMP		#0032
      0x1C280317,  //  0067  EQ	R10	R1	K23
      0x782A0002,  //  0068  JMPF	R10	#006C
      0xA42A3000,  //  0069  IMPORT	R10	K24
      0x8C2C1519,  //  006A  GETMET	R11	R10	K25
...
be_local_class(Tasmota,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key(exec_rules, 45), be_const_closure(Tasmota_exec_rules_closure) },
        { be_const_key(cmd, 30), be_const_closure(Tasmota_cmd_closure) },
        { be_const_key(remove_cron, -1), be_const_closure(Tasmota_remove_cron_closure) },
        { be_const_key(remove_rule, 23), be_const_closure(Tasmota_remove_rule_closure) },
        { be_const_key(run_deferred, -1), be_const_closure(Tasmota_run_deferred_closure) },
        { be_const_key(find_key_i, 22), be_const_closure(Tasmota_find_key_i_closure) },
        ...
        { be_const_key(_drivers, 4), be_const_var(5) },
        { be_const_key(wire1, -1), be_const_var(6) },
        { be_const_key(run_cron, 7), be_const_closure(Tasmota_run_cron_closure) },
        { be_const_key(wire_scan, 9), be_const_closure(Tasmota_wire_scan_closure) },
        { be_const_key(add_rule, -1), be_const_closure(Tasmota_add_rule_closure) },
        { be_const_key(_fl, 36), be_const_var(0) },
        ...
        { be_const_key(remove_fast_loop, 17), be_const_closure(Tasmota_remove_fast_loop_closure) },
        { be_const_key(remove_cmd, -1), be_const_closure(Tasmota_remove_cmd_closure) },
        { be_const_key(add_driver, 18), be_const_closure(Tasmota_add_driver_closure) },
        { be_const_key(settings, 41), be_const_var(10) },
        { be_const_key(wire2, -1), be_const_var(7) },
        { be_const_key(remove_driver, -1), be_const_closure(Tasmota_remove_driver_closure) },
        { be_const_key(check_not_method, 29), be_const_closure(Tasmota_check_not_method_closure) },
        { be_const_key(set_light, 37), be_const_closure(Tasmota_set_light_closure) },
        { be_const_key(cmd_res, -1), be_const_var(8) },
        { be_const_key(wd, 8), be_const_var(11) },
        { be_const_key(urlfetch_cmd, -1), be_const_closure(Tasmota_urlfetch_cmd_closure) },
        { be_const_key(global, 39), be_const_var(9) },
        ...
        { be_const_key(next_cron, 15), be_const_closure(Tasmota_next_cron_closure) },
        ...
        { be_const_key(hs2rgb, 2), be_const_closure(Tasmota_hs2rgb_closure) },
    })),
