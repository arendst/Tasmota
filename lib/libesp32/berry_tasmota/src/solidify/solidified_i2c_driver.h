...
// compact class 'I2C_Driver' ktab size: 20, total: 74 (saved 432 bytes)
static const bvalue be_ktab_class_I2C_Driver[20] = {
  ...
  /* K8   */  be_nested_str(read8),
  /* K9   */  be_nested_str(write8),
  /* K10  */  be_nested_str(write16),
...
/********************************************************************
** Solidified function: read_bit
********************************************************************/
be_local_closure(class_I2C_Driver_read_bit,   /* name */
  be_nested_proto(
    7,                          /* nstack */
    3,                          /* argc */
    10,                          /* varg */
...
be_local_closure(class_I2C_Driver_write_bit,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[26]) {  /* code */
      0x14100504,  //  0000  LT	R4	R2	K4
      0x74120002,  //  0001  JMPT	R4	#0005
      0x54120006,  //  0002  LDINT	R4	7
      0x24100404,  //  0003  GT	R4	R2	R4
      0x78120000,  //  0004  JMPF	R4	#0006
      0x80000800,  //  0005  RET	0
      0x38120A02,  //  0006  SHL	R4	K5	R2
      0x780E0007,  //  0007  JMPF	R3	#0010
      0x8C140109,  //  0008  GETMET	R5	R0	K9
      0x5C1C0200,  //  0009  MOVE	R7	R1
      0x8C200108,  //  000A  GETMET	R8	R0	K8
      ...
      0x8C140109,  //  0010  GETMET	R5	R0	K9
      0x5C1C0200,  //  0011  MOVE	R7	R1
      0x8C200108,  //  0012  GETMET	R8	R0	K8
...
be_local_closure(class_I2C_Driver_write16LE,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[15]) {  /* code */
      ...
      0x8C0C010A,  //  000A  GETMET	R3	R0	K10
...
be_local_closure(class_I2C_Driver_write8,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[ 8]) {  /* code */
      ...
      0x8C0C070B,  //  0001  GETMET	R3	R3	K11
...
be_local_class(I2C_Driver,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key(write16, 11), be_const_closure(class_I2C_Driver_write16_closure) },
        { be_const_key(read13, 8), be_const_closure(class_I2C_Driver_read13_closure) },
        { be_const_key(read32, -1), be_const_closure(class_I2C_Driver_read32_closure) },
        { be_const_key(read8, 4), be_const_closure(class_I2C_Driver_read8_closure) },
        { be_const_key(write_bit, -1), be_const_closure(class_I2C_Driver_write_bit_closure) },
        { be_const_key(read16, 16), be_const_closure(class_I2C_Driver_read16_closure) },
        { be_const_key(read12, -1), be_const_closure(class_I2C_Driver_read12_closure) },
        { be_const_key(read_bit, -1), be_const_closure(class_I2C_Driver_read_bit_closure) },
        ...
        { be_const_key(write16LE, -1), be_const_closure(class_I2C_Driver_write16LE_closure) },
        { be_const_key(wire, -1), be_const_var(0) },
        { be_const_key(addr, 0), be_const_var(1) },
