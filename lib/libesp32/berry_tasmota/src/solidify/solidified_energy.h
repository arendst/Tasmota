...
// compact class 'bytes_array' ktab size: 18, total: 33 (saved 120 bytes)
static const bvalue be_ktab_class_bytes_array[18] = {
  /* K0   */  be_const_int(0),
  /* K1   */  be_nested_str(sz),
  /* K2   */  be_nested_str(index_error),
  /* K3   */  be_nested_str(list_X20assignment_X20index_X20out_X20of_X20range),
  /* K4   */  be_nested_str(item_type),
  /* K5   */  be_nested_str(setfloat),
  /* K6   */  be_nested_str(item_size),
  /* K7   */  be_nested_str(set),
  /* K8   */  be_nested_str(value_X20error),
  /* K9   */  be_nested_str(unsupported_X20item_type_X20number),
  /* K10  */  be_nested_str(init),
  /* K11  */  be_nested_str(_X5B),
  /* K12  */  be_nested_str(_X2C),
  /* K13  */  be_nested_str(getfloat),
  /* K14  */  be_nested_str(get),
  /* K15  */  be_const_int(1),
  /* K16  */  be_nested_str(_X5D),
  /* K17  */  be_nested_str(list_X20index_X20out_X20of_X20range),
};
...
be_local_closure(class_bytes_array_setitem,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[29]) {  /* code */
      ...
      0x88180104,  //  0018  GETMBR	R6	R0	K4
...
be_local_closure(class_bytes_array_init,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[35]) {  /* code */
      0x90020802,  //  0000  SETMBR	R0	K4	R2
      ...
      0x20140500,  //  0009  NE	R5	R2	K0
      0x78160006,  //  000A  JMPF	R5	#0012
      0x24140500,  //  000B  GT	R5	R2	K0
      ...
      0xB0061109,  //  0017  RAISE	1	K8	K9
      0x90020C04,  //  0018  SETMBR	R0	K6	R4
...
be_local_closure(class_bytes_array_tostring,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[32]) {  /* code */
      ...
      0x8C10010D,  //  000D  GETMET	R4	R0	K13
...
be_local_class(bytes_array,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key(item_size, 4), be_const_var(2) },
        { be_const_key(item, -1), be_const_closure(class_bytes_array_item_closure) },
        { be_const_key(item_type, 1), be_const_var(0) },
        { be_const_key(tostring, 6), be_const_closure(class_bytes_array_tostring_closure) },
        { be_const_key(init, 2), be_const_closure(class_bytes_array_init_closure) },
