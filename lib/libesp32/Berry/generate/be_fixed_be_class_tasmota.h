...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(gen_cb, 17), be_const_closure(Tasmota_gen_cb_closure) },
    { be_const_key(cmd_res, 20), be_const_var(3) },
    { be_const_key(set_light, 63), be_const_closure(Tasmota_set_light_closure) },
    { be_const_key(millis, -1), be_const_func(l_millis) },
    { be_const_key(global, -1), be_const_var(4) },
    { be_const_key(exec_tele, 67), be_const_closure(Tasmota_exec_tele_closure) },
    ...
    { be_const_key(time_str, 45), be_const_closure(Tasmota_time_str_closure) },
    ...
    { be_const_key(load, 72), be_const_closure(Tasmota_load_closure) },
    ...
    { be_const_key(add_rule, 41), be_const_closure(Tasmota_add_rule_closure) },
    ...
    { be_const_key(kv, 74), be_const_closure(Tasmota_kv_closure) },
    { be_const_key(delay, -1), be_const_func(l_delay) },
    { be_const_key(remove_cmd, 19), be_const_closure(Tasmota_remove_cmd_closure) },
