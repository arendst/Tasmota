...
be_define_const_str(WE517_TX, "WE517_TX", 2954817217u, 0, 8, &be_const_str_lv_objmask);
...
be_define_const_str(AZ_RXD, "AZ_RXD", 699914019u, 0, 6, &be_const_str_split);
...
be_define_const_str(SYMBOL_AUDIO, "SYMBOL_AUDIO", 3056537956u, 0, 12, &be_const_str_Tasmota);
be_define_const_str(Tasmota, "Tasmota", 4047617668u, 0, 7, NULL);
be_define_const_str(i2c_enabled, "i2c_enabled", 218388101u, 0, 11, &be_const_str_time_reached);
...
be_define_const_str(PULLDOWN, "PULLDOWN", 1853074086u, 0, 8, &be_const_str_SYMBOL_EDIT);
be_define_const_str(SYMBOL_EDIT, "SYMBOL_EDIT", 1396182822u, 0, 11, &be_const_str_lv_win);
be_define_const_str(lv_win, "lv_win", 780927558u, 0, 6, &be_const_str_reverse_gamma10);
be_define_const_str(reverse_gamma10, "reverse_gamma10", 739112262u, 0, 15, NULL);
be_define_const_str(SYMBOL_BELL, "SYMBOL_BELL", 1736196487u, 0, 11, &be_const_str_SYMBOL_NEXT);
be_define_const_str(SYMBOL_NEXT, "SYMBOL_NEXT", 1102844455u, 0, 11, &be_const_str_add_rule);
be_define_const_str(add_rule, "add_rule", 596540743u, 0, 8, NULL);
be_define_const_str(insert, "insert", 3332609576u, 0, 6, &be_const_str_lv_arc);
be_define_const_str(lv_arc, "lv_arc", 4170125384u, 0, 6, NULL);
be_define_const_str(EXS_ENABLE, "EXS_ENABLE", 1896914313u, 0, 10, &be_const_str_MAX7219DIN);
be_define_const_str(MAX7219DIN, "MAX7219DIN", 380687049u, 0, 10, &be_const_str_SDM120_RX);
be_define_const_str(SDM120_RX, "SDM120_RX", 1367571753u, 0, 9, &be_const_str_open);
be_define_const_str(open, "open", 3546203337u, 0, 4, NULL);
be_define_const_str(opt_add, "+", 772578730u, 0, 1, &be_const_str_SYMBOL_CUT);
...
be_define_const_str(REL1_INV, "REL1_INV", 3733155371u, 0, 8, &be_const_str_SYMBOL_MUTE);
be_define_const_str(SYMBOL_MUTE, "SYMBOL_MUTE", 563116043u, 0, 11, &be_const_str_get_tasmota);
be_define_const_str(get_tasmota, "get_tasmota", 334356779u, 0, 11, NULL);
be_define_const_str(write8, "write8", 3133991532u, 0, 6, NULL);
be_define_const_str(NRG_SEL, "NRG_SEL", 1771358125u, 0, 7, &be_const_str_lv_slider);
be_define_const_str(lv_slider, "lv_slider", 2274180781u, 0, 9, &be_const_str_sin);
be_define_const_str(sin, "sin", 3761252941u, 0, 3, NULL);
be_define_const_str(ADC_INPUT, "ADC_INPUT", 2207556878u, 0, 9, &be_const_str_yield);
be_define_const_str(yield, "yield", 1821831854u, 0, 5, NULL);
be_define_const_str(BUZZER_INV, "BUZZER_INV", 3274564335u, 0, 10, &be_const_str_INPUT_PULLDOWN);
...
be_define_const_str(CSE7761_RX, "CSE7761_RX", 65423248u, 0, 10, &be_const_str_SWT1);
be_define_const_str(SWT1, "SWT1", 805224112u, 0, 4, &be_const_str_lv_btn);
be_define_const_str(lv_btn, "lv_btn", 1612829968u, 0, 6, &be_const_str_lv_roller);
be_define_const_str(lv_roller, "lv_roller", 661902064u, 0, 9, &be_const_str_read32);
be_define_const_str(read32, "read32", 1741276240u, 0, 6, &be_const_str_rtc);
be_define_const_str(rtc, "rtc", 1070575216u, 0, 3, &be_const_str_str);
...
be_define_const_str(SPI_CLK, "SPI_CLK", 3943233814u, 0, 7, &be_const_str_WEBCAM_VSYNC);
be_define_const_str(WEBCAM_VSYNC, "WEBCAM_VSYNC", 4032882166u, 0, 12, &be_const_str_rand);
be_define_const_str(rand, "rand", 2711325910u, 0, 4, NULL);
be_define_const_str(get, "get", 1410115415u, 0, 3, NULL);
be_define_const_str(SYMBOL_RIGHT, "SYMBOL_RIGHT", 2984010648u, 0, 12, &be_const_str_imin);
...
be_define_const_str(SWT1_NP, "SWT1_NP", 4033043739u, 0, 7, &be_const_str_SYMBOL_POWER);
be_define_const_str(SYMBOL_POWER, "SYMBOL_POWER", 1125993627u, 0, 12, NULL);
be_define_const_str(PROJECTOR_CTRL_RX, "PROJECTOR_CTRL_RX", 1542762460u, 0, 17, &be_const_str__request_from);
...
be_define_const_str(AS608_RX, "AS608_RX", 4275502016u, 0, 8, &be_const_str_ILI9341_DC);
be_define_const_str(ILI9341_DC, "ILI9341_DC", 28838624u, 0, 10, &be_const_str_digital_read);
...
be_define_const_str(SYMBOL_REFRESH, "SYMBOL_REFRESH", 1266229761u, 0, 14, &be_const_str_seg7_font);
be_define_const_str(seg7_font, "seg7_font", 4099690689u, 0, 9, NULL);
be_define_const_str(ADE7953_IRQ, "ADE7953_IRQ", 2329185922u, 0, 11, &be_const_str_WS2812);
be_define_const_str(WS2812, "WS2812", 3539741218u, 0, 6, &be_const_str__get_cb);
be_define_const_str(_get_cb, "_get_cb", 1448849122u, 0, 7, &be_const_str_isinstance);
...
be_define_const_str(ILI9341_CS, "ILI9341_CS", 3519318851u, 0, 10, &be_const_str___upper__);
...
be_define_const_str(HRE_CLOCK, "HRE_CLOCK", 2870559111u, 0, 9, &be_const_str_SYMBOL_EJECT);
be_define_const_str(SYMBOL_EJECT, "SYMBOL_EJECT", 873760647u, 0, 12, &be_const_str_VL53L0X_XSHUT1);
be_define_const_str(VL53L0X_XSHUT1, "VL53L0X_XSHUT1", 2341134183u, 0, 14, &be_const_str_arg);
...
be_define_const_str(RXD, "RXD", 2311579049u, 0, 3, &be_const_str_srand);
be_define_const_str(srand, "srand", 465518633u, 0, 5, NULL);
be_define_const_str(arg_name, "arg_name", 1345046155u, 0, 8, NULL);
be_define_const_str(RA8876_CS, "RA8876_CS", 2529944108u, 0, 9, &be_const_str_web_sensor);
be_define_const_str(web_sensor, "web_sensor", 2900096972u, 0, 10, NULL);
be_define_const_str(DSB_OUT, "DSB_OUT", 732335085u, 0, 7, &be_const_str_lv_bar);
be_define_const_str(lv_bar, "lv_bar", 1582673229u, 0, 6, &be_const_str_type);
...
be_define_const_str(TM1638CLK, "TM1638CLK", 3045182446u, 0, 9, &be_const_str_while);
...
be_define_const_str(lv_list, "lv_list", 2876551248u, 0, 7, &be_const_str_for);
...
be_define_const_str(SYMBOL_PLAY, "SYMBOL_PLAY", 1750902100u, 0, 11, &be_const_str__timers);
be_define_const_str(_timers, "_timers", 2600100916u, 0, 7, &be_const_str_add);
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_update);
...
be_define_const_str(IBEACON_RX, "IBEACON_RX", 2466155575u, 0, 10, &be_const_str_SI7021);
be_define_const_str(SI7021, "SI7021", 864377911u, 0, 6, &be_const_str_SYMBOL_COPY);
be_define_const_str(SYMBOL_COPY, "SYMBOL_COPY", 4193681815u, 0, 11, &be_const_str_SYMBOL_WIFI);
be_define_const_str(SYMBOL_WIFI, "SYMBOL_WIFI", 682141303u, 0, 11, NULL);
be_define_const_str(PZEM0XX_TX, "PZEM0XX_TX", 944775704u, 0, 10, &be_const_str_SOLAXX1_TX);
be_define_const_str(SOLAXX1_TX, "SOLAXX1_TX", 903770840u, 0, 10, &be_const_str_set_light);
...
be_define_const_str(P9813_CLK, "P9813_CLK", 2455391001u, 0, 9, &be_const_str_TM1637CLK);
be_define_const_str(TM1637CLK, "TM1637CLK", 2797300857u, 0, 9, &be_const_str_TUYA_TX);
be_define_const_str(TUYA_TX, "TUYA_TX", 1541301465u, 0, 7, &be_const_str_WEBCAM_PCLK);
be_define_const_str(WEBCAM_PCLK, "WEBCAM_PCLK", 3813770649u, 0, 11, &be_const_str_arg_size);
...
be_define_const_str(SM2135_CLK, "SM2135_CLK", 2383410011u, 0, 10, &be_const_str_time_dump);
...
be_define_const_str(DDS2382_RX, "DDS2382_RX", 432446462u, 0, 10, &be_const_str_var);
be_define_const_str(var, "var", 2317739966u, 64, 3, NULL);
be_define_const_str(MCP39F5_TX, "MCP39F5_TX", 1332322047u, 0, 10, &be_const_str_acos);
...
be_define_const_str(SYMBOL_DOWN, "SYMBOL_DOWN", 1107513570u, 0, 11, &be_const_str_classof);
be_define_const_str(classof, "classof", 1796577762u, 0, 7, NULL);
be_define_const_str(opt_neq, "!=", 2428715011u, 0, 2, &be_const_str_A4988_MS1);
...
be_define_const_str(CNTR1, "CNTR1", 510376965u, 0, 5, &be_const_str_SDM630_RX);
be_define_const_str(SDM630_RX, "SDM630_RX", 1971606309u, 0, 9, &be_const_str_SDM72_TX);
be_define_const_str(SDM72_TX, "SDM72_TX", 2042143269u, 0, 8, &be_const_str_SYMBOL_BATTERY_3);
be_define_const_str(SYMBOL_BATTERY_3, "SYMBOL_BATTERY_3", 662591301u, 0, 16, &be_const_str_TELEINFO_ENABLE);
be_define_const_str(TELEINFO_ENABLE, "TELEINFO_ENABLE", 1600974501u, 0, 15, &be_const_str_read);
...
be_define_const_str(WEBCAM_HSD, "WEBCAM_HSD", 2648502504u, 0, 10, &be_const_str_save);
...
be_define_const_str(MCP39F5_RX, "MCP39F5_RX", 190458217u, 0, 10, &be_const_str_SAIR_RX);
be_define_const_str(SAIR_RX, "SAIR_RX", 1273688713u, 0, 7, &be_const_str__write);
...
be_define_const_str(content_start, "content_start", 2937509069u, 0, 13, &be_const_str_keys);
...
be_define_const_str(get_power, "get_power", 3009799377u, 0, 9, &be_const_str_log);
be_define_const_str(log, "log", 1062293841u, 0, 3, &be_const_str_tolower);
...
be_define_const_str(LMT01, "LMT01", 2490623797u, 0, 5, &be_const_str_TM1637DIO);
be_define_const_str(TM1637DIO, "TM1637DIO", 1574659381u, 0, 9, &be_const_str_display);
...
be_define_const_str(ROT1B_NP, "ROT1B_NP", 3710079736u, 0, 8, &be_const_str_break);
be_define_const_str(break, "break", 3378807160u, 58, 5, NULL);
be_define_const_str(lv_spinbox, "lv_spinbox", 2666096729u, 0, 10, NULL);
be_define_const_str(PROJECTOR_CTRL_TX, "PROJECTOR_CTRL_TX", 535811130u, 0, 17, &be_const_str_resp_cmnd_failed);
be_define_const_str(resp_cmnd_failed, "resp_cmnd_failed", 2136281562u, 0, 16, NULL);
be_define_const_str(MGC3130_XFER, "MGC3130_XFER", 4178219131u, 0, 12, &be_const_str_NONE);
be_define_const_str(NONE, "NONE", 1932136219u, 0, 4, &be_const_str_abs);
be_define_const_str(abs, "abs", 709362235u, 0, 3, NULL);
be_define_const_str(RDM6300_RX, "RDM6300_RX", 1522345628u, 0, 10, &be_const_str_SYMBOL_PAUSE);
...
be_define_const_str(LEDLNK_INV, "LEDLNK_INV", 3559015101u, 0, 10, &be_const_str_char);
...
be_define_const_str(remove, "remove", 3683784189u, 0, 6, &be_const_str_set_power);
be_define_const_str(set_power, "set_power", 549820893u, 0, 9, NULL);
be_define_const_str(ADC_LIGHT, "ADC_LIGHT", 3982461502u, 0, 9, &be_const_str_wire2);
be_define_const_str(wire2, "wire2", 3229499038u, 0, 5, NULL);
be_define_const_str(HALLEFFECT, "HALLEFFECT", 3334305407u, 0, 10, &be_const_str_SDS0X1_TX);
be_define_const_str(SDS0X1_TX, "SDS0X1_TX", 165045983u, 0, 9, &be_const_str_TCP_RX);
be_define_const_str(TCP_RX, "TCP_RX", 3904354751u, 0, 6, &be_const_str_TFMINIPLUS_RX);
be_define_const_str(TFMINIPLUS_RX, "TFMINIPLUS_RX", 1522203935u, 0, 13, &be_const_str_deg);
...
be_define_const_str(DDSU666_RX, "DDSU666_RX", 1812507936u, 0, 10, &be_const_str_OPEN_DRAIN);
be_define_const_str(OPEN_DRAIN, "OPEN_DRAIN", 677872608u, 0, 10, NULL);
be_define_const_str(LOW, "LOW", 3526092385u, 0, 3, &be_const_str_SYMBOL_VIDEO);
be_define_const_str(SYMBOL_VIDEO, "SYMBOL_VIDEO", 789726913u, 0, 12, &be_const_str_WEBCAM_XCLK);
be_define_const_str(WEBCAM_XCLK, "WEBCAM_XCLK", 536207425u, 0, 11, &be_const_str_resize);
...
be_define_const_str(CSE7761_TX, "CSE7761_TX", 3354719142u, 0, 10, &be_const_str_MIEL_HVAC_TX);
be_define_const_str(MIEL_HVAC_TX, "MIEL_HVAC_TX", 567403014u, 0, 12, &be_const_str_OUTPUT_HI);
...
be_define_const_str(iter, "iter", 3124256359u, 0, 4, &be_const_str_read8);
...
be_define_const_str(fromstring, "fromstring", 610302344u, 0, 10, &be_const_str_load_freetype_font);
be_define_const_str(load_freetype_font, "load_freetype_font", 2368447592u, 0, 18, &be_const_str_publish);
...
be_define_const_str(SYMBOL_VOLUME_MAX, "SYMBOL_VOLUME_MAX", 3582646093u, 0, 17, &be_const_str_traceback);
be_define_const_str(traceback, "traceback", 3385188109u, 0, 9, &be_const_str_as);
be_define_const_str(as, "as", 1579491469u, 67, 2, NULL);
be_define_const_str(SM16716_DAT, "SM16716_DAT", 1905621806u, 0, 11, &be_const_str_SOLAXX1_RX);
be_define_const_str(SOLAXX1_RX, "SOLAXX1_RX", 971867054u, 0, 10, &be_const_str_SYMBOL_PLUS);
...
be_define_const_str(TUYA_RX, "TUYA_RX", 1609397679u, 0, 7, &be_const_str_WIEGAND_D0);
be_define_const_str(WIEGAND_D0, "WIEGAND_D0", 4192335759u, 0, 10, &be_const_str__cb);
be_define_const_str(_cb, "_cb", 4043300367u, 0, 3, NULL);
be_define_const_str(_end_transmission, "_end_transmission", 3237480400u, 0, 17, &be_const_str_check_privileged_access);
...
be_define_const_str(SYMBOL_STOP, "SYMBOL_STOP", 2836505202u, 0, 11, &be_const_str_web_add_button);
...
be_define_const_str(AS608_TX, "AS608_TX", 48630934u, 0, 8, &be_const_str_SYMBOL_CLOSE);
be_define_const_str(SYMBOL_CLOSE, "SYMBOL_CLOSE", 2654402806u, 0, 12, NULL);
be_define_const_str(delay, "delay", 1322381784u, 0, 5, &be_const_str_toupper);
be_define_const_str(toupper, "toupper", 3691983576u, 0, 7, NULL);
be_define_const_str(LE01MR_RX, "LE01MR_RX", 1521590809u, 0, 9, NULL);
be_define_const_str(EPAPER29_CS, "EPAPER29_CS", 3916373594u, 0, 11, &be_const_str_SSPI_SCLK);
...
be_define_const_str(SYMBOL_IMAGE, "SYMBOL_IMAGE", 815601151u, 0, 12, &be_const_str_add_cmd);
...
be_define_const_str(SYMBOL_LEFT, "SYMBOL_LEFT", 1563517575u, 0, 11, &be_const_str_lv_img);
be_define_const_str(lv_img, "lv_img", 2474052327u, 0, 6, &be_const_str_upper);
...
be_define_const_str(rad, "rad", 1358899048u, 0, 3, &be_const_str_wire_scan);
...
be_define_const_str(resp_cmnd, "resp_cmnd", 2869459626u, 0, 9, &be_const_str_save_before_restart);
...
be_define_const_str(SPI_DC, "SPI_DC", 553259951u, 0, 6, &be_const_str_SYMBOL_PREV);
be_define_const_str(SYMBOL_PREV, "SYMBOL_PREV", 2952615023u, 0, 11, NULL);
be_define_const_str(IRSEND, "IRSEND", 184848336u, 0, 6, &be_const_str_MIEL_HVAC_RX);
be_define_const_str(MIEL_HVAC_RX, "MIEL_HVAC_RX", 3720609648u, 0, 12, &be_const_str_OPTION_A);
...
be_define_const_str(CC1101_GDO0, "CC1101_GDO0", 940611027u, 0, 11, &be_const_str_SDM630_TX);
...
be_define_const_str(MAX7219CS, "MAX7219CS", 2593198244u, 0, 9, &be_const_str_RF_SENSOR);
be_define_const_str(RF_SENSOR, "RF_SENSOR", 2289628100u, 0, 9, &be_const_str_SSPI_MAX31865_CS1);
...
be_define_const_str(item, "item", 2671260646u, 0, 4, &be_const_str_lv_indev);
...
be_define_const_str(ETH_PHY_POWER, "ETH_PHY_POWER", 487529454u, 0, 13, &be_const_str_FTC532);
be_define_const_str(FTC532, "FTC532", 3182343438u, 0, 6, &be_const_str_SYMBOL_DRIVE);
be_define_const_str(SYMBOL_DRIVE, "SYMBOL_DRIVE", 567203502u, 0, 12, &be_const_str_WEBCAM_PWDN);
be_define_const_str(WEBCAM_PWDN, "WEBCAM_PWDN", 2219597454u, 0, 11, &be_const_str_memory);
be_define_const_str(memory, "memory", 2229924270u, 0, 6, NULL);
be_define_const_str(LE01MR_TX, "LE01MR_TX", 1589687023u, 0, 9, &be_const_str_SYMBOL_KEYBOARD);
be_define_const_str(SYMBOL_KEYBOARD, "SYMBOL_KEYBOARD", 1621492879u, 0, 15, NULL);
be_define_const_str(WEBCAM_RESET, "WEBCAM_RESET", 2171221520u, 0, 12, &be_const_str_web_add_main_button);
be_define_const_str(web_add_main_button, "web_add_main_button", 3960367664u, 0, 19, NULL);
be_define_const_str(SYMBOL_VOLUME_MID, "SYMBOL_VOLUME_MID", 158835057u, 0, 17, &be_const_str_collect);
be_define_const_str(collect, "collect", 2399039025u, 0, 7, &be_const_str_get_option);
be_define_const_str(get_option, "get_option", 2123730033u, 0, 10, &be_const_str_map);
...
be_define_const_str(SYMBOL_BATTERY_2, "SYMBOL_BATTERY_2", 645813682u, 0, 16, &be_const_str_finish);
be_define_const_str(finish, "finish", 1494643858u, 0, 6, NULL);
be_define_const_str(PMS5003_TX, "PMS5003_TX", 3868169364u, 0, 10, &be_const_str_lv_switch);
...
be_define_const_str(ZIGBEE_TX, "ZIGBEE_TX", 25119256u, 0, 9, &be_const_str_tan);
...
be_define_const_str(SYMBOL_EYE_OPEN, "SYMBOL_EYE_OPEN", 3449311676u, 0, 15, &be_const_str_cosh);
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, NULL);
be_define_const_str(BS814_DAT, "BS814_DAT", 3620403837u, 0, 9, &be_const_str_module);
be_define_const_str(module, "module", 3617558685u, 0, 6, NULL);
be_define_const_str(SAIR_TX, "SAIR_TX", 268017311u, 0, 7, &be_const_str_SYMBOL_UPLOAD);
be_define_const_str(SYMBOL_UPLOAD, "SYMBOL_UPLOAD", 3293679647u, 0, 13, &be_const_str_sinh);
be_define_const_str(sinh, "sinh", 282220607u, 0, 4, &be_const_str_start);
...
be_define_const_str(ADC_RANGE, "ADC_RANGE", 3467329543u, 0, 9, &be_const_str_SYMBOL_UP);
be_define_const_str(SYMBOL_UP, "SYMBOL_UP", 3886401511u, 0, 9, &be_const_str_exec_cmd);
be_define_const_str(exec_cmd, "exec_cmd", 493567399u, 0, 8, NULL);
be_define_const_str(SYMBOL_USB, "SYMBOL_USB", 1962656552u, 0, 10, &be_const_str_attrdump);
be_define_const_str(attrdump, "attrdump", 1521571304u, 0, 8, &be_const_str_exp);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, NULL);
be_define_const_str(SYMBOL_DIRECTORY, "SYMBOL_DIRECTORY", 1886053449u, 0, 16, &be_const_str_every_second);
...
be_define_const_str(HRE_DATA, "HRE_DATA", 1820377643u, 0, 8, &be_const_str_wire1);
be_define_const_str(wire1, "wire1", 3212721419u, 0, 5, NULL);
be_define_const_str(SYMBOL_FILE, "SYMBOL_FILE", 237085260u, 0, 11, &be_const_str_chars_in_string);
be_define_const_str(chars_in_string, "chars_in_string", 3148785132u, 0, 15, &be_const_str_def);
be_define_const_str(def, "def", 3310976652u, 55, 3, &be_const_str_nil);
...
be_define_const_str(IEM3000_TX, "IEM3000_TX", 1185907310u, 0, 10, &be_const_str_calldepth);
...
be_define_const_str(ADC_CT_POWER, "ADC_CT_POWER", 3382284599u, 0, 12, &be_const_str_SYMBOL_SAVE);
be_define_const_str(SYMBOL_SAVE, "SYMBOL_SAVE", 2439821015u, 0, 11, &be_const_str_WE517_RX);
be_define_const_str(WE517_RX, "WE517_RX", 4096577879u, 0, 8, &be_const_str_content_button);
...
be_define_const_str(CC1101_GDO2, "CC1101_GDO2", 974166265u, 0, 11, &be_const_str__drivers);
be_define_const_str(_drivers, "_drivers", 3260328985u, 0, 8, NULL);
be_define_const_str(opt_call, "()", 685372826u, 0, 2, &be_const_str_I2C_Driver);
be_define_const_str(I2C_Driver, "I2C_Driver", 1714501658u, 0, 10, &be_const_str_KEY1_INV_NP);
...
be_define_const_str(RISING, "RISING", 1256404539u, 0, 6, &be_const_str_resp_cmnd_done);
be_define_const_str(resp_cmnd_done, "resp_cmnd_done", 2601874875u, 0, 14, NULL);
be_define_const_str(ARIRFRCV, "ARIRFRCV", 1120816444u, 0, 8, &be_const_str_WIEGAND_D1);
be_define_const_str(WIEGAND_D1, "WIEGAND_D1", 4175558140u, 0, 10, &be_const_str_top);
...
be_define_const_str(DHT11_OUT, "DHT11_OUT", 1645300734u, 0, 9, &be_const_str_compile);
be_define_const_str(compile, "compile", 1000265118u, 0, 7, NULL);
be_define_const_str(MAX31855CLK, "MAX31855CLK", 715977727u, 0, 11, &be_const_str_REL1);
...
be_define_const_str(TXD, "TXD", 3614562079u, 0, 3, &be_const_str_resp_cmnd_error);
be_define_const_str(resp_cmnd_error, "resp_cmnd_error", 2404088863u, 0, 15, NULL);
be_define_const_str(WEBCAM_PSRCS, "WEBCAM_PSRCS", 624464864u, 0, 12, &be_const_str_remove_rule);
be_define_const_str(remove_rule, "remove_rule", 3456211328u, 0, 11, NULL);
be_define_const_str(IBEACON_TX, "IBEACON_TX", 3471826977u, 0, 10, &be_const_str_list);
be_define_const_str(list, "list", 217798785u, 0, 4, NULL);
be_define_const_str(ADC_BUTTON, "ADC_BUTTON", 3393454690u, 0, 10, &be_const_str_HM10_RX);
...
be_define_const_str(lv_cpicker, "lv_cpicker", 1935129251u, 0, 10, &be_const_str_elif);
be_define_const_str(elif, "elif", 3232090307u, 51, 4, NULL);
be_define_const_str(exec_rules, "exec_rules", 1445221092u, 0, 10, NULL);
be_define_const_str(_available, "_available", 1306196581u, 0, 10, &be_const_str_lv_tileview);
be_define_const_str(lv_tileview, "lv_tileview", 2419887973u, 0, 11, &be_const_str_reverse);
...
be_define_const_str(DDS2382_TX, "DDS2382_TX", 1438117864u, 0, 10, &be_const_str_FALLING);
be_define_const_str(FALLING, "FALLING", 2851701064u, 0, 7, &be_const_str_GPS_TX);
be_define_const_str(GPS_TX, "GPS_TX", 4228740808u, 0, 6, &be_const_str_WEBCAM_HREF);
be_define_const_str(WEBCAM_HREF, "WEBCAM_HREF", 3161890024u, 0, 11, NULL);
be_define_const_str(HX711_DAT, "HX711_DAT", 2935118250u, 0, 9, &be_const_str_SYMBOL_DUMMY);
be_define_const_str(SYMBOL_DUMMY, "SYMBOL_DUMMY", 3621732138u, 0, 12, &be_const_str_read12);
be_define_const_str(read12, "read12", 4291076970u, 0, 6, NULL);
be_define_const_str(RFSEND, "RFSEND", 1862630731u, 0, 6, &be_const_str_WEBCAM_SIOC);
...
be_define_const_str(SYMBOL_PASTE, "SYMBOL_PASTE", 2281577421u, 0, 12, &be_const_str_lv_imgbtn);
be_define_const_str(lv_imgbtn, "lv_imgbtn", 2402844429u, 0, 9, &be_const_str_resolvecmnd);
be_define_const_str(resolvecmnd, "resolvecmnd", 993361485u, 0, 11, NULL);
be_define_const_str(ZIGBEE_RX, "ZIGBEE_RX", 93215470u, 0, 9, &be_const_str_try);
...
be_define_const_str(log10, "log10", 2346846000u, 0, 5, &be_const_str_write_bytes);
...
be_define_const_str(A4988_STP, "A4988_STP", 1622172049u, 0, 9, &be_const_str_AS3935);
be_define_const_str(AS3935, "AS3935", 603621745u, 0, 6, &be_const_str_RFRECV);
be_define_const_str(RFRECV, "RFRECV", 354742801u, 0, 6, &be_const_str_ST7789_DC);
be_define_const_str(ST7789_DC, "ST7789_DC", 2533509745u, 0, 9, &be_const_str__rules);
be_define_const_str(_rules, "_rules", 4266217105u, 0, 6, &be_const_str_screenshot);
...
be_define_const_str(RC522_RST, "RC522_RST", 720511443u, 0, 9, &be_const_str_lv_linemeter);
...
be_define_const_str(SYMBOL_BATTERY_EMPTY, "SYMBOL_BATTERY_EMPTY", 3945064277u, 0, 20, &be_const_str_lv_keyboard);
...
be_define_const_str(gamma8, "gamma8", 3802843830u, 0, 6, &be_const_str_resp_cmnd_str);
...
be_define_const_str(SSD1351_CS, "SSD1351_CS", 488746042u, 0, 10, &be_const_str_find);
be_define_const_str(find, "find", 3186656602u, 0, 4, NULL);
be_define_const_str(INPUT, "INPUT", 1638025307u, 0, 5, &be_const_str_SSD1331_DC);
be_define_const_str(SSD1331_DC, "SSD1331_DC", 3386560859u, 0, 10, &be_const_str_digital_write);
be_define_const_str(digital_write, "digital_write", 3435877979u, 0, 13, NULL);
be_define_const_str(WINDMETER_SPEED, "WINDMETER_SPEED", 1980822204u, 0, 15, &be_const_str_size);
...
be_define_const_str(SHELLY_DIMMER_RST_INV, "SHELLY_DIMMER_RST_INV", 2366759773u, 0, 21, &be_const_str_lv_obj);
be_define_const_str(lv_obj, "lv_obj", 4257833149u, 0, 6, &be_const_str_lv_style);
...
be_define_const_str(HLW_CF, "HLW_CF", 3982619486u, 0, 6, &be_const_str_int);
...
be_define_const_str(LED1, "LED1", 21005825u, 0, 4, &be_const_str_NRF24_DC);
...
be_define_const_str(SM16716_SEL, "SM16716_SEL", 142377379u, 0, 11, &be_const_str_set);
be_define_const_str(set, "set", 3324446467u, 0, 3, NULL);
be_define_const_str(OUTPUT, "OUTPUT", 1469629700u, 0, 6, &be_const_str_continue);
be_define_const_str(continue, "continue", 2977070660u, 59, 8, NULL);
be_define_const_str(AZ_TXD, "AZ_TXD", 850268709u, 0, 6, &be_const_str__ccmd);
be_define_const_str(_ccmd, "_ccmd", 2163421413u, 0, 5, &be_const_str_true);
be_define_const_str(true, "true", 1303515621u, 61, 4, NULL);
be_define_const_str(BACKLIGHT, "BACKLIGHT", 3147761926u, 0, 9, &be_const_str_SYMBOL_BULLET);
...
be_define_const_str(SDS0X1_RX, "SDS0X1_RX", 1170717385u, 0, 9, &be_const_str_TFMINIPLUS_TX);
be_define_const_str(TFMINIPLUS_TX, "TFMINIPLUS_TX", 2527875337u, 0, 13, &be_const_str_load);
...
be_define_const_str(ETH_PHY_MDIO, "ETH_PHY_MDIO", 3261871568u, 0, 12, &be_const_str_on);
...
be_define_const_str(MCP39F5_RST, "MCP39F5_RST", 3657125652u, 0, 11, &be_const_str_PN532_TXD);
be_define_const_str(PN532_TXD, "PN532_TXD", 3093418644u, 0, 9, NULL);
be_define_const_str(TASMOTACLIENT_RST_INV, "TASMOTACLIENT_RST_INV", 2601785365u, 0, 21, &be_const_str_WEBCAM_DATA);
be_define_const_str(WEBCAM_DATA, "WEBCAM_DATA", 1476954421u, 0, 11, NULL);
be_define_const_str(HRXL_RX, "HRXL_RX", 92702006u, 0, 7, &be_const_str_PZEM017_RX);
be_define_const_str(PZEM017_RX, "PZEM017_RX", 3227495894u, 0, 10, &be_const_str_lv_msgbox);
be_define_const_str(lv_msgbox, "lv_msgbox", 689085206u, 0, 9, &be_const_str_scale_uint);
be_define_const_str(scale_uint, "scale_uint", 3090811094u, 0, 10, NULL);
be_define_const_str(HJL_CF, "HJL_CF", 786158487u, 0, 6, &be_const_str_PZEM016_RX);
be_define_const_str(PZEM016_RX, "PZEM016_RX", 1004012055u, 0, 10, &be_const_str___iterator__);
be_define_const_str(__iterator__, "__iterator__", 3884039703u, 0, 12, NULL);
be_define_const_str(BS814_CLK, "BS814_CLK", 3002713336u, 0, 9, &be_const_str_SSPI_DC);
be_define_const_str(SSPI_DC, "SSPI_DC", 1782271864u, 0, 7, &be_const_str_lv_cont);
be_define_const_str(lv_cont, "lv_cont", 1391686552u, 0, 7, &be_const_str_wire);
be_define_const_str(wire, "wire", 4082753944u, 0, 4, NULL);
be_define_const_str(MHZ_TXD, "MHZ_TXD", 3310158233u, 0, 7, &be_const_str_SBR_RX);
be_define_const_str(SBR_RX, "SBR_RX", 3350999801u, 0, 6, &be_const_str_SSPI_MOSI);
be_define_const_str(SSPI_MOSI, "SSPI_MOSI", 3745917497u, 0, 9, NULL);
be_define_const_str(BUZZER, "BUZZER", 1550039611u, 0, 6, &be_const_str_assert);
be_define_const_str(assert, "assert", 2774883451u, 0, 6, NULL);
be_define_const_str(SYMBOL_OK, "SYMBOL_OK", 4033162940u, 0, 9, &be_const_str_write);
...
be_define_const_str(Driver, "Driver", 3576386303u, 0, 6, &be_const_str_ELECTRIQ_MOODL_TX);
be_define_const_str(ELECTRIQ_MOODL_TX, "ELECTRIQ_MOODL_TX", 31009247u, 0, 17, &be_const_str_SYMBOL_BATTERY_1);
be_define_const_str(SYMBOL_BATTERY_1, "SYMBOL_BATTERY_1", 629036063u, 0, 16, &be_const_str_gc);
