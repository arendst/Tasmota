...
be_define_const_str(EPAPER42_CS, "EPAPER42_CS", 3274717451u, 0, 11, &be_const_str_ETH_PHY_MDC);
...
be_define_const_str(GPS_TX, "GPS_TX", 4228740808u, 0, 6, &be_const_str_PULLDOWN);
be_define_const_str(PULLDOWN, "PULLDOWN", 1853074086u, 0, 8, &be_const_str_SERIAL_8E1);
be_define_const_str(SERIAL_8E1, "SERIAL_8E1", 2371121616u, 0, 10, &be_const_str__get_cb);
be_define_const_str(_get_cb, "_get_cb", 1448849122u, 0, 7, NULL);
be_define_const_str(MHZ_RXD, "MHZ_RXD", 328619727u, 0, 7, &be_const_str__rules);
be_define_const_str(_rules, "_rules", 4266217105u, 0, 6, NULL);
be_define_const_str(_buffer, "_buffer", 2044888568u, 0, 7, NULL);
be_define_const_str(SERIAL_8E2, "SERIAL_8E2", 2421454473u, 0, 10, &be_const_str_TM1637DIO);
be_define_const_str(TM1637DIO, "TM1637DIO", 1574659381u, 0, 9, NULL);
be_define_const_str(AudioGeneratorMP3, "AudioGeneratorMP3", 2199818488u, 0, 17, &be_const_str_find_key_i);
...
be_define_const_str(SAIR_RX, "SAIR_RX", 1273688713u, 0, 7, &be_const_str_TCP_RX);
...
be_define_const_str(NONE, "NONE", 1932136219u, 0, 4, &be_const_str_get_power);
be_define_const_str(get_power, "get_power", 3009799377u, 0, 9, &be_const_str_read_bytes);
be_define_const_str(read_bytes, "read_bytes", 3576733173u, 0, 10, NULL);
be_define_const_str(addr, "addr", 1087856498u, 0, 4, &be_const_str_break);
be_define_const_str(break, "break", 3378807160u, 58, 5, NULL);
be_define_const_str(reverse, "reverse", 558918661u, 0, 7, &be_const_str_select);
be_define_const_str(select, "select", 297952813u, 0, 6, &be_const_str_tag);
be_define_const_str(tag, "tag", 2516003219u, 0, 3, NULL);
be_define_const_str(IEM3000_TX, "IEM3000_TX", 1185907310u, 0, 10, &be_const_str_SR04_ECHO);
...
be_define_const_str(SERIAL_8N1, "SERIAL_8N1", 2369297235u, 0, 10, &be_const_str_SM16716_CLK);
...
be_define_const_str(SERIAL_8N2, "SERIAL_8N2", 2386074854u, 0, 10, &be_const_str_TM1638CLK);
...
be_define_const_str(TM1638STB, "TM1638STB", 823674593u, 0, 9, &be_const_str_get_string);
...
be_define_const_str(TX2X_TXD_BLACK, "TX2X_TXD_BLACK", 956526176u, 0, 14, &be_const_str_exp);
...
be_define_const_str(EPD_DATA, "EPD_DATA", 3799141097u, 0, 8, &be_const_str_I2S_OUT_DATA);
be_define_const_str(I2S_OUT_DATA, "I2S_OUT_DATA", 1176288293u, 0, 12, &be_const_str_log);
be_define_const_str(log, "log", 1062293841u, 0, 3, NULL);
be_define_const_str(WEBCAM_XCLK, "WEBCAM_XCLK", 536207425u, 0, 11, &be_const_str_exec_cmd);
...
be_define_const_str(DDS2382_TX, "DDS2382_TX", 1438117864u, 0, 10, &be_const_str_state);
...
be_define_const_str(HPMA_TX, "HPMA_TX", 173233104u, 0, 7, &be_const_str_print);
...
be_define_const_str(OUTPUT_OPEN_DRAIN, "OUTPUT_OPEN_DRAIN", 2147249436u, 0, 17, &be_const_str_name);
be_define_const_str(name, "name", 2369371622u, 0, 4, &be_const_str_write);
be_define_const_str(write, "write", 3190202204u, 0, 5, &be_const_str_write_bytes);
...
be_define_const_str(EC_C25519, "EC_C25519", 95492591u, 0, 9, &be_const_str_SDM72_RX);
be_define_const_str(SDM72_RX, "SDM72_RX", 766750035u, 0, 8, &be_const_str_SERIAL_5E1);
be_define_const_str(SERIAL_5E1, "SERIAL_5E1", 1163775235u, 0, 10, NULL);
be_define_const_str(SERIAL_5E2, "SERIAL_5E2", 1180552854u, 0, 10, &be_const_str_end);
be_define_const_str(end, "end", 1787721130u, 56, 3, NULL);
be_define_const_str(DSB_OUT, "DSB_OUT", 732335085u, 0, 7, &be_const_str_bus);
...
be_define_const_str(ADC_BUTTON, "ADC_BUTTON", 3393454690u, 0, 10, &be_const_str_item);
...
be_define_const_str(AudioFileSourceFS, "AudioFileSourceFS", 1839147653u, 0, 17, &be_const_str_REL1);
be_define_const_str(REL1, "REL1", 3142397887u, 0, 4, &be_const_str_serial);
be_define_const_str(serial, "serial", 3687697785u, 0, 6, NULL);
be_define_const_str(copy, "copy", 3848464964u, 0, 4, &be_const_str_hex);
be_define_const_str(hex, "hex", 4273249610u, 0, 3, &be_const_str_isrunning);
be_define_const_str(isrunning, "isrunning", 1688182268u, 0, 9, NULL);
be_define_const_str(NRG_SEL_INV, "NRG_SEL_INV", 3567431069u, 0, 11, &be_const_str_SSD1351_DC);
be_define_const_str(SSD1351_DC, "SSD1351_DC", 84950353u, 0, 10, &be_const_str__global_addr);
...
be_define_const_str(INPUT, "INPUT", 1638025307u, 0, 5, &be_const_str_list);
...
be_define_const_str(HX711_DAT, "HX711_DAT", 2935118250u, 0, 9, &be_const_str_HX711_SCK);
be_define_const_str(HX711_SCK, "HX711_SCK", 3785979404u, 0, 9, &be_const_str_bytes);
be_define_const_str(bytes, "bytes", 1706151940u, 0, 5, &be_const_str_chars_in_string);
be_define_const_str(chars_in_string, "chars_in_string", 3148785132u, 0, 15, &be_const_str_set_timeouts);
...
be_define_const_str(opt_add, "+", 772578730u, 0, 1, &be_const_str_AS608_TX);
be_define_const_str(AS608_TX, "AS608_TX", 48630934u, 0, 8, &be_const_str_detect);
...
be_define_const_str(dot_w, ".w", 1255414514u, 0, 2, &be_const_str_except);
...
be_define_const_str(SSD1351_CS, "SSD1351_CS", 488746042u, 0, 10, &be_const_str_get_light);
be_define_const_str(get_light, "get_light", 381930476u, 0, 9, &be_const_str_log10);
be_define_const_str(log10, "log10", 2346846000u, 0, 5, &be_const_str_tomap);
...
be_define_const_str(A4988_MS1, "A4988_MS1", 1729976611u, 0, 9, &be_const_str_ZEROCROSS);
be_define_const_str(ZEROCROSS, "ZEROCROSS", 1747596785u, 0, 9, NULL);
be_define_const_str(rad, "rad", 1358899048u, 0, 3, NULL);
be_define_const_str(BOILER_OT_RX, "BOILER_OT_RX", 603647409u, 0, 12, &be_const_str_ZIGBEE_RST);
...
be_define_const_str(loop, "loop", 3723446379u, 0, 4, &be_const_str_target_search);
...
be_define_const_str(number, "number", 467038368u, 0, 6, &be_const_str_scan);
...
be_define_const_str(WEBCAM_DATA, "WEBCAM_DATA", 1476954421u, 0, 11, &be_const_str_remove);
...
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, &be_const_str_encrypt);
be_define_const_str(encrypt, "encrypt", 2194327650u, 0, 7, &be_const_str_get_switch);
be_define_const_str(get_switch, "get_switch", 164821028u, 0, 10, NULL);
be_define_const_str(KEY1_NP, "KEY1_NP", 709918726u, 0, 7, &be_const_str_SM16716_DAT);
be_define_const_str(SM16716_DAT, "SM16716_DAT", 1905621806u, 0, 11, &be_const_str_SPI_CS);
be_define_const_str(SPI_CS, "SPI_CS", 553701236u, 0, 6, &be_const_str__read);
...
be_define_const_str(Tasmota, "Tasmota", 4047617668u, 0, 7, &be_const_str_while);
be_define_const_str(while, "while", 231090382u, 53, 5, NULL);
be_define_const_str(DYP_RX, "DYP_RX", 2122310285u, 0, 6, NULL);
be_define_const_str(DDSU666_RX, "DDSU666_RX", 1812507936u, 0, 10, &be_const_str_PROJECTOR_CTRL_RX);
...
be_define_const_str(init, "init", 380752755u, 0, 4, &be_const_str_reset_search);
be_define_const_str(reset_search, "reset_search", 1350414305u, 0, 12, &be_const_str_sinh);
...
be_define_const_str(ILI9341_DC, "ILI9341_DC", 28838624u, 0, 10, &be_const_str_write8);
be_define_const_str(write8, "write8", 3133991532u, 0, 6, NULL);
be_define_const_str(INPUT_PULLDOWN, "INPUT_PULLDOWN", 1172232591u, 0, 14, &be_const_str_LOW);
be_define_const_str(LOW, "LOW", 3526092385u, 0, 3, &be_const_str_SDM630_RX);
...
be_define_const_str(AudioOutputI2S, "AudioOutputI2S", 638031784u, 0, 14, &be_const_str_write_bit);
be_define_const_str(write_bit, "write_bit", 2660990436u, 0, 9, NULL);
be_define_const_str(digital_write, "digital_write", 3435877979u, 0, 13, &be_const_str_open);
...
be_define_const_str(TFMINIPLUS_RX, "TFMINIPLUS_RX", 1522203935u, 0, 13, &be_const_str_set_timer);
be_define_const_str(set_timer, "set_timer", 2135414533u, 0, 9, NULL);
be_define_const_str(OUTPUT, "OUTPUT", 1469629700u, 0, 6, &be_const_str_P9813_DAT);
be_define_const_str(P9813_DAT, "P9813_DAT", 778577052u, 0, 9, &be_const_str_attrdump);
...
be_define_const_str(SDCARD_CS, "SDCARD_CS", 3348952003u, 0, 9, &be_const_str_SI7021);
be_define_const_str(SI7021, "SI7021", 864377911u, 0, 6, NULL);
be_define_const_str(POST, "POST", 1929554311u, 0, 4, &be_const_str_flush);
be_define_const_str(flush, "flush", 3002334877u, 0, 5, NULL);
be_define_const_str(pin_mode, "pin_mode", 3258314030u, 0, 8, &be_const_str_pop);
...
be_define_const_str(ADC_PH, "ADC_PH", 3820290594u, 0, 6, &be_const_str_RA8876_CS);
be_define_const_str(RA8876_CS, "RA8876_CS", 2529944108u, 0, 9, &be_const_str_begin);
be_define_const_str(begin, "begin", 1748273790u, 0, 5, NULL);
be_define_const_str(GET, "GET", 2531704439u, 0, 3, &be_const_str_pow);
be_define_const_str(pow, "pow", 1479764693u, 0, 3, NULL);
be_define_const_str(CNTR1_NP, "CNTR1_NP", 4288381648u, 0, 8, &be_const_str_add_header);
...
be_define_const_str(KEY1, "KEY1", 6715975u, 0, 4, &be_const_str_SDS0X1_RX);
...
be_define_const_str(A4988_ENA, "A4988_ENA", 1517502682u, 0, 9, &be_const_str_SERIAL_7O2);
...
be_define_const_str(wire, "wire", 4082753944u, 0, 4, &be_const_str_def);
be_define_const_str(def, "def", 3310976652u, 55, 3, NULL);
be_define_const_str(RFRECV, "RFRECV", 354742801u, 0, 6, &be_const_str_deg);
be_define_const_str(deg, "deg", 3327754271u, 0, 3, &be_const_str_as);
be_define_const_str(as, "as", 1579491469u, 67, 2, NULL);
be_define_const_str(yield, "yield", 1821831854u, 0, 5, NULL);
be_define_const_str(SDM630_TX, "SDM630_TX", 696213075u, 0, 9, &be_const_str_redirect);
be_define_const_str(redirect, "redirect", 389758641u, 0, 8, NULL);
be_define_const_str(NEOPOOL_RX, "NEOPOOL_RX", 1917974474u, 0, 10, &be_const_str_OPTION_A);
be_define_const_str(OPTION_A, "OPTION_A", 1133299440u, 0, 8, &be_const_str_wire_scan);
be_define_const_str(wire_scan, "wire_scan", 2671275880u, 0, 9, NULL);
be_define_const_str(read32, "read32", 1741276240u, 0, 6, &be_const_str_shared_key);
be_define_const_str(shared_key, "shared_key", 2200833624u, 0, 10, NULL);
be_define_const_str(SAIR_TX, "SAIR_TX", 268017311u, 0, 7, &be_const_str_read13);
be_define_const_str(read13, "read13", 12887293u, 0, 6, NULL);
be_define_const_str(DSB, "DSB", 98073254u, 0, 3, &be_const_str_PN532_RXD);
be_define_const_str(PN532_RXD, "PN532_RXD", 1780093022u, 0, 9, &be_const_str_finish);
be_define_const_str(finish, "finish", 1494643858u, 0, 6, &be_const_str_nil);
...
be_define_const_str(content_button, "content_button", 1956476087u, 0, 14, &be_const_str_gen_cb);
be_define_const_str(gen_cb, "gen_cb", 3245227551u, 0, 6, &be_const_str_get);
...
be_define_const_str(PWM1, "PWM1", 1353352426u, 0, 4, &be_const_str_find_op);
be_define_const_str(find_op, "find_op", 3766713376u, 0, 7, NULL);
be_define_const_str(KEY1_INV, "KEY1_INV", 263542563u, 0, 8, &be_const_str_OLED_RESET);
be_define_const_str(OLED_RESET, "OLED_RESET", 4048987655u, 0, 10, &be_const_str_SERIAL_6E2);
be_define_const_str(SERIAL_6E2, "SERIAL_6E2", 317471867u, 0, 10, NULL);
be_define_const_str(dot_size, ".size", 1965188224u, 0, 5, &be_const_str_SERIAL_6E1);
be_define_const_str(SERIAL_6E1, "SERIAL_6E1", 334249486u, 0, 10, &be_const_str_XPT2046_CS);
be_define_const_str(XPT2046_CS, "XPT2046_CS", 4049231042u, 0, 10, NULL);
be_define_const_str(dot_len, ".len", 850842136u, 0, 4, &be_const_str_SERIAL_6N2);
be_define_const_str(SERIAL_6N2, "SERIAL_6N2", 148562844u, 0, 10, &be_const_str___lower__);
...
be_define_const_str(HALLEFFECT, "HALLEFFECT", 3334305407u, 0, 10, &be_const_str_SERIAL_6N1);
...
be_define_const_str(I2C_SDA, "I2C_SDA", 1052592262u, 0, 7, &be_const_str_INTERRUPT);
be_define_const_str(INTERRUPT, "INTERRUPT", 3809502704u, 0, 9, &be_const_str_WEBCAM_HREF);
be_define_const_str(WEBCAM_HREF, "WEBCAM_HREF", 3161890024u, 0, 11, &be_const_str_rand);
be_define_const_str(rand, "rand", 2711325910u, 0, 4, NULL);
be_define_const_str(opt_neq, "!=", 2428715011u, 0, 2, &be_const_str_DAC);
be_define_const_str(DAC, "DAC", 788912847u, 0, 3, &be_const_str_EXS_ENABLE);
be_define_const_str(EXS_ENABLE, "EXS_ENABLE", 1896914313u, 0, 10, &be_const_str_acos);
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_srand);
...
be_define_const_str(_ccmd, "_ccmd", 2163421413u, 0, 5, &be_const_str_abs);
be_define_const_str(abs, "abs", 709362235u, 0, 3, &be_const_str_call);
...
be_define_const_str(AS3935, "AS3935", 603621745u, 0, 6, &be_const_str_get_size);
be_define_const_str(get_size, "get_size", 2803644713u, 0, 8, NULL);
be_define_const_str(RC522_CS, "RC522_CS", 2639619996u, 0, 8, &be_const_str_WS2812);
be_define_const_str(WS2812, "WS2812", 3539741218u, 0, 6, &be_const_str_count);
...
be_define_const_str(opt_connect, "..", 2748622605u, 0, 2, &be_const_str_cb_dispatch);
be_define_const_str(cb_dispatch, "cb_dispatch", 1741510499u, 0, 11, &be_const_str_strftime);
...
be_define_const_str(content_send, "content_send", 1673733649u, 0, 12, &be_const_str_ctypes_bytes_dyn);
...
be_define_const_str(DI, "DI", 1070498734u, 0, 2, &be_const_str_ZIGBEE_TX);
...
be_define_const_str(BACKLIGHT, "BACKLIGHT", 3147761926u, 0, 9, &be_const_str_WEBCAM_PSRCS);
be_define_const_str(WEBCAM_PSRCS, "WEBCAM_PSRCS", 624464864u, 0, 12, NULL);
be_define_const_str(LE01MR_RX, "LE01MR_RX", 1521590809u, 0, 9, &be_const_str_MP3_DFR562);
be_define_const_str(MP3_DFR562, "MP3_DFR562", 2859952977u, 0, 10, &be_const_str_arg_name);
...
be_define_const_str(AudioGenerator, "AudioGenerator", 1839297342u, 0, 14, &be_const_str_if);
be_define_const_str(if, "if", 959999494u, 50, 2, NULL);
be_define_const_str(CSE7766_RX, "CSE7766_RX", 1546766819u, 0, 10, &be_const_str_IBEACON_RX);
be_define_const_str(IBEACON_RX, "IBEACON_RX", 2466155575u, 0, 10, &be_const_str_depower);
be_define_const_str(depower, "depower", 3563819571u, 0, 7, &be_const_str_get_free_heap);
be_define_const_str(get_free_heap, "get_free_heap", 625069757u, 0, 13, &be_const_str_millis);
...
be_define_const_str(WEBCAM_VSYNC, "WEBCAM_VSYNC", 4032882166u, 0, 12, &be_const_str_nan);
be_define_const_str(nan, "nan", 797905850u, 0, 3, NULL);
be_define_const_str(MAX7219DIN, "MAX7219DIN", 380687049u, 0, 10, &be_const_str_resize);
be_define_const_str(resize, "resize", 3514612129u, 0, 6, &be_const_str_resp_cmnd_done);
be_define_const_str(resp_cmnd_done, "resp_cmnd_done", 2601874875u, 0, 14, NULL);
be_define_const_str(_ptr, "_ptr", 306235816u, 0, 4, &be_const_str_exec_rules);
...
be_define_const_str(AudioGeneratorWAV, "AudioGeneratorWAV", 2746509368u, 0, 17, &be_const_str_OUTPUT_HI);
...
be_define_const_str(ARIRFRCV, "ARIRFRCV", 1120816444u, 0, 8, &be_const_str_CSE7761_RX);
be_define_const_str(CSE7761_RX, "CSE7761_RX", 65423248u, 0, 10, &be_const_str_resp_cmnd);
be_define_const_str(resp_cmnd, "resp_cmnd", 2869459626u, 0, 9, NULL);
be_define_const_str(AudioFileSource, "AudioFileSource", 2959980058u, 0, 15, &be_const_str_MIEL_HVAC_TX);
be_define_const_str(MIEL_HVAC_TX, "MIEL_HVAC_TX", 567403014u, 0, 12, &be_const_str_SERIAL_5O2);
be_define_const_str(SERIAL_5O2, "SERIAL_5O2", 3732325060u, 0, 10, &be_const_str_publish);
be_define_const_str(publish, "publish", 264247304u, 0, 7, NULL);
be_define_const_str(ILI9488_CS, "ILI9488_CS", 2363112073u, 0, 10, &be_const_str_LEDLNK);
be_define_const_str(LEDLNK, "LEDLNK", 2862810701u, 0, 6, &be_const_str_MAX31855CLK);
be_define_const_str(MAX31855CLK, "MAX31855CLK", 715977727u, 0, 11, &be_const_str_SSPI_MOSI);
be_define_const_str(SSPI_MOSI, "SSPI_MOSI", 3745917497u, 0, 9, &be_const_str_TASMOTACLIENT_RST_INV);
be_define_const_str(TASMOTACLIENT_RST_INV, "TASMOTACLIENT_RST_INV", 2601785365u, 0, 21, &be_const_str_read8);
be_define_const_str(read8, "read8", 2802788167u, 0, 5, NULL);
be_define_const_str(MCP39F5_RST, "MCP39F5_RST", 3657125652u, 0, 11, &be_const_str_TM1638DIO);
be_define_const_str(TM1638DIO, "TM1638DIO", 1408212414u, 0, 9, &be_const_str_read12);
be_define_const_str(read12, "read12", 4291076970u, 0, 6, NULL);
be_define_const_str(DHT22, "DHT22", 215937903u, 0, 5, &be_const_str_SERIAL_5O1);
...
be_define_const_str(I2S_IN_DATA, "I2S_IN_DATA", 4125971460u, 0, 11, &be_const_str_WEBCAM_RESET);
...
be_define_const_str(A4988_DIR, "A4988_DIR", 2223595843u, 0, 9, &be_const_str_WIEGAND_D0);
be_define_const_str(WIEGAND_D0, "WIEGAND_D0", 4192335759u, 0, 10, NULL);
be_define_const_str(I2S_IN_CLK, "I2S_IN_CLK", 2996930120u, 0, 10, &be_const_str_MIEL_HVAC_RX);
be_define_const_str(MIEL_HVAC_RX, "MIEL_HVAC_RX", 3720609648u, 0, 12, NULL);
be_define_const_str(BUZZER_INV, "BUZZER_INV", 3274564335u, 0, 10, &be_const_str_gamma10);
be_define_const_str(gamma10, "gamma10", 3472052483u, 0, 7, NULL);
be_define_const_str(dot_p2, ".p2", 232398067u, 0, 3, &be_const_str_getbits);
be_define_const_str(getbits, "getbits", 3094168979u, 0, 7, NULL);
be_define_const_str(dot_p1, ".p1", 249175686u, 0, 3, &be_const_str_I2C_SCL);
be_define_const_str(I2C_SCL, "I2C_SCL", 164217098u, 0, 7, &be_const_str_RF_SENSOR);
be_define_const_str(RF_SENSOR, "RF_SENSOR", 2289628100u, 0, 9, NULL);
be_define_const_str(PZEM016_RX, "PZEM016_RX", 1004012055u, 0, 10, &be_const_str_response_append);
be_define_const_str(response_append, "response_append", 450346371u, 0, 15, NULL);
be_define_const_str(DCKI, "DCKI", 3846847480u, 0, 4, &be_const_str_MAX31855DO);
be_define_const_str(MAX31855DO, "MAX31855DO", 552730368u, 0, 10, &be_const_str_global);
be_define_const_str(global, "global", 503252654u, 0, 6, &be_const_str_set_useragent);
be_define_const_str(set_useragent, "set_useragent", 612237244u, 0, 13, NULL);
be_define_const_str(ILI9341_CS, "ILI9341_CS", 3519318851u, 0, 10, &be_const_str_atan);
...
be_define_const_str(I2S_OUT_CLK, "I2S_OUT_CLK", 2580200387u, 0, 11, &be_const_str_SERIAL_8O2);
be_define_const_str(SERIAL_8O2, "SERIAL_8O2", 272345123u, 0, 10, &be_const_str_member);
be_define_const_str(member, "member", 719708611u, 0, 6, &be_const_str_set_power);
be_define_const_str(set_power, "set_power", 549820893u, 0, 9, &be_const_str_wire1);
be_define_const_str(wire1, "wire1", 3212721419u, 0, 5, NULL);
be_define_const_str(BS814_CLK, "BS814_CLK", 3002713336u, 0, 9, &be_const_str_PZEM017_RX);
be_define_const_str(PZEM017_RX, "PZEM017_RX", 3227495894u, 0, 10, &be_const_str_SERIAL_8O1);
be_define_const_str(SERIAL_8O1, "SERIAL_8O1", 289122742u, 0, 10, &be_const_str_isinstance);
be_define_const_str(isinstance, "isinstance", 3669352738u, 0, 10, &be_const_str_wire2);
be_define_const_str(wire2, "wire2", 3229499038u, 0, 5, &be_const_str_false);
...
be_define_const_str(Wire, "Wire", 1938276536u, 0, 4, &be_const_str_resp_cmnd_str);
be_define_const_str(resp_cmnd_str, "resp_cmnd_str", 737845590u, 0, 13, &be_const_str_else);
be_define_const_str(else, "else", 3183434736u, 52, 4, &be_const_str_for);
be_define_const_str(for, "for", 2901640080u, 54, 3, NULL);
be_define_const_str(TASMOTACLIENT_RST, "TASMOTACLIENT_RST", 3326196213u, 0, 17, &be_const_str_assert);
...
be_define_const_str(MCP39F5_TX, "MCP39F5_TX", 1332322047u, 0, 10, &be_const_str__drivers);
be_define_const_str(_drivers, "_drivers", 3260328985u, 0, 8, &be_const_str_gc);
be_define_const_str(gc, "gc", 1042313471u, 0, 2, &be_const_str_set);
be_define_const_str(set, "set", 3324446467u, 0, 3, NULL);
be_define_const_str(SPI_MISO, "SPI_MISO", 150818010u, 0, 8, &be_const_str_calldepth);
...
be_define_const_str(ADE7953_IRQ, "ADE7953_IRQ", 2329185922u, 0, 11, &be_const_str_ST7789_CS);
be_define_const_str(ST7789_CS, "ST7789_CS", 2937305434u, 0, 9, &be_const_str__begin_transmission);
be_define_const_str(_begin_transmission, "_begin_transmission", 2779461176u, 0, 19, NULL);
be_define_const_str(DEEPSLEEP, "DEEPSLEEP", 189922226u, 0, 9, &be_const_str_GPS_RX);
be_define_const_str(GPS_RX, "GPS_RX", 1075637342u, 0, 6, &be_const_str_HM10_RX);
be_define_const_str(HM10_RX, "HM10_RX", 515085922u, 0, 7, &be_const_str_MAX7219CS);
be_define_const_str(MAX7219CS, "MAX7219CS", 2593198244u, 0, 9, &be_const_str_isnan);
be_define_const_str(isnan, "isnan", 2981347434u, 0, 5, &be_const_str_web_send);
be_define_const_str(web_send, "web_send", 2989941448u, 0, 8, NULL);
be_define_const_str(WE517_TX, "WE517_TX", 2954817217u, 0, 8, &be_const_str_content_start);
be_define_const_str(content_start, "content_start", 2937509069u, 0, 13, NULL);
be_define_const_str(SSD1331_CS, "SSD1331_CS", 4191047928u, 0, 10, &be_const_str_codedump);
...
be_define_const_str(FALLING, "FALLING", 2851701064u, 0, 7, &be_const_str_classname);
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_cos);
be_define_const_str(cos, "cos", 4220379804u, 0, 3, &be_const_str_save);
be_define_const_str(save, "save", 3439296072u, 0, 4, NULL);
be_define_const_str(CC1101_GDO0, "CC1101_GDO0", 940611027u, 0, 11, &be_const_str_LEDLNK_INV);
be_define_const_str(LEDLNK_INV, "LEDLNK_INV", 3559015101u, 0, 10, NULL);
be_define_const_str(AS608_RX, "AS608_RX", 4275502016u, 0, 8, &be_const_str_HPMA_RX);
be_define_const_str(HPMA_RX, "HPMA_RX", 3462528998u, 0, 7, &be_const_str_gamma8);
be_define_const_str(gamma8, "gamma8", 3802843830u, 0, 6, &be_const_str_top);
be_define_const_str(top, "top", 2802900028u, 0, 3, NULL);
be_define_const_str(CC1101_GDO2, "CC1101_GDO2", 974166265u, 0, 11, &be_const_str_CHANGE);
be_define_const_str(CHANGE, "CHANGE", 4280911421u, 0, 6, &be_const_str_MAX31855CS);
...
be_define_const_str(SERIAL_7N2, "SERIAL_7N2", 1874282627u, 0, 10, &be_const_str_i2c_enabled);
...
be_define_const_str(SERIAL_7N1, "SERIAL_7N1", 1891060246u, 0, 10, &be_const_str_WINDMETER_SPEED);
...
be_define_const_str(DHT11_OUT, "DHT11_OUT", 1645300734u, 0, 9, &be_const_str_ROT1B_NP);
...
be_define_const_str(NRF24_DC, "NRF24_DC", 688921313u, 0, 8, &be_const_str_RC522_RST);
be_define_const_str(RC522_RST, "RC522_RST", 720511443u, 0, 9, &be_const_str_concat);
be_define_const_str(concat, "concat", 4124019837u, 0, 6, NULL);
be_define_const_str(read, "read", 3470762949u, 0, 4, &be_const_str_sqrt);
...
be_define_const_str(MGC3130_RESET, "MGC3130_RESET", 405013121u, 0, 13, &be_const_str_add_rule);
be_define_const_str(add_rule, "add_rule", 596540743u, 0, 8, &be_const_str_read24);
...
be_define_const_str(SSPI_DC, "SSPI_DC", 1782271864u, 0, 7, &be_const_str_dac_voltage);
...
be_define_const_str(REL1_INV, "REL1_INV", 3733155371u, 0, 8, &be_const_str_ROT1A_NP);
be_define_const_str(ROT1A_NP, "ROT1A_NP", 2322706903u, 0, 8, &be_const_str_char);
...
be_define_const_str(RDM6300_RX, "RDM6300_RX", 1522345628u, 0, 10, &be_const_str_setrange);
be_define_const_str(setrange, "setrange", 3794019032u, 0, 8, NULL);
be_define_const_str(AZ_RXD, "AZ_RXD", 699914019u, 0, 6, &be_const_str_LMT01);
be_define_const_str(LMT01, "LMT01", 2490623797u, 0, 5, &be_const_str_atan2);
be_define_const_str(atan2, "atan2", 3173440503u, 0, 5, &be_const_str_real);
...
be_define_const_str(SPI_CLK, "SPI_CLK", 3943233814u, 0, 7, &be_const_str_has_arg);
be_define_const_str(has_arg, "has_arg", 424878688u, 0, 7, NULL);
be_define_const_str(BL0940_RX, "BL0940_RX", 2908993179u, 0, 9, &be_const_str_MCP39F5_RX);
be_define_const_str(MCP39F5_RX, "MCP39F5_RX", 190458217u, 0, 10, &be_const_str_SHELLY_DIMMER_RST_INV);
be_define_const_str(SHELLY_DIMMER_RST_INV, "SHELLY_DIMMER_RST_INV", 2366759773u, 0, 21, &be_const_str_time_dump);
...
be_define_const_str(SERIAL_6O1, "SERIAL_6O1", 266153272u, 0, 10, &be_const_str_decrypt);
be_define_const_str(decrypt, "decrypt", 2886974618u, 0, 7, NULL);
be_define_const_str(IRSEND, "IRSEND", 184848336u, 0, 6, &be_const_str_SERIAL_5N1);
be_define_const_str(SERIAL_5N1, "SERIAL_5N1", 3313031680u, 0, 10, &be_const_str_set_auth);
be_define_const_str(set_auth, "set_auth", 1057170930u, 0, 8, NULL);
be_define_const_str(SDS0X1_TX, "SDS0X1_TX", 165045983u, 0, 9, &be_const_str_SERIAL_6O2);
...
be_define_const_str(RISING, "RISING", 1256404539u, 0, 6, &be_const_str_SERIAL_5N2);
...
be_define_const_str(ADC_RANGE, "ADC_RANGE", 3467329543u, 0, 9, &be_const_str__cb);
be_define_const_str(_cb, "_cb", 4043300367u, 0, 3, &be_const_str_setmember);
be_define_const_str(setmember, "setmember", 1432909441u, 0, 9, NULL);
be_define_const_str(NRG_SEL, "NRG_SEL", 1771358125u, 0, 7, &be_const_str_WE517_RX);
...
be_define_const_str(TCP_TX, "TCP_TX", 2762594089u, 0, 6, &be_const_str_content_send_style);
be_define_const_str(content_send_style, "content_send_style", 1087907647u, 0, 18, &be_const_str_map);
...
be_define_const_str(SOLAXX1_TX, "SOLAXX1_TX", 903770840u, 0, 10, &be_const_str_SSPI_MAX31865_CS1);
be_define_const_str(SSPI_MAX31865_CS1, "SSPI_MAX31865_CS1", 1256578724u, 0, 17, &be_const_str_webclient);
be_define_const_str(webclient, "webclient", 4076389146u, 0, 9, NULL);
be_define_const_str(resolvecmnd, "resolvecmnd", 993361485u, 0, 11, &be_const_str_return);
...
be_define_const_str(BOILER_OT_TX, "BOILER_OT_TX", 671743623u, 0, 12, &be_const_str_SWT1_PD);
be_define_const_str(SWT1_PD, "SWT1_PD", 4166278953u, 0, 7, &be_const_str_WEBCAM_SIOC);
be_define_const_str(WEBCAM_SIOC, "WEBCAM_SIOC", 218815147u, 0, 11, &be_const_str_close);
...
be_define_const_str(ELECTRIQ_MOODL_TX, "ELECTRIQ_MOODL_TX", 31009247u, 0, 17, &be_const_str_LED1);
be_define_const_str(LED1, "LED1", 21005825u, 0, 4, &be_const_str_TELEINFO_ENABLE);
be_define_const_str(TELEINFO_ENABLE, "TELEINFO_ENABLE", 1600974501u, 0, 15, NULL);
be_define_const_str(OPEN_DRAIN, "OPEN_DRAIN", 677872608u, 0, 10, &be_const_str_WEBCAM_SIOD);
be_define_const_str(WEBCAM_SIOD, "WEBCAM_SIOD", 302703242u, 0, 11, &be_const_str__timers);
...
be_define_const_str(TFMINIPLUS_TX, "TFMINIPLUS_TX", 2527875337u, 0, 13, &be_const_str_ctypes_bytes);
be_define_const_str(ctypes_bytes, "ctypes_bytes", 3879019703u, 0, 12, NULL);
be_define_const_str(FTC532, "FTC532", 3182343438u, 0, 6, &be_const_str_HLW_CF);
be_define_const_str(HLW_CF, "HLW_CF", 3982619486u, 0, 6, &be_const_str_TASMOTACLIENT_TXD);
be_define_const_str(TASMOTACLIENT_TXD, "TASMOTACLIENT_TXD", 1386193940u, 0, 17, &be_const_str__request_from);
...
be_define_const_str(HRE_CLOCK, "HRE_CLOCK", 2870559111u, 0, 9, &be_const_str_search);
be_define_const_str(search, "search", 2150836393u, 0, 6, NULL);
be_define_const_str(continue, "continue", 2977070660u, 59, 8, NULL);
be_define_const_str(DHT11, "DHT11", 367083569u, 0, 5, &be_const_str_reduce);
be_define_const_str(reduce, "reduce", 2002030311u, 0, 6, &be_const_str_time_reached);
be_define_const_str(time_reached, "time_reached", 2075136773u, 0, 12, &be_const_str_url_encode);
be_define_const_str(url_encode, "url_encode", 528392145u, 0, 10, NULL);
be_define_const_str(DDSU666_TX, "DDSU666_TX", 1880604150u, 0, 10, &be_const_str_rtc);
...
be_define_const_str(_def, "_def", 1985022181u, 0, 4, &be_const_str_tolower);
