...
be_define_const_str(OneWire, "OneWire", 2298990722u, 0, 7, &be_const_str_XPT2046_CS);
...
be_define_const_str(dot_p1, ".p1", 249175686u, 0, 3, &be_const_str_BACKLIGHT);
...
be_define_const_str(load_font, "load_font", 1875840019u, 0, 9, &be_const_str_tag);
...
be_define_const_str(PULLUP, "PULLUP", 3417628531u, 0, 6, &be_const_str_depower);
...
be_define_const_str(GCM, "GCM", 3790320054u, 0, 3, &be_const_str_SPI_MOSI);
...
be_define_const_str(ADC_CT_POWER, "ADC_CT_POWER", 3382284599u, 0, 12, &be_const_str_fromb64);
...
be_define_const_str(MHZ_TXD, "MHZ_TXD", 3310158233u, 0, 7, &be_const_str_target_search);
...
be_define_const_str(OUTPUT_LO, "OUTPUT_LO", 3724620328u, 0, 9, &be_const_str_rad);
...
be_define_const_str(SYMBOL_EYE_CLOSE, "SYMBOL_EYE_CLOSE", 404721792u, 0, 16, &be_const_str_reset);
be_define_const_str(reset, "reset", 1695364032u, 0, 5, NULL);
be_define_const_str(SYMBOL_VIDEO, "SYMBOL_VIDEO", 789726913u, 0, 12, NULL);
be_define_const_str(lv_textarea, "lv_textarea", 2864635074u, 0, 11, &be_const_str_skip);
...
be_define_const_str(lv_objmask, "lv_objmask", 1311221665u, 0, 10, &be_const_str_reset_search);
...
be_define_const_str(lv_cb, "lv_cb", 1389787433u, 0, 5, &be_const_str_search);
...
be_define_const_str(AudioGeneratorWAV, "AudioGeneratorWAV", 2746509368u, 0, 17, &be_const_str_SSD1331_CS);
...
be_define_const_str(SDS0X1_RX, "SDS0X1_RX", 1170717385u, 0, 9, &be_const_str_lv_draw_mask_line_param_cfg);
...
be_define_const_str(A4988_MS1, "A4988_MS1", 1729976611u, 0, 9, &be_const_str_lv_cpicker);
