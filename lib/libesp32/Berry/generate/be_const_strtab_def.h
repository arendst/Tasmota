...
be_define_const_str(MGC3130_RESET, "MGC3130_RESET", 405013121u, 0, 13, &be_const_str_SYMBOL_REFRESH);
be_define_const_str(SYMBOL_REFRESH, "SYMBOL_REFRESH", 1266229761u, 0, 14, &be_const_str_lv_area);
be_define_const_str(lv_area, "lv_area", 2521150401u, 0, 7, &be_const_str_setmember);
be_define_const_str(setmember, "setmember", 1432909441u, 0, 9, NULL);
be_define_const_str(ADE7953_IRQ, "ADE7953_IRQ", 2329185922u, 0, 11, &be_const_str_XPT2046_CS);
be_define_const_str(XPT2046_CS, "XPT2046_CS", 4049231042u, 0, 10, NULL);
be_define_const_str(A4988_DIR, "A4988_DIR", 2223595843u, 0, 9, &be_const_str_SDCARD_CS);
be_define_const_str(SDCARD_CS, "SDCARD_CS", 3348952003u, 0, 9, &be_const_str___upper__);
...
be_define_const_str(BACKLIGHT, "BACKLIGHT", 3147761926u, 0, 9, &be_const_str_KEY1_NP);
...
be_define_const_str(SYMBOL_EJECT, "SYMBOL_EJECT", 873760647u, 0, 12, &be_const_str_read8);
be_define_const_str(read8, "read8", 2802788167u, 0, 5, &be_const_str_upper);
be_define_const_str(upper, "upper", 176974407u, 0, 5, NULL);
be_define_const_str(GPS_TX, "GPS_TX", 4228740808u, 0, 6, &be_const_str_lv_draw_mask_angle_param_cfg);
be_define_const_str(lv_draw_mask_angle_param_cfg, "lv_draw_mask_angle_param_cfg", 3599767368u, 0, 28, &be_const_str_lv_draw_rect_dsc);
be_define_const_str(lv_draw_rect_dsc, "lv_draw_rect_dsc", 3246772488u, 0, 16, &be_const_str_web_send);
be_define_const_str(web_send, "web_send", 2989941448u, 0, 8, NULL);
be_define_const_str(MAX7219DIN, "MAX7219DIN", 380687049u, 0, 10, &be_const_str_SYMBOL_DIRECTORY);
...
be_define_const_str(web_sensor, "web_sensor", 2900096972u, 0, 10, &be_const_str_def);
be_define_const_str(def, "def", 3310976652u, 55, 3, NULL);
be_define_const_str(SYMBOL_VOLUME_MAX, "SYMBOL_VOLUME_MAX", 3582646093u, 0, 17, &be_const_str_type);
be_define_const_str(type, "type", 1361572173u, 0, 4, NULL);
be_define_const_str(WEBCAM_PWDN, "WEBCAM_PWDN", 2219597454u, 0, 11, NULL);
be_define_const_str(opt_eq, "==", 2431966415u, 0, 2, &be_const_str_SBR_TX);
be_define_const_str(SBR_TX, "SBR_TX", 3419096015u, 0, 6, &be_const_str_SYMBOL_SETTINGS);
be_define_const_str(SYMBOL_SETTINGS, "SYMBOL_SETTINGS", 339656335u, 0, 15, NULL);
be_define_const_str(IRSEND, "IRSEND", 184848336u, 0, 6, &be_const_str_button_pressed);
be_define_const_str(button_pressed, "button_pressed", 1694209616u, 0, 14, NULL);
be_define_const_str(MP3_DFR562, "MP3_DFR562", 2859952977u, 0, 10, &be_const_str_get_power);
...
be_define_const_str(getbits, "getbits", 3094168979u, 0, 7, &be_const_str_load_font);
be_define_const_str(load_font, "load_font", 1875840019u, 0, 9, NULL);
be_define_const_str(SYMBOL_PLAY, "SYMBOL_PLAY", 1750902100u, 0, 11, &be_const_str_TASMOTACLIENT_TXD);
be_define_const_str(TASMOTACLIENT_TXD, "TASMOTACLIENT_TXD", 1386193940u, 0, 17, &be_const_str_pin);
be_define_const_str(pin, "pin", 1866532500u, 0, 3, &be_const_str_import);
be_define_const_str(import, "import", 288002260u, 66, 6, NULL);
be_define_const_str(IRRECV, "IRRECV", 1743648982u, 0, 6, NULL);
be_define_const_str(ROT1A_NP, "ROT1A_NP", 2322706903u, 0, 8, &be_const_str___iterator__);
...
be_define_const_str(PZEM0XX_TX, "PZEM0XX_TX", 944775704u, 0, 10, &be_const_str_delay);
be_define_const_str(delay, "delay", 1322381784u, 0, 5, &be_const_str_wire);
be_define_const_str(wire, "wire", 4082753944u, 0, 4, NULL);
be_define_const_str(TUYA_TX, "TUYA_TX", 1541301465u, 0, 7, &be_const_str__drivers);
be_define_const_str(_drivers, "_drivers", 3260328985u, 0, 8, NULL);
be_define_const_str(opt_call, "()", 685372826u, 0, 2, NULL);
be_define_const_str(INPUT, "INPUT", 1638025307u, 0, 5, &be_const_str_SYMBOL_POWER);
...
be_define_const_str(NRG_SEL_INV, "NRG_SEL_INV", 3567431069u, 0, 11, &be_const_str_lv_style);
be_define_const_str(lv_style, "lv_style", 4151611549u, 0, 8, NULL);
be_define_const_str(lv_point, "lv_point", 4120221790u, 0, 8, NULL);
be_define_const_str(MAX31855CS, "MAX31855CS", 753620511u, 0, 10, &be_const_str_SAIR_TX);
be_define_const_str(SAIR_TX, "SAIR_TX", 268017311u, 0, 7, &be_const_str_deg);
be_define_const_str(deg, "deg", 3327754271u, 0, 3, &be_const_str_gen_cb);
be_define_const_str(gen_cb, "gen_cb", 3245227551u, 0, 6, &be_const_str_start);
...
be_define_const_str(NRF24_DC, "NRF24_DC", 688921313u, 0, 8, &be_const_str_TM1638STB);
be_define_const_str(TM1638STB, "TM1638STB", 823674593u, 0, 9, NULL);
be_define_const_str(ADC_PH, "ADC_PH", 3820290594u, 0, 6, &be_const_str_clear);
be_define_const_str(clear, "clear", 1550717474u, 0, 5, NULL);
be_define_const_str(raise, "raise", 1593437475u, 70, 5, NULL);
be_define_const_str(ROT1A, "ROT1A", 759599716u, 0, 5, &be_const_str_SYMBOL_AUDIO);
be_define_const_str(SYMBOL_AUDIO, "SYMBOL_AUDIO", 3056537956u, 0, 12, &be_const_str_setitem);
...
be_define_const_str(NRG_CF1, "NRG_CF1", 3292534757u, 0, 7, &be_const_str_stop);
be_define_const_str(stop, "stop", 3411225317u, 0, 4, NULL);
be_define_const_str(HPMA_RX, "HPMA_RX", 3462528998u, 0, 7, &be_const_str_SYMBOL_MINUS);
...
be_define_const_str(iter, "iter", 3124256359u, 0, 4, &be_const_str_lv_draw_mask_saved);
...
be_define_const_str(SYMBOL_BACKSPACE, "SYMBOL_BACKSPACE", 1997168681u, 0, 16, &be_const_str_call);
...
be_define_const_str(ADC_BUTTON_INV, "ADC_BUTTON_INV", 2027625326u, 0, 14, &be_const_str_SM16716_DAT);
be_define_const_str(SM16716_DAT, "SM16716_DAT", 1905621806u, 0, 11, &be_const_str_SYMBOL_CALL);
be_define_const_str(SYMBOL_CALL, "SYMBOL_CALL", 1444504366u, 0, 11, &be_const_str_TM1638CLK);
be_define_const_str(TM1638CLK, "TM1638CLK", 3045182446u, 0, 9, NULL);
be_define_const_str(AudioOutput, "AudioOutput", 3257792048u, 0, 11, &be_const_str_MIEL_HVAC_RX);
...
be_define_const_str(DHT11, "DHT11", 367083569u, 0, 5, &be_const_str_tolower);
be_define_const_str(tolower, "tolower", 1042520049u, 0, 7, NULL);
be_define_const_str(PMS5003_RX, "PMS5003_RX", 3934985650u, 0, 10, NULL);
be_define_const_str(PULLUP, "PULLUP", 3417628531u, 0, 6, &be_const_str_read24);
be_define_const_str(read24, "read24", 1808533811u, 0, 6, NULL);
be_define_const_str(TASMOTACLIENT_RST, "TASMOTACLIENT_RST", 3326196213u, 0, 17, &be_const_str_lv_font);
...
be_define_const_str(SSPI_MOSI, "SSPI_MOSI", 3745917497u, 0, 9, &be_const_str_TM1637CLK);
be_define_const_str(TM1637CLK, "TM1637CLK", 2797300857u, 0, 9, &be_const_str_arg_size);
be_define_const_str(arg_size, "arg_size", 3310243257u, 0, 8, NULL);
be_define_const_str(RISING, "RISING", 1256404539u, 0, 6, &be_const_str_input);
be_define_const_str(input, "input", 4191711099u, 0, 5, NULL);
be_define_const_str(SYMBOL_OK, "SYMBOL_OK", 4033162940u, 0, 9, &be_const_str_WIEGAND_D1);
be_define_const_str(WIEGAND_D1, "WIEGAND_D1", 4175558140u, 0, 10, NULL);
be_define_const_str(CHANGE, "CHANGE", 4280911421u, 0, 6, &be_const_str_ETH_PHY_MDC);
be_define_const_str(ETH_PHY_MDC, "ETH_PHY_MDC", 1519379581u, 0, 11, &be_const_str_HIGH);
be_define_const_str(HIGH, "HIGH", 2066738941u, 0, 4, &be_const_str_LEDLNK_INV);
be_define_const_str(LEDLNK_INV, "LEDLNK_INV", 3559015101u, 0, 10, NULL);
be_define_const_str(ADC_LIGHT, "ADC_LIGHT", 3982461502u, 0, 9, &be_const_str_AudioGenerator);
be_define_const_str(AudioGenerator, "AudioGenerator", 1839297342u, 0, 14, &be_const_str_DDS2382_RX);
be_define_const_str(DDS2382_RX, "DDS2382_RX", 432446462u, 0, 10, &be_const_str__cmd);
...
be_define_const_str(LED1, "LED1", 21005825u, 0, 4, &be_const_str_WEBCAM_XCLK);
...
be_define_const_str(SYMBOL_SHUFFLE, "SYMBOL_SHUFFLE", 1123310147u, 0, 14, &be_const_str_set);
be_define_const_str(set, "set", 3324446467u, 0, 3, &be_const_str_elif);
be_define_const_str(elif, "elif", 3232090307u, 51, 4, NULL);
be_define_const_str(Tasmota, "Tasmota", 4047617668u, 0, 7, &be_const_str_lv_draw_mask_common_dsc);
...
be_define_const_str(EXS_ENABLE, "EXS_ENABLE", 1896914313u, 0, 10, &be_const_str_ILI9488_CS);
be_define_const_str(ILI9488_CS, "ILI9488_CS", 2363112073u, 0, 10, &be_const_str_SAIR_RX);
be_define_const_str(SAIR_RX, "SAIR_RX", 1273688713u, 0, 7, NULL);
be_define_const_str(NEOPOOL_RX, "NEOPOOL_RX", 1917974474u, 0, 10, &be_const_str_SYMBOL_CUT);
be_define_const_str(SYMBOL_CUT, "SYMBOL_CUT", 3455112394u, 0, 10, NULL);
be_define_const_str(arg_name, "arg_name", 1345046155u, 0, 8, &be_const_str_lv_sqrt_res);
...
be_define_const_str(SYMBOL_KEYBOARD, "SYMBOL_KEYBOARD", 1621492879u, 0, 15, &be_const_str_WIEGAND_D0);
be_define_const_str(WIEGAND_D0, "WIEGAND_D0", 4192335759u, 0, 10, &be_const_str_sqrt);
be_define_const_str(sqrt, "sqrt", 2112764879u, 0, 4, NULL);
be_define_const_str(WEBCAM_RESET, "WEBCAM_RESET", 2171221520u, 0, 12, &be_const_str__end_transmission);
be_define_const_str(_end_transmission, "_end_transmission", 3237480400u, 0, 17, &be_const_str_pop);
...
be_define_const_str(RFRECV, "RFRECV", 354742801u, 0, 6, &be_const_str_log);
be_define_const_str(log, "log", 1062293841u, 0, 3, NULL);
be_define_const_str(format, "format", 3114108242u, 0, 6, &be_const_str_range);
...
be_define_const_str(PN532_TXD, "PN532_TXD", 3093418644u, 0, 9, &be_const_str_json_append);
be_define_const_str(json_append, "json_append", 3002019284u, 0, 11, &be_const_str_lv_draw_mask_map_param);
be_define_const_str(lv_draw_mask_map_param, "lv_draw_mask_map_param", 1666886804u, 0, 22, NULL);
be_define_const_str(SYMBOL_HOME, "SYMBOL_HOME", 730845525u, 0, 11, &be_const_str_TASMOTACLIENT_RST_INV);
be_define_const_str(TASMOTACLIENT_RST_INV, "TASMOTACLIENT_RST_INV", 2601785365u, 0, 21, &be_const_str_web_add_config_button);
be_define_const_str(web_add_config_button, "web_add_config_button", 639674325u, 0, 21, NULL);
be_define_const_str(SYMBOL_WARNING, "SYMBOL_WARNING", 4119913686u, 0, 14, &be_const_str_find_key_i);
...
be_define_const_str(SYMBOL_LOOP, "SYMBOL_LOOP", 2762053208u, 0, 11, &be_const_str_SYMBOL_RIGHT);
be_define_const_str(SYMBOL_RIGHT, "SYMBOL_RIGHT", 2984010648u, 0, 12, &be_const_str_false);
be_define_const_str(false, "false", 184981848u, 62, 5, NULL);
be_define_const_str(LE01MR_RX, "LE01MR_RX", 1521590809u, 0, 9, &be_const_str_WEBCAM_PCLK);
be_define_const_str(WEBCAM_PCLK, "WEBCAM_PCLK", 3813770649u, 0, 11, &be_const_str_lv_spinbox);
be_define_const_str(lv_spinbox, "lv_spinbox", 2666096729u, 0, 10, NULL);
be_define_const_str(SPI_MISO, "SPI_MISO", 150818010u, 0, 8, &be_const_str_geti);
be_define_const_str(geti, "geti", 2381006490u, 0, 4, NULL);
be_define_const_str(SM2135_CLK, "SM2135_CLK", 2383410011u, 0, 10, &be_const_str_lv_gauge);
...
be_define_const_str(SYMBOL_PAUSE, "SYMBOL_PAUSE", 641998172u, 0, 12, &be_const_str_time_str);
be_define_const_str(time_str, "time_str", 2613827612u, 0, 8, NULL);
be_define_const_str(ROT1B, "ROT1B", 809932573u, 0, 5, &be_const_str_SHELLY_DIMMER_RST_INV);
be_define_const_str(SHELLY_DIMMER_RST_INV, "SHELLY_DIMMER_RST_INV", 2366759773u, 0, 21, &be_const_str_lv_led);
...
be_define_const_str(lv_calendar, "lv_calendar", 3284396894u, 0, 11, &be_const_str_seti);
...
be_define_const_str(DDSU666_RX, "DDSU666_RX", 1812507936u, 0, 10, &be_const_str_TX2X_TXD_BLACK);
be_define_const_str(TX2X_TXD_BLACK, "TX2X_TXD_BLACK", 956526176u, 0, 14, &be_const_str_WEBCAM_PSCLK);
be_define_const_str(WEBCAM_PSCLK, "WEBCAM_PSCLK", 3150007456u, 0, 12, &be_const_str_find_op);
be_define_const_str(find_op, "find_op", 3766713376u, 0, 7, NULL);
be_define_const_str(IBEACON_TX, "IBEACON_TX", 3471826977u, 0, 10, NULL);
be_define_const_str(WS2812, "WS2812", 3539741218u, 0, 6, &be_const_str_isinstance);
be_define_const_str(isinstance, "isinstance", 3669352738u, 0, 10, NULL);
be_define_const_str(AZ_RXD, "AZ_RXD", 699914019u, 0, 6, &be_const_str_CSE7766_RX);
be_define_const_str(CSE7766_RX, "CSE7766_RX", 1546766819u, 0, 10, &be_const_str_SM16716_SEL);
be_define_const_str(SM16716_SEL, "SM16716_SEL", 142377379u, 0, 11, &be_const_str_cb_dispatch);
...
be_define_const_str(TELEINFO_ENABLE, "TELEINFO_ENABLE", 1600974501u, 0, 15, &be_const_str__available);
be_define_const_str(_available, "_available", 1306196581u, 0, 10, &be_const_str_true);
be_define_const_str(true, "true", 1303515621u, 61, 4, NULL);
be_define_const_str(CSE7761_TX, "CSE7761_TX", 3354719142u, 0, 10, &be_const_str_SYMBOL_BULLET);
be_define_const_str(SYMBOL_BULLET, "SYMBOL_BULLET", 587181862u, 0, 13, &be_const_str_SYMBOL_EDIT);
be_define_const_str(SYMBOL_EDIT, "SYMBOL_EDIT", 1396182822u, 0, 11, &be_const_str_name);
...
be_define_const_str(AudioOutputI2S, "AudioOutputI2S", 638031784u, 0, 14, &be_const_str_DDS2382_TX);
be_define_const_str(DDS2382_TX, "DDS2382_TX", 1438117864u, 0, 10, &be_const_str_WEBCAM_HREF);
be_define_const_str(WEBCAM_HREF, "WEBCAM_HREF", 3161890024u, 0, 11, &be_const_str_WEBCAM_HSD);
be_define_const_str(WEBCAM_HSD, "WEBCAM_HSD", 2648502504u, 0, 10, &be_const_str_attrdump);
be_define_const_str(attrdump, "attrdump", 1521571304u, 0, 8, NULL);
be_define_const_str(_write, "_write", 2215462825u, 0, 6, NULL);
be_define_const_str(PWM1, "PWM1", 1353352426u, 0, 4, &be_const_str_resp_cmnd);
...
be_define_const_str(IEM3000_TX, "IEM3000_TX", 1185907310u, 0, 10, &be_const_str_ZIGBEE_RX);
be_define_const_str(ZIGBEE_RX, "ZIGBEE_RX", 93215470u, 0, 9, &be_const_str_memory);
be_define_const_str(memory, "memory", 2229924270u, 0, 6, &be_const_str_pin_mode);
be_define_const_str(pin_mode, "pin_mode", 3258314030u, 0, 8, &be_const_str_register_button_encoder);
...
be_define_const_str(SWT1, "SWT1", 805224112u, 0, 4, &be_const_str_write_bytes);
...
be_define_const_str(SHELLY_DIMMER_BOOT0, "SHELLY_DIMMER_BOOT0", 2948777716u, 0, 19, &be_const_str_SPI_CS);
be_define_const_str(SPI_CS, "SPI_CS", 553701236u, 0, 6, &be_const_str__timers);
be_define_const_str(_timers, "_timers", 2600100916u, 0, 7, &be_const_str_lv_draw_line_dsc);
be_define_const_str(lv_draw_line_dsc, "lv_draw_line_dsc", 2422805236u, 0, 16, NULL);
be_define_const_str(LMT01, "LMT01", 2490623797u, 0, 5, &be_const_str_lv_draw_mask_map_param_cfg);
...
be_define_const_str(DCKI, "DCKI", 3846847480u, 0, 4, &be_const_str_break);
be_define_const_str(break, "break", 3378807160u, 58, 5, NULL);
be_define_const_str(SBR_RX, "SBR_RX", 3350999801u, 0, 6, &be_const_str_bus);
...
be_define_const_str(ARIRFRCV, "ARIRFRCV", 1120816444u, 0, 8, &be_const_str_WINDMETER_SPEED);
be_define_const_str(WINDMETER_SPEED, "WINDMETER_SPEED", 1980822204u, 0, 15, &be_const_str__request_from);
...
be_define_const_str(HALLEFFECT, "HALLEFFECT", 3334305407u, 0, 10, &be_const_str_MAX31855CLK);
be_define_const_str(MAX31855CLK, "MAX31855CLK", 715977727u, 0, 11, &be_const_str_MCP39F5_TX);
be_define_const_str(MCP39F5_TX, "MCP39F5_TX", 1332322047u, 0, 10, &be_const_str_REL1);
...
be_define_const_str(MAX31855DO, "MAX31855DO", 552730368u, 0, 10, &be_const_str_asstring);
be_define_const_str(asstring, "asstring", 1298225088u, 0, 8, &be_const_str_remove_rule);
be_define_const_str(remove_rule, "remove_rule", 3456211328u, 0, 11, NULL);
be_define_const_str(lv_gauge_format_cb, "lv_gauge_format_cb", 4073149249u, 0, 18, &be_const_str_seg7_font);
...
be_define_const_str(opt_neq, "!=", 2428715011u, 0, 2, &be_const_str_ILI9341_CS);
...
be_define_const_str(HM10_TX, "HM10_TX", 1522037252u, 0, 7, &be_const_str_lv_canvas);
be_define_const_str(lv_canvas, "lv_canvas", 142865412u, 0, 9, NULL);
be_define_const_str(AudioFileSourceFS, "AudioFileSourceFS", 1839147653u, 0, 17, &be_const_str_set_timer);
...
be_define_const_str(lv_indev, "lv_indev", 225602374u, 0, 8, &be_const_str_if);
be_define_const_str(if, "if", 959999494u, 50, 2, NULL);
be_define_const_str(KEY1, "KEY1", 6715975u, 0, 4, &be_const_str_OLED_RESET);
be_define_const_str(OLED_RESET, "OLED_RESET", 4048987655u, 0, 10, &be_const_str_SYMBOL_LEFT);
...
be_define_const_str(TFMINIPLUS_TX, "TFMINIPLUS_TX", 2527875337u, 0, 13, &be_const_str_open);
...
be_define_const_str(SYMBOL_FILE, "SYMBOL_FILE", 237085260u, 0, 11, &be_const_str_lv_table);
be_define_const_str(lv_table, "lv_table", 1675691020u, 0, 8, NULL);
be_define_const_str(LEDLNK, "LEDLNK", 2862810701u, 0, 6, &be_const_str_SYMBOL_PASTE);
be_define_const_str(SYMBOL_PASTE, "SYMBOL_PASTE", 2281577421u, 0, 12, &be_const_str_keys);
be_define_const_str(keys, "keys", 4182378701u, 0, 4, &be_const_str_lv_spinner);
be_define_const_str(lv_spinner, "lv_spinner", 3361501901u, 0, 10, &be_const_str_sin);
be_define_const_str(sin, "sin", 3761252941u, 0, 3, NULL);
be_define_const_str(SYMBOL_PLUS, "SYMBOL_PLUS", 2860093262u, 0, 11, &be_const_str_calldepth);
...
be_define_const_str(CC1101_GDO0, "CC1101_GDO0", 940611027u, 0, 11, &be_const_str_lv_page);
...
be_define_const_str(SR04_ECHO, "SR04_ECHO", 1906909592u, 0, 9, &be_const_str_lv_cont);
be_define_const_str(lv_cont, "lv_cont", 1391686552u, 0, 7, &be_const_str_setrange);
...
be_define_const_str(EPAPER29_CS, "EPAPER29_CS", 3916373594u, 0, 11, &be_const_str_ST7789_CS);
...
be_define_const_str(TXD, "TXD", 3614562079u, 0, 3, &be_const_str_add_cmd);
be_define_const_str(add_cmd, "add_cmd", 3361630879u, 0, 7, &be_const_str_event);
be_define_const_str(event, "event", 4264611999u, 0, 5, &be_const_str_lv_color);
be_define_const_str(lv_color, "lv_color", 1419148319u, 0, 8, NULL);
be_define_const_str(HM10_RX, "HM10_RX", 515085922u, 0, 7, &be_const_str__get_cb);
...
be_define_const_str(MAX7219CS, "MAX7219CS", 2593198244u, 0, 9, &be_const_str_SSPI_MAX31865_CS1);
be_define_const_str(SSPI_MAX31865_CS1, "SSPI_MAX31865_CS1", 1256578724u, 0, 17, &be_const_str_SYMBOL_SD_CARD);
...
be_define_const_str(PULLDOWN, "PULLDOWN", 1853074086u, 0, 8, &be_const_str_item);
be_define_const_str(item, "item", 2671260646u, 0, 4, NULL);
be_define_const_str(lv_img, "lv_img", 2474052327u, 0, 6, &be_const_str_setbits);
be_define_const_str(setbits, "setbits", 2762408167u, 0, 7, NULL);
be_define_const_str(dot_def, ".def", 4095748648u, 0, 4, &be_const_str_OUTPUT_LO);
be_define_const_str(OUTPUT_LO, "OUTPUT_LO", 3724620328u, 0, 9, &be_const_str_every_50ms);
be_define_const_str(every_50ms, "every_50ms", 2383884008u, 0, 10, &be_const_str_rad);
be_define_const_str(rad, "rad", 1358899048u, 0, 3, NULL);
be_define_const_str(RXD, "RXD", 2311579049u, 0, 3, &be_const_str_TCP_TX);
be_define_const_str(TCP_TX, "TCP_TX", 2762594089u, 0, 6, &be_const_str_load);
be_define_const_str(load, "load", 3859241449u, 0, 4, &be_const_str_lv_btnmatrix);
be_define_const_str(lv_btnmatrix, "lv_btnmatrix", 626248489u, 0, 12, NULL);
be_define_const_str(opt_add, "+", 772578730u, 0, 1, &be_const_str_HX711_DAT);
be_define_const_str(HX711_DAT, "HX711_DAT", 2935118250u, 0, 9, &be_const_str_read12);
...
be_define_const_str(DI, "DI", 1070498734u, 0, 2, &be_const_str_ETH_PHY_POWER);
be_define_const_str(ETH_PHY_POWER, "ETH_PHY_POWER", 487529454u, 0, 13, &be_const_str_SOLAXX1_RX);
be_define_const_str(SOLAXX1_RX, "SOLAXX1_RX", 971867054u, 0, 10, &be_const_str_yield);
...
be_define_const_str(allocated, "allocated", 429986098u, 0, 9, &be_const_str_web_add_button);
be_define_const_str(web_add_button, "web_add_button", 3537875058u, 0, 14, NULL);
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_lv_draw_mask_radius_param);
be_define_const_str(lv_draw_mask_radius_param, "lv_draw_mask_radius_param", 3777679220u, 0, 25, NULL);
be_define_const_str(CSE7766_TX, "CSE7766_TX", 674624821u, 0, 10, &be_const_str_TM1637DIO);
be_define_const_str(TM1637DIO, "TM1637DIO", 1574659381u, 0, 9, &be_const_str_WEBCAM_DATA);
be_define_const_str(WEBCAM_DATA, "WEBCAM_DATA", 1476954421u, 0, 11, &be_const_str_ZIGBEE_RST);
be_define_const_str(ZIGBEE_RST, "ZIGBEE_RST", 721588661u, 0, 10, &be_const_str_lv_dropdown);
be_define_const_str(lv_dropdown, "lv_dropdown", 2797165301u, 0, 11, NULL);
be_define_const_str(lv_design_cb, "lv_design_cb", 3822640502u, 0, 12, &be_const_str_remove_cmd);
be_define_const_str(remove_cmd, "remove_cmd", 3832315702u, 0, 10, NULL);
be_define_const_str(SYMBOL_WIFI, "SYMBOL_WIFI", 682141303u, 0, 11, &be_const_str_ctypes_bytes);
be_define_const_str(ctypes_bytes, "ctypes_bytes", 3879019703u, 0, 12, NULL);
be_define_const_str(KEY1_INV_PD, "KEY1_INV_PD", 3828014584u, 0, 11, &be_const_str_SSPI_DC);
be_define_const_str(SSPI_DC, "SSPI_DC", 1782271864u, 0, 7, &be_const_str_imin);
be_define_const_str(imin, "imin", 2714127864u, 0, 4, NULL);
be_define_const_str(CC1101_GDO2, "CC1101_GDO2", 974166265u, 0, 11, &be_const_str_SYMBOL_BATTERY_FULL);
...
be_define_const_str(remove, "remove", 3683784189u, 0, 6, &be_const_str_toint);
...
be_define_const_str(TCP_RX, "TCP_RX", 3904354751u, 0, 6, &be_const_str_content_stop);
be_define_const_str(content_stop, "content_stop", 658554751u, 0, 12, &be_const_str_gc);
...
be_define_const_str(MAX7219CLK, "MAX7219CLK", 963568838u, 0, 10, &be_const_str_lv_win);
be_define_const_str(lv_win, "lv_win", 780927558u, 0, 6, NULL);
be_define_const_str(I2S_IN_CLK, "I2S_IN_CLK", 2996930120u, 0, 10, &be_const_str_ceil);
be_define_const_str(ceil, "ceil", 1659167240u, 0, 4, NULL);
be_define_const_str(WEBCAM_SIOD, "WEBCAM_SIOD", 302703242u, 0, 11, NULL);
be_define_const_str(ARIRFSEL, "ARIRFSEL", 233874443u, 0, 8, &be_const_str_SM16716_CLK);
be_define_const_str(SM16716_CLK, "SM16716_CLK", 3037641483u, 0, 11, &be_const_str_SYMBOL_MUTE);
be_define_const_str(SYMBOL_MUTE, "SYMBOL_MUTE", 563116043u, 0, 11, NULL);
be_define_const_str(HX711_SCK, "HX711_SCK", 3785979404u, 0, 9, &be_const_str_lv_draw_mask_fade_param);
be_define_const_str(lv_draw_mask_fade_param, "lv_draw_mask_fade_param", 2743309964u, 0, 23, NULL);
be_define_const_str(opt_connect, "..", 2748622605u, 0, 2, &be_const_str_DYP_RX);
be_define_const_str(DYP_RX, "DYP_RX", 2122310285u, 0, 6, &be_const_str_resolvecmnd);
...
be_define_const_str(CNTR1_NP, "CNTR1_NP", 4288381648u, 0, 8, &be_const_str_CSE7761_RX);
be_define_const_str(CSE7761_RX, "CSE7761_RX", 65423248u, 0, 10, &be_const_str_ETH_PHY_MDIO);
be_define_const_str(ETH_PHY_MDIO, "ETH_PHY_MDIO", 3261871568u, 0, 12, &be_const_str_SYMBOL_TRASH);
be_define_const_str(SYMBOL_TRASH, "SYMBOL_TRASH", 3169100368u, 0, 12, &be_const_str_check_privileged_access);
be_define_const_str(check_privileged_access, "check_privileged_access", 3692933968u, 0, 23, &be_const_str_lv_btn);
be_define_const_str(lv_btn, "lv_btn", 1612829968u, 0, 6, &be_const_str_lv_list);
be_define_const_str(lv_list, "lv_list", 2876551248u, 0, 7, NULL);
be_define_const_str(A4988_STP, "A4988_STP", 1622172049u, 0, 9, &be_const_str_content_send);
...
be_define_const_str(MCP39F5_RST, "MCP39F5_RST", 3657125652u, 0, 11, &be_const_str_pin_used);
...
be_define_const_str(lv_draw_mask_radius_param_cfg, "lv_draw_mask_radius_param_cfg", 3889386773u, 0, 29, &be_const_str_pow);
be_define_const_str(pow, "pow", 1479764693u, 0, 3, NULL);
be_define_const_str(AS608_TX, "AS608_TX", 48630934u, 0, 8, &be_const_str_PZEM017_RX);
be_define_const_str(PZEM017_RX, "PZEM017_RX", 3227495894u, 0, 10, &be_const_str_SPI_CLK);
be_define_const_str(SPI_CLK, "SPI_CLK", 3943233814u, 0, 7, &be_const_str_scale_uint);
be_define_const_str(scale_uint, "scale_uint", 3090811094u, 0, 10, NULL);
be_define_const_str(PZEM016_RX, "PZEM016_RX", 1004012055u, 0, 10, &be_const_str_SYMBOL_COPY);
be_define_const_str(SYMBOL_COPY, "SYMBOL_COPY", 4193681815u, 0, 11, &be_const_str_SYMBOL_SAVE);
...
be_define_const_str(IEM3000_RX, "IEM3000_RX", 1117811096u, 0, 10, &be_const_str_ZIGBEE_TX);
be_define_const_str(ZIGBEE_TX, "ZIGBEE_TX", 25119256u, 0, 9, &be_const_str_toupper);
...
be_define_const_str(BL0940_RX, "BL0940_RX", 2908993179u, 0, 9, &be_const_str_NONE);
be_define_const_str(NONE, "NONE", 1932136219u, 0, 4, &be_const_str_SSD1331_DC);
be_define_const_str(SSD1331_DC, "SSD1331_DC", 3386560859u, 0, 10, &be_const_str_SWT1_NP);
be_define_const_str(SWT1_NP, "SWT1_NP", 4033043739u, 0, 7, &be_const_str_digital_write);
...
be_define_const_str(GPS_RX, "GPS_RX", 1075637342u, 0, 6, &be_const_str_PN532_RXD);
be_define_const_str(PN532_RXD, "PN532_RXD", 1780093022u, 0, 9, &be_const_str_SM2135_DAT);
be_define_const_str(SM2135_DAT, "SM2135_DAT", 2882726942u, 0, 10, &be_const_str_int);
be_define_const_str(int, "int", 2515107422u, 0, 3, NULL);
be_define_const_str(SDS0X1_TX, "SDS0X1_TX", 165045983u, 0, 9, &be_const_str_SR04_TRIG);
be_define_const_str(SR04_TRIG, "SR04_TRIG", 68671263u, 0, 9, &be_const_str_SYMBOL_BATTERY_1);
be_define_const_str(SYMBOL_BATTERY_1, "SYMBOL_BATTERY_1", 629036063u, 0, 16, &be_const_str_byte);
...
be_define_const_str(LOW, "LOW", 3526092385u, 0, 3, &be_const_str_lv_objmask);
...
be_define_const_str(AZ_TXD, "AZ_TXD", 850268709u, 0, 6, &be_const_str_SDM630_RX);
...
be_define_const_str(PWM1_INV, "PWM1_INV", 3939021030u, 0, 8, &be_const_str___lower__);
...
be_define_const_str(SYMBOL_UP, "SYMBOL_UP", 3886401511u, 0, 9, &be_const_str_arg);
be_define_const_str(arg, "arg", 1047474471u, 0, 3, NULL);
be_define_const_str(SYMBOL_USB, "SYMBOL_USB", 1962656552u, 0, 10, &be_const_str_deinit);
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, &be_const_str_load_freetype_font);
be_define_const_str(load_freetype_font, "load_freetype_font", 2368447592u, 0, 18, NULL);
be_define_const_str(SDM120_RX, "SDM120_RX", 1367571753u, 0, 9, &be_const_str_SWT1_PD);
be_define_const_str(SWT1_PD, "SWT1_PD", 4166278953u, 0, 7, &be_const_str_lv_cb);
...
be_define_const_str(SYMBOL_NEW_LINE, "SYMBOL_NEW_LINE", 2014334315u, 0, 15, &be_const_str_content_flush);
be_define_const_str(content_flush, "content_flush", 214922475u, 0, 13, NULL);
be_define_const_str(TELEINFO_RX, "TELEINFO_RX", 1195717356u, 0, 11, &be_const_str_get_light);
be_define_const_str(get_light, "get_light", 381930476u, 0, 9, &be_const_str_lv_group_focus_cb);
...
be_define_const_str(OPTION_A, "OPTION_A", 1133299440u, 0, 8, &be_const_str_log10);
...
be_define_const_str(SYMBOL_BATTERY_2, "SYMBOL_BATTERY_2", 645813682u, 0, 16, &be_const_str_SYMBOL_STOP);
be_define_const_str(SYMBOL_STOP, "SYMBOL_STOP", 2836505202u, 0, 11, &be_const_str_lv_draw_label_dsc);
be_define_const_str(lv_draw_label_dsc, "lv_draw_label_dsc", 265601842u, 0, 17, &be_const_str_pi);
...
be_define_const_str(count, "count", 967958004u, 0, 5, &be_const_str_lv_signal_cb);
...
be_define_const_str(HRXL_RX, "HRXL_RX", 92702006u, 0, 7, &be_const_str_SYMBOL_CLOSE);
be_define_const_str(SYMBOL_CLOSE, "SYMBOL_CLOSE", 2654402806u, 0, 12, &be_const_str_WEBCAM_VSYNC);
be_define_const_str(WEBCAM_VSYNC, "WEBCAM_VSYNC", 4032882166u, 0, 12, &be_const_str_lv_label);
...
be_define_const_str(AudioGeneratorMP3, "AudioGeneratorMP3", 2199818488u, 0, 17, &be_const_str_SSD1331_CS);
be_define_const_str(SSD1331_CS, "SSD1331_CS", 4191047928u, 0, 10, &be_const_str__buffer);
...
be_define_const_str(SYMBOL_DOWNLOAD, "SYMBOL_DOWNLOAD", 2607324090u, 0, 15, &be_const_str_lower);
...
be_define_const_str(MGC3130_XFER, "MGC3130_XFER", 4178219131u, 0, 12, &be_const_str_assert);
be_define_const_str(assert, "assert", 2774883451u, 0, 6, NULL);
be_define_const_str(ADC_JOY, "ADC_JOY", 1116943612u, 0, 7, &be_const_str_SYMBOL_BLUETOOTH);
...
be_define_const_str(I2S_IN_DATA, "I2S_IN_DATA", 4125971460u, 0, 11, &be_const_str_OUTPUT);
be_define_const_str(OUTPUT, "OUTPUT", 1469629700u, 0, 6, &be_const_str_RF_SENSOR);
be_define_const_str(RF_SENSOR, "RF_SENSOR", 2289628100u, 0, 9, &be_const_str_bytes);
...
be_define_const_str(, "", 2166136261u, 0, 0, &be_const_str_SYMBOL_BATTERY_3);
be_define_const_str(SYMBOL_BATTERY_3, "SYMBOL_BATTERY_3", 662591301u, 0, 16, &be_const_str_i2c_enabled);
...
be_define_const_str(I2C_SDA, "I2C_SDA", 1052592262u, 0, 7, &be_const_str_OUTPUT_HI);
...
be_define_const_str(ADC_RANGE, "ADC_RANGE", 3467329543u, 0, 9, &be_const_str_BOILER_OT_TX);
be_define_const_str(BOILER_OT_TX, "BOILER_OT_TX", 671743623u, 0, 12, &be_const_str_add_rule);
...
be_define_const_str(SDS0X1_RX, "SDS0X1_RX", 1170717385u, 0, 9, &be_const_str_every_second);
be_define_const_str(every_second, "every_second", 2075451465u, 0, 12, &be_const_str_lv_draw_mask_line_param_cfg);
...
be_define_const_str(content_start, "content_start", 2937509069u, 0, 13, &be_const_str_lv_bar);
be_define_const_str(lv_bar, "lv_bar", 1582673229u, 0, 6, &be_const_str_lv_imgbtn);
be_define_const_str(lv_imgbtn, "lv_imgbtn", 2402844429u, 0, 9, &be_const_str_traceback);
...
be_define_const_str(SYMBOL_BATTERY_EMPTY, "SYMBOL_BATTERY_EMPTY", 3945064277u, 0, 20, &be_const_str_display);
...
be_define_const_str(P9813_CLK, "P9813_CLK", 2455391001u, 0, 9, &be_const_str_lv_draw_mask_angle_param);
...
be_define_const_str(OPEN_DRAIN, "OPEN_DRAIN", 677872608u, 0, 10, &be_const_str_digital_read);
...
be_define_const_str(ADC_BUTTON, "ADC_BUTTON", 3393454690u, 0, 10, &be_const_str_SYMBOL_DOWN);
be_define_const_str(SYMBOL_DOWN, "SYMBOL_DOWN", 1107513570u, 0, 11, NULL);
be_define_const_str(A4988_MS1, "A4988_MS1", 1729976611u, 0, 9, &be_const_str_close);
be_define_const_str(close, "close", 667630371u, 0, 5, &be_const_str_lv_cpicker);
be_define_const_str(lv_cpicker, "lv_cpicker", 1935129251u, 0, 10, &be_const_str_split);
be_define_const_str(split, "split", 2276994531u, 0, 5, NULL);
be_define_const_str(exec_rules, "exec_rules", 1445221092u, 0, 10, NULL);
be_define_const_str(I2S_OUT_DATA, "I2S_OUT_DATA", 1176288293u, 0, 12, &be_const_str_SSPI_MISO);
be_define_const_str(SSPI_MISO, "SSPI_MISO", 2485347173u, 0, 9, &be_const_str__ccmd);
be_define_const_str(_ccmd, "_ccmd", 2163421413u, 0, 5, &be_const_str_lv_tileview);
...
be_define_const_str(LED1_INV, "LED1_INV", 2112045097u, 0, 8, &be_const_str_MCP39F5_RX);
be_define_const_str(MCP39F5_RX, "MCP39F5_RX", 190458217u, 0, 10, NULL);
be_define_const_str(SYMBOL_DUMMY, "SYMBOL_DUMMY", 3621732138u, 0, 12, &be_const_str_save_before_restart);
...
be_define_const_str(get_tasmota, "get_tasmota", 334356779u, 0, 11, &be_const_str_loop);
be_define_const_str(loop, "loop", 3723446379u, 0, 4, &be_const_str_lv_group);
...
be_define_const_str(DHT22, "DHT22", 215937903u, 0, 5, &be_const_str_LE01MR_TX);
be_define_const_str(LE01MR_TX, "LE01MR_TX", 1589687023u, 0, 9, &be_const_str_SYMBOL_PREV);
be_define_const_str(SYMBOL_PREV, "SYMBOL_PREV", 2952615023u, 0, 11, NULL);
be_define_const_str(INTERRUPT, "INTERRUPT", 3809502704u, 0, 9, &be_const_str_lv_draw_mask_line_param);
be_define_const_str(lv_draw_mask_line_param, "lv_draw_mask_line_param", 2692990704u, 0, 23, &be_const_str_lv_roller);
...
be_define_const_str(AS3935, "AS3935", 603621745u, 0, 6, &be_const_str_ST7789_DC);
be_define_const_str(ST7789_DC, "ST7789_DC", 2533509745u, 0, 9, &be_const_str_ZEROCROSS);
be_define_const_str(ZEROCROSS, "ZEROCROSS", 1747596785u, 0, 9, &be_const_str_collect);
be_define_const_str(collect, "collect", 2399039025u, 0, 7, NULL);
be_define_const_str(DEEPSLEEP, "DEEPSLEEP", 189922226u, 0, 9, &be_const_str_codedump);
...
be_define_const_str(KEY1_TC, "KEY1_TC", 25685109u, 0, 7, &be_const_str_lv_keyboard);
be_define_const_str(lv_keyboard, "lv_keyboard", 197530229u, 0, 11, NULL);
be_define_const_str(DDSU666_TX, "DDSU666_TX", 1880604150u, 0, 10, &be_const_str_gamma8);
...
be_define_const_str(I2S_IN_SLCT, "I2S_IN_SLCT", 706051516u, 0, 11, &be_const_str_SYMBOL_EYE_OPEN);
be_define_const_str(SYMBOL_EYE_OPEN, "SYMBOL_EYE_OPEN", 3449311676u, 0, 15, &be_const_str_eth);
...
be_define_const_str(concat, "concat", 4124019837u, 0, 6, &be_const_str_get_free_heap);
be_define_const_str(get_free_heap, "get_free_heap", 625069757u, 0, 13, &be_const_str_lv_draw_mask_fade_param_cfg);
...
be_define_const_str(issubclass, "issubclass", 4078395519u, 0, 10, &be_const_str_class);
