...
be_define_const_str(LE01MR_TX, "LE01MR_TX", 1589687023u, 0, 9, &be_const_str_SYMBOL_BATTERY_2);
...
be_define_const_str(OUTPUT_HI, "OUTPUT_HI", 3153592902u, 0, 9, &be_const_str_lv_checkbox);
...
be_define_const_str(content_send, "content_send", 1673733649u, 0, 12, &be_const_str_lv_btn);
be_define_const_str(lv_btn, "lv_btn", 1612829968u, 0, 6, &be_const_str_while);
be_define_const_str(while, "while", 231090382u, 53, 5, NULL);
be_define_const_str(SYMBOL_BATTERY_FULL, "SYMBOL_BATTERY_FULL", 2638935545u, 0, 19, &be_const_str_clear);
be_define_const_str(clear, "clear", 1550717474u, 0, 5, NULL);
be_define_const_str(lv_img, "lv_img", 2474052327u, 0, 6, &be_const_str_pin);
...
be_define_const_str(lv_obj, "lv_obj", 4257833149u, 0, 6, &be_const_str_try);
...
be_define_const_str(SYMBOL_NEW_LINE, "SYMBOL_NEW_LINE", 2014334315u, 0, 15, &be_const_str_find_key_i);
be_define_const_str(find_key_i, "find_key_i", 850136726u, 0, 10, NULL);
be_define_const_str(SYMBOL_BATTERY_3, "SYMBOL_BATTERY_3", 662591301u, 0, 16, &be_const_str_event);
...
be_define_const_str(KEY1_INV_NP, "KEY1_INV_NP", 3160558586u, 0, 11, &be_const_str_SYMBOL_GPS);
be_define_const_str(SYMBOL_GPS, "SYMBOL_GPS", 3044165570u, 0, 10, &be_const_str_dump);
be_define_const_str(dump, "dump", 3663001223u, 0, 4, &be_const_str_register_button_encoder);
...
be_define_const_str(SYMBOL_BULLET, "SYMBOL_BULLET", 587181862u, 0, 13, &be_const_str_WEBCAM_SIOC);
...
be_define_const_str(char, "char", 2823553821u, 0, 4, &be_const_str_web_add_management_button);
be_define_const_str(web_add_management_button, "web_add_management_button", 2738877186u, 0, 25, NULL);
be_define_const_str(SHELLY_DIMMER_RST_INV, "SHELLY_DIMMER_RST_INV", 2366759773u, 0, 21, &be_const_str_SYMBOL_IMAGE);
...
be_define_const_str(SYMBOL_EDIT, "SYMBOL_EDIT", 1396182822u, 0, 11, &be_const_str_floor);
...
be_define_const_str(SYMBOL_RIGHT, "SYMBOL_RIGHT", 2984010648u, 0, 12, &be_const_str__cmd);
...
be_define_const_str(SDCARD_CS, "SDCARD_CS", 3348952003u, 0, 9, &be_const_str_SYMBOL_CLOSE);
...
be_define_const_str(OPEN_DRAIN, "OPEN_DRAIN", 677872608u, 0, 10, &be_const_str_lv_font);
...
be_define_const_str(SM2135_DAT, "SM2135_DAT", 2882726942u, 0, 10, &be_const_str_lv_chart);
be_define_const_str(lv_chart, "lv_chart", 2652494144u, 0, 8, &be_const_str_var);
be_define_const_str(var, "var", 2317739966u, 64, 3, NULL);
be_define_const_str(WINDMETER_SPEED, "WINDMETER_SPEED", 1980822204u, 0, 15, &be_const_str_lv_switch);
be_define_const_str(lv_switch, "lv_switch", 3407171508u, 0, 9, &be_const_str_seg7_font);
be_define_const_str(seg7_font, "seg7_font", 4099690689u, 0, 9, &be_const_str_raise);
...
be_define_const_str(cb_dispatch, "cb_dispatch", 1741510499u, 0, 11, &be_const_str_load_freetype_font);
...
be_define_const_str(MAX7219CS, "MAX7219CS", 2593198244u, 0, 9, &be_const_str_button_pressed);
be_define_const_str(button_pressed, "button_pressed", 1694209616u, 0, 14, &be_const_str_write);
...
be_define_const_str(TASMOTACLIENT_RST_INV, "TASMOTACLIENT_RST_INV", 2601785365u, 0, 21, &be_const_str_rad);
...
be_define_const_str(SSD1331_DC, "SSD1331_DC", 3386560859u, 0, 10, &be_const_str_SYMBOL_PLUS);
...
be_define_const_str(SYMBOL_WIFI, "SYMBOL_WIFI", 682141303u, 0, 11, &be_const_str_add_rule);
...
be_define_const_str(ADC_JOY, "ADC_JOY", 1116943612u, 0, 7, &be_const_str_WEBCAM_XCLK);
...
be_define_const_str(MHZ_TXD, "MHZ_TXD", 3310158233u, 0, 7, &be_const_str_range);
...
be_define_const_str(lv_slider, "lv_slider", 2274180781u, 0, 9, &be_const_str_lv_tileview);
...
be_define_const_str(SBR_RX, "SBR_RX", 3350999801u, 0, 6, &be_const_str_SYMBOL_USB);
be_define_const_str(SYMBOL_USB, "SYMBOL_USB", 1962656552u, 0, 10, &be_const_str_ZEROCROSS);
...
be_define_const_str(PZEM016_RX, "PZEM016_RX", 1004012055u, 0, 10, &be_const_str_web_add_button);
...
be_define_const_str(GPS_RX, "GPS_RX", 1075637342u, 0, 6, &be_const_str_web_add_console_button);
be_define_const_str(web_add_console_button, "web_add_console_button", 3481436192u, 0, 22, NULL);
be_define_const_str(lv_calendar, "lv_calendar", 3284396894u, 0, 11, &be_const_str_sinh);
be_define_const_str(sinh, "sinh", 282220607u, 0, 4, NULL);
be_define_const_str(else, "else", 3183434736u, 52, 4, NULL);
be_define_const_str(SYMBOL_TRASH, "SYMBOL_TRASH", 3169100368u, 0, 12, &be_const_str_set_timer);
...
be_define_const_str(SYMBOL_PAUSE, "SYMBOL_PAUSE", 641998172u, 0, 12, &be_const_str_digital_read);
be_define_const_str(digital_read, "digital_read", 3585496928u, 0, 12, &be_const_str_start);
...
be_define_const_str(Driver, "Driver", 3576386303u, 0, 6, &be_const_str_NRG_SEL_INV);
be_define_const_str(NRG_SEL_INV, "NRG_SEL_INV", 3567431069u, 0, 11, &be_const_str_SYMBOL_CHARGE);
be_define_const_str(SYMBOL_CHARGE, "SYMBOL_CHARGE", 2106391946u, 0, 13, &be_const_str_on);
...
be_define_const_str(DDS2382_RX, "DDS2382_RX", 432446462u, 0, 10, &be_const_str_SYMBOL_LIST);
...
be_define_const_str(SOLAXX1_RX, "SOLAXX1_RX", 971867054u, 0, 10, &be_const_str_SYMBOL_SHUFFLE);
be_define_const_str(SYMBOL_SHUFFLE, "SYMBOL_SHUFFLE", 1123310147u, 0, 14, &be_const_str_WEBCAM_SIOD);
...
be_define_const_str(BOILER_OT_TX, "BOILER_OT_TX", 671743623u, 0, 12, &be_const_str_SYMBOL_DIRECTORY);
...
be_define_const_str(get_option, "get_option", 2123730033u, 0, 10, &be_const_str_lv_imgbtn);
...
be_define_const_str(GPS_TX, "GPS_TX", 4228740808u, 0, 6, &be_const_str_lv_style);
...
be_define_const_str(attrdump, "attrdump", 1521571304u, 0, 8, &be_const_str_get_tasmota);
be_define_const_str(get_tasmota, "get_tasmota", 334356779u, 0, 11, &be_const_str_continue);
...
be_define_const_str(LE01MR_RX, "LE01MR_RX", 1521590809u, 0, 9, &be_const_str_SYMBOL_BLUETOOTH);
be_define_const_str(SYMBOL_BLUETOOTH, "SYMBOL_BLUETOOTH", 679376572u, 0, 16, NULL);
be_define_const_str(keys, "keys", 4182378701u, 0, 4, &be_const_str_lv_msgbox);
...
be_define_const_str(NRG_CF1, "NRG_CF1", 3292534757u, 0, 7, &be_const_str_lv_spinbox);
be_define_const_str(lv_spinbox, "lv_spinbox", 2666096729u, 0, 10, &be_const_str_pin_mode);
be_define_const_str(pin_mode, "pin_mode", 3258314030u, 0, 8, NULL);
be_define_const_str(list, "list", 217798785u, 0, 4, &be_const_str_lv_canvas);
be_define_const_str(lv_canvas, "lv_canvas", 142865412u, 0, 9, NULL);
be_define_const_str(get, "get", 1410115415u, 0, 3, NULL);
be_define_const_str(LEDLNK_INV, "LEDLNK_INV", 3559015101u, 0, 10, &be_const_str_read);
...
be_define_const_str(PMS5003_RX, "PMS5003_RX", 3934985650u, 0, 10, &be_const_str_WEBCAM_HREF);
...
be_define_const_str(LEDLNK, "LEDLNK", 2862810701u, 0, 6, &be_const_str_SYMBOL_OK);
...
be_define_const_str(chars_in_string, "chars_in_string", 3148785132u, 0, 15, &be_const_str_lv_linemeter);
be_define_const_str(lv_linemeter, "lv_linemeter", 1413069363u, 0, 12, NULL);
be_define_const_str(SYMBOL_CUT, "SYMBOL_CUT", 3455112394u, 0, 10, &be_const_str_ZIGBEE_TX);
...
be_define_const_str(json_append, "json_append", 3002019284u, 0, 11, &be_const_str_time_dump);
...
be_define_const_str(SYMBOL_KEYBOARD, "SYMBOL_KEYBOARD", 1621492879u, 0, 15, &be_const_str_TCP_TX);
be_define_const_str(TCP_TX, "TCP_TX", 2762594089u, 0, 6, &be_const_str_montserrat_font);
...
be_define_const_str(SYMBOL_NEXT, "SYMBOL_NEXT", 1102844455u, 0, 11, &be_const_str_TM1638CLK);
be_define_const_str(TM1638CLK, "TM1638CLK", 3045182446u, 0, 9, &be_const_str_lv_group);
be_define_const_str(lv_group, "lv_group", 3852039019u, 0, 8, &be_const_str_import);
...
be_define_const_str(BS814_CLK, "BS814_CLK", 3002713336u, 0, 9, &be_const_str_SYMBOL_CALL);
be_define_const_str(SYMBOL_CALL, "SYMBOL_CALL", 1444504366u, 0, 11, &be_const_str_TXD);
be_define_const_str(TXD, "TXD", 3614562079u, 0, 3, NULL);
be_define_const_str(TX2X_TXD_BLACK, "TX2X_TXD_BLACK", 956526176u, 0, 14, NULL);
be_define_const_str(MIEL_HVAC_TX, "MIEL_HVAC_TX", 567403014u, 0, 12, &be_const_str_SYMBOL_EYE_CLOSE);
be_define_const_str(SYMBOL_EYE_CLOSE, "SYMBOL_EYE_CLOSE", 404721792u, 0, 16, &be_const_str_TASMOTACLIENT_RST);
be_define_const_str(TASMOTACLIENT_RST, "TASMOTACLIENT_RST", 3326196213u, 0, 17, NULL);
be_define_const_str(I2C_SDA, "I2C_SDA", 1052592262u, 0, 7, &be_const_str_lv_roller);
be_define_const_str(lv_roller, "lv_roller", 661902064u, 0, 9, NULL);
be_define_const_str(SM16716_DAT, "SM16716_DAT", 1905621806u, 0, 11, &be_const_str_elif);
...
be_define_const_str(SYMBOL_DOWN, "SYMBOL_DOWN", 1107513570u, 0, 11, &be_const_str_SYMBOL_STOP);
be_define_const_str(SYMBOL_STOP, "SYMBOL_STOP", 2836505202u, 0, 11, &be_const_str_web_add_config_button);
...
be_define_const_str(HM10_TX, "HM10_TX", 1522037252u, 0, 7, &be_const_str_hex);
...
be_define_const_str(MCP39F5_RX, "MCP39F5_RX", 190458217u, 0, 10, &be_const_str_TASMOTACLIENT_RXD);
be_define_const_str(TASMOTACLIENT_RXD, "TASMOTACLIENT_RXD", 72868318u, 0, 17, &be_const_str_screenshot);
be_define_const_str(screenshot, "screenshot", 3894592561u, 0, 10, NULL);
be_define_const_str(HRXL_RX, "HRXL_RX", 92702006u, 0, 7, NULL);
be_define_const_str(AZ_TXD, "AZ_TXD", 850268709u, 0, 6, &be_const_str_SYMBOL_DOWNLOAD);
be_define_const_str(SYMBOL_DOWNLOAD, "SYMBOL_DOWNLOAD", 2607324090u, 0, 15, &be_const_str_asstring);
be_define_const_str(asstring, "asstring", 1298225088u, 0, 8, &be_const_str_lv_page);
be_define_const_str(lv_page, "lv_page", 2373170067u, 0, 7, NULL);
be_define_const_str(BUZZER, "BUZZER", 1550039611u, 0, 6, &be_const_str_SYMBOL_VOLUME_MAX);
be_define_const_str(SYMBOL_VOLUME_MAX, "SYMBOL_VOLUME_MAX", 3582646093u, 0, 17, &be_const_str_WEBCAM_VSYNC);
...
be_define_const_str(AS608_TX, "AS608_TX", 48630934u, 0, 8, &be_const_str_SSD1351_DC);
...
be_define_const_str(RXD, "RXD", 2311579049u, 0, 3, &be_const_str_SYMBOL_BACKSPACE);
be_define_const_str(SYMBOL_BACKSPACE, "SYMBOL_BACKSPACE", 1997168681u, 0, 16, &be_const_str_try_rule);
be_define_const_str(try_rule, "try_rule", 1986449405u, 0, 8, NULL);
be_define_const_str(PN532_TXD, "PN532_TXD", 3093418644u, 0, 9, &be_const_str_every_second);
be_define_const_str(every_second, "every_second", 2075451465u, 0, 12, &be_const_str_lv_bar);
...
be_define_const_str(load_font, "load_font", 1875840019u, 0, 9, &be_const_str_rtc);
be_define_const_str(rtc, "rtc", 1070575216u, 0, 3, NULL);
be_define_const_str(TCP_RX, "TCP_RX", 3904354751u, 0, 6, &be_const_str_ceil);
be_define_const_str(ceil, "ceil", 1659167240u, 0, 4, &be_const_str_lv_gauge);
...
be_define_const_str(IRSEND, "IRSEND", 184848336u, 0, 6, &be_const_str_SYMBOL_HOME);
be_define_const_str(SYMBOL_HOME, "SYMBOL_HOME", 730845525u, 0, 11, &be_const_str_VL53L0X_XSHUT1);
...
be_define_const_str(ROT1A_NP, "ROT1A_NP", 2322706903u, 0, 8, &be_const_str_SPI_CLK);
be_define_const_str(SPI_CLK, "SPI_CLK", 3943233814u, 0, 7, &be_const_str_SSD1351_CS);
be_define_const_str(SSD1351_CS, "SSD1351_CS", 488746042u, 0, 10, &be_const_str_lv_btnmatrix);
be_define_const_str(lv_btnmatrix, "lv_btnmatrix", 626248489u, 0, 12, &be_const_str_set);
...
be_define_const_str(DEEPSLEEP, "DEEPSLEEP", 189922226u, 0, 9, &be_const_str_lv_cpicker);
be_define_const_str(lv_cpicker, "lv_cpicker", 1935129251u, 0, 10, NULL);
be_define_const_str(pop, "pop", 1362321360u, 0, 3, NULL);
be_define_const_str(NRF24_CS, "NRF24_CS", 555833194u, 0, 8, &be_const_str_SYMBOL_PLAY);
be_define_const_str(SYMBOL_PLAY, "SYMBOL_PLAY", 1750902100u, 0, 11, NULL);
be_define_const_str(MD5, "MD5", 1935726387u, 0, 3, &be_const_str_gen_cb);
be_define_const_str(gen_cb, "gen_cb", 3245227551u, 0, 6, &be_const_str_init);
be_define_const_str(init, "init", 380752755u, 0, 4, &be_const_str_lv_line);
...
be_define_const_str(HM10_RX, "HM10_RX", 515085922u, 0, 7, &be_const_str_SYMBOL_COPY);
...
be_define_const_str(SHELLY_DIMMER_BOOT0, "SHELLY_DIMMER_BOOT0", 2948777716u, 0, 19, &be_const_str_resp_cmnd_error);
...
be_define_const_str(lv_textarea, "lv_textarea", 2864635074u, 0, 11, &be_const_str_toupper);
...
be_define_const_str(A4988_DIR, "A4988_DIR", 2223595843u, 0, 9, &be_const_str_SI7021);
...
be_define_const_str(real, "real", 3604983901u, 0, 4, &be_const_str_traceback);
...
be_define_const_str(SWT1_NP, "SWT1_NP", 4033043739u, 0, 7, &be_const_str_lv_list);
...
be_define_const_str(_ccmd, "_ccmd", 2163421413u, 0, 5, &be_const_str_number);
...
be_define_const_str(A4988_ENA, "A4988_ENA", 1517502682u, 0, 9, &be_const_str_item);
...
be_define_const_str(gamma8, "gamma8", 3802843830u, 0, 6, &be_const_str_lv_tabview);
be_define_const_str(lv_tabview, "lv_tabview", 2109024786u, 0, 10, &be_const_str_lv_win);
be_define_const_str(lv_win, "lv_win", 780927558u, 0, 6, &be_const_str_millis);
...
be_define_const_str(SYMBOL_AUDIO, "SYMBOL_AUDIO", 3056537956u, 0, 12, &be_const_str_top);
...
be_define_const_str(WEBCAM_PSCLK, "WEBCAM_PSCLK", 3150007456u, 0, 12, &be_const_str_lv_indev);
be_define_const_str(lv_indev, "lv_indev", 225602374u, 0, 8, NULL);
be_define_const_str(CSE7766_RX, "CSE7766_RX", 1546766819u, 0, 10, &be_const_str_format);
be_define_const_str(format, "format", 3114108242u, 0, 6, &be_const_str_lv_dropdown);
be_define_const_str(lv_dropdown, "lv_dropdown", 2797165301u, 0, 11, &be_const_str_push);
be_define_const_str(push, "push", 2272264157u, 0, 4, NULL);
be_define_const_str(IBEACON_TX, "IBEACON_TX", 3471826977u, 0, 10, &be_const_str_lv_label);
be_define_const_str(lv_label, "lv_label", 4199664246u, 0, 8, &be_const_str_web_send_decimal);
...
be_define_const_str(ROT1B_NP, "ROT1B_NP", 3710079736u, 0, 8, &be_const_str_SYMBOL_SETTINGS);
be_define_const_str(SYMBOL_SETTINGS, "SYMBOL_SETTINGS", 339656335u, 0, 15, &be_const_str_exec_cmd);
...
be_define_const_str(SYMBOL_DUMMY, "SYMBOL_DUMMY", 3621732138u, 0, 12, &be_const_str_SYMBOL_EJECT);
be_define_const_str(SYMBOL_EJECT, "SYMBOL_EJECT", 873760647u, 0, 12, &be_const_str_SYMBOL_POWER);
...
be_define_const_str(SYMBOL_BATTERY_EMPTY, "SYMBOL_BATTERY_EMPTY", 3945064277u, 0, 20, &be_const_str_fromstring);
be_define_const_str(fromstring, "fromstring", 610302344u, 0, 10, &be_const_str_pi);
...
be_define_const_str(SR04_ECHO, "SR04_ECHO", 1906909592u, 0, 9, &be_const_str_lv_spinner);
...
be_define_const_str(INPUT, "INPUT", 1638025307u, 0, 5, &be_const_str_SPI_DC);
...
be_define_const_str(SPI_MISO, "SPI_MISO", 150818010u, 0, 8, &be_const_str_SYMBOL_SD_CARD);
be_define_const_str(SYMBOL_SD_CARD, "SYMBOL_SD_CARD", 2542376484u, 0, 14, NULL);
be_define_const_str(KEY1, "KEY1", 6715975u, 0, 4, &be_const_str_SYMBOL_BELL);
be_define_const_str(SYMBOL_BELL, "SYMBOL_BELL", 1736196487u, 0, 11, NULL);
be_define_const_str(SYMBOL_BATTERY_1, "SYMBOL_BATTERY_1", 629036063u, 0, 16, &be_const_str_add_driver);
...
be_define_const_str(_begin_transmission, "_begin_transmission", 2779461176u, 0, 19, &be_const_str_web_sensor);
...
be_define_const_str(SYMBOL_FILE, "SYMBOL_FILE", 237085260u, 0, 11, &be_const_str__cb);
...
be_define_const_str(SPI_MOSI, "SPI_MOSI", 2494218614u, 0, 8, &be_const_str_lv_led);
be_define_const_str(lv_led, "lv_led", 3192184733u, 0, 6, NULL);
be_define_const_str(SYMBOL_WARNING, "SYMBOL_WARNING", 4119913686u, 0, 14, &be_const_str_print);
