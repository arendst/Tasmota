be_define_const_str(CNTR1_NP, "CNTR1_NP", 4288381648u, 0, 8, &be_const_str_digital_read);
be_define_const_str(digital_read, "digital_read", 3585496928u, 0, 12, NULL);
be_define_const_str(MP3_DFR562, "MP3_DFR562", 2859952977u, 0, 10, &be_const_str_get_option);
...
be_define_const_str(ADC_PH, "ADC_PH", 3820290594u, 0, 6, &be_const_str_PMS5003_RX);
...
be_define_const_str(HPMA_RX, "HPMA_RX", 3462528998u, 0, 7, &be_const_str_SYMBOL_LIST);
be_define_const_str(SYMBOL_LIST, "SYMBOL_LIST", 70793990u, 0, 11, &be_const_str_asin);
be_define_const_str(asin, "asin", 4272848550u, 0, 4, NULL);
be_define_const_str(OLED_RESET, "OLED_RESET", 4048987655u, 0, 10, &be_const_str_exec_cmd);
...
be_define_const_str(ROT1B_NP, "ROT1B_NP", 3710079736u, 0, 8, &be_const_str_SR04_ECHO);
...
be_define_const_str(SDS0X1_RX, "SDS0X1_RX", 1170717385u, 0, 9, &be_const_str_SYMBOL_DIRECTORY);
be_define_const_str(SYMBOL_DIRECTORY, "SYMBOL_DIRECTORY", 1886053449u, 0, 16, NULL);
be_define_const_str(opt_call, "()", 685372826u, 0, 2, &be_const_str_ST7789_CS);
be_define_const_str(ST7789_CS, "ST7789_CS", 2937305434u, 0, 9, &be_const_str_SYMBOL_CHARGE);
be_define_const_str(SYMBOL_CHARGE, "SYMBOL_CHARGE", 2106391946u, 0, 13, NULL);
be_define_const_str(BUZZER, "BUZZER", 1550039611u, 0, 6, &be_const_str_SSPI_CS);
be_define_const_str(SSPI_CS, "SSPI_CS", 977784795u, 0, 7, NULL);
be_define_const_str(NRG_SEL, "NRG_SEL", 1771358125u, 0, 7, &be_const_str_type);
...
be_define_const_str(Driver, "Driver", 3576386303u, 0, 6, &be_const_str_MAX31855CLK);
be_define_const_str(MAX31855CLK, "MAX31855CLK", 715977727u, 0, 11, &be_const_str_add_cmd);
be_define_const_str(add_cmd, "add_cmd", 3361630879u, 0, 7, &be_const_str_lv_color);
be_define_const_str(lv_color, "lv_color", 1419148319u, 0, 8, NULL);
be_define_const_str(ADC_TEMP, "ADC_TEMP", 3771053440u, 0, 8, &be_const_str_OPTION_A);
be_define_const_str(OPTION_A, "OPTION_A", 1133299440u, 0, 8, &be_const_str_WEBCAM_RESET);
be_define_const_str(WEBCAM_RESET, "WEBCAM_RESET", 2171221520u, 0, 12, &be_const_str_lv_list);
...
be_define_const_str(MAX7219CS, "MAX7219CS", 2593198244u, 0, 9, &be_const_str_SYMBOL_PLAY);
be_define_const_str(SYMBOL_PLAY, "SYMBOL_PLAY", 1750902100u, 0, 11, NULL);
be_define_const_str(SYMBOL_HOME, "SYMBOL_HOME", 730845525u, 0, 11, &be_const_str_lv_keyboard);
be_define_const_str(lv_keyboard, "lv_keyboard", 197530229u, 0, 11, NULL);
be_define_const_str(SYMBOL_EDIT, "SYMBOL_EDIT", 1396182822u, 0, 11, &be_const_str_lv_label);
be_define_const_str(lv_label, "lv_label", 4199664246u, 0, 8, &be_const_str_name);
...
be_define_const_str(ADC_RANGE, "ADC_RANGE", 3467329543u, 0, 9, &be_const_str_KEY1);
be_define_const_str(KEY1, "KEY1", 6715975u, 0, 4, &be_const_str_WE517_RX);
...
be_define_const_str(OUTPUT_LO, "OUTPUT_LO", 3724620328u, 0, 9, &be_const_str_PZEM0XX_TX);
be_define_const_str(PZEM0XX_TX, "PZEM0XX_TX", 944775704u, 0, 10, &be_const_str_SSPI_DC);
be_define_const_str(SSPI_DC, "SSPI_DC", 1782271864u, 0, 7, &be_const_str_SYMBOL_USB);
be_define_const_str(SYMBOL_USB, "SYMBOL_USB", 1962656552u, 0, 10, &be_const_str_insert);
be_define_const_str(insert, "insert", 3332609576u, 0, 6, NULL);
be_define_const_str(SAIR_RX, "SAIR_RX", 1273688713u, 0, 7, NULL);
be_define_const_str(SYMBOL_CUT, "SYMBOL_CUT", 3455112394u, 0, 10, &be_const_str_lower);
be_define_const_str(lower, "lower", 3038577850u, 0, 5, NULL);
be_define_const_str(RFSEND, "RFSEND", 1862630731u, 0, 6, NULL);
be_define_const_str(RA8876_CS, "RA8876_CS", 2529944108u, 0, 9, &be_const_str_size);
...
be_define_const_str(WIEGAND_D0, "WIEGAND_D0", 4192335759u, 0, 10, &be_const_str_start);
be_define_const_str(start, "start", 1697318111u, 0, 5, NULL);
be_define_const_str(DDSU666_RX, "DDSU666_RX", 1812507936u, 0, 10, NULL);
be_define_const_str(resize, "resize", 3514612129u, 0, 6, NULL);
be_define_const_str(detect, "detect", 8884370u, 0, 6, NULL);
be_define_const_str(A4988_MS1, "A4988_MS1", 1729976611u, 0, 9, &be_const_str_RC522_RST);
be_define_const_str(RC522_RST, "RC522_RST", 720511443u, 0, 9, NULL);
be_define_const_str(count, "count", 967958004u, 0, 5, NULL);
be_define_const_str(LMT01, "LMT01", 2490623797u, 0, 5, &be_const_str_lv_font);
be_define_const_str(lv_font, "lv_font", 1550958453u, 0, 7, NULL);
be_define_const_str(BACKLIGHT, "BACKLIGHT", 3147761926u, 0, 9, &be_const_str_SPI_CLK);
...
be_define_const_str(attrdump, "attrdump", 1521571304u, 0, 8, &be_const_str_break);
...
be_define_const_str(lv_group, "lv_group", 3852039019u, 0, 8, &be_const_str_time_dump);
be_define_const_str(time_dump, "time_dump", 3330410747u, 0, 9, NULL);
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_get_light);
...
be_define_const_str(NRG_CF1, "NRG_CF1", 3292534757u, 0, 7, &be_const_str__ccmd);
be_define_const_str(_ccmd, "_ccmd", 2163421413u, 0, 5, &be_const_str_tostring);
be_define_const_str(tostring, "tostring", 2299708645u, 0, 8, NULL);
be_define_const_str(AS608_TX, "AS608_TX", 48630934u, 0, 8, &be_const_str_HRXL_RX);
be_define_const_str(HRXL_RX, "HRXL_RX", 92702006u, 0, 7, &be_const_str_IRRECV);
be_define_const_str(IRRECV, "IRRECV", 1743648982u, 0, 6, &be_const_str_item);
be_define_const_str(item, "item", 2671260646u, 0, 4, &be_const_str_lv_win);
...
be_define_const_str(SYMBOL_SAVE, "SYMBOL_SAVE", 2439821015u, 0, 11, &be_const_str_upper);
...
be_define_const_str(ZIGBEE_TX, "ZIGBEE_TX", 25119256u, 0, 9, &be_const_str_wire_scan);
...
be_define_const_str(TASMOTACLIENT_RXD, "TASMOTACLIENT_RXD", 72868318u, 0, 17, &be_const_str_wire2);
...
be_define_const_str(ILI9341_CS, "ILI9341_CS", 3519318851u, 0, 10, &be_const_str_SM16716_SEL);
be_define_const_str(SM16716_SEL, "SM16716_SEL", 142377379u, 0, 11, NULL);
be_define_const_str(TASMOTACLIENT_TXD, "TASMOTACLIENT_TXD", 1386193940u, 0, 17, &be_const_str_copy);
...
be_define_const_str(BS814_CLK, "BS814_CLK", 3002713336u, 0, 9, &be_const_str__begin_transmission);
be_define_const_str(_begin_transmission, "_begin_transmission", 2779461176u, 0, 19, &be_const_str_imin);
be_define_const_str(imin, "imin", 2714127864u, 0, 4, NULL);
be_define_const_str(every_second, "every_second", 2075451465u, 0, 12, &be_const_str_open);
...
be_define_const_str(SYMBOL_TRASH, "SYMBOL_TRASH", 3169100368u, 0, 12, &be_const_str_log10);
be_define_const_str(log10, "log10", 2346846000u, 0, 5, &be_const_str_remove_rule);
...
be_define_const_str(LED1, "LED1", 21005825u, 0, 4, &be_const_str_tolower);
be_define_const_str(tolower, "tolower", 1042520049u, 0, 7, NULL);
be_define_const_str(classof, "classof", 1796577762u, 0, 7, NULL);
be_define_const_str(opt_neq, "!=", 2428715011u, 0, 2, &be_const_str_AZ_RXD);
be_define_const_str(AZ_RXD, "AZ_RXD", 699914019u, 0, 6, &be_const_str_init);
be_define_const_str(init, "init", 380752755u, 0, 4, NULL);
be_define_const_str(SPI_CS, "SPI_CS", 553701236u, 0, 6, &be_const_str_Tasmota);
...
be_define_const_str(display, "display", 1164572437u, 0, 7, &be_const_str_read_bytes);
...
be_define_const_str(lv_arc, "lv_arc", 4170125384u, 0, 6, &be_const_str_false);
...
be_define_const_str(I2C_SCL, "I2C_SCL", 164217098u, 0, 7, &be_const_str_SYMBOL_DOWNLOAD);
...
be_define_const_str(RISING, "RISING", 1256404539u, 0, 6, &be_const_str_digital_write);
be_define_const_str(digital_write, "digital_write", 3435877979u, 0, 13, NULL);
be_define_const_str(ADC_JOY, "ADC_JOY", 1116943612u, 0, 7, &be_const_str_time_str);
be_define_const_str(time_str, "time_str", 2613827612u, 0, 8, NULL);
be_define_const_str(DYP_RX, "DYP_RX", 2122310285u, 0, 6, &be_const_str_ETH_PHY_MDC);
be_define_const_str(ETH_PHY_MDC, "ETH_PHY_MDC", 1519379581u, 0, 11, &be_const_str_LEDLNK);
be_define_const_str(LEDLNK, "LEDLNK", 2862810701u, 0, 6, &be_const_str_LEDLNK_INV);
be_define_const_str(LEDLNK_INV, "LEDLNK_INV", 3559015101u, 0, 10, &be_const_str_lv_obj);
be_define_const_str(lv_obj, "lv_obj", 4257833149u, 0, 6, &be_const_str_push);
be_define_const_str(push, "push", 2272264157u, 0, 4, &be_const_str_set_power);
...
be_define_const_str(DHT22, "DHT22", 215937903u, 0, 5, &be_const_str_SYMBOL_UPLOAD);
...
be_define_const_str(TX2X_TXD_BLACK, "TX2X_TXD_BLACK", 956526176u, 0, 14, &be_const_str_asstring);
be_define_const_str(asstring, "asstring", 1298225088u, 0, 8, NULL);
be_define_const_str(ADC_BUTTON, "ADC_BUTTON", 3393454690u, 0, 10, &be_const_str_format);
...
be_define_const_str(RF_SENSOR, "RF_SENSOR", 2289628100u, 0, 9, &be_const_str_SYMBOL_SD_CARD);
be_define_const_str(SYMBOL_SD_CARD, "SYMBOL_SD_CARD", 2542376484u, 0, 14, NULL);
be_define_const_str(TASMOTACLIENT_RST_INV, "TASMOTACLIENT_RST_INV", 2601785365u, 0, 21, &be_const_str_pow);
be_define_const_str(pow, "pow", 1479764693u, 0, 3, NULL);
be_define_const_str(PULLDOWN, "PULLDOWN", 1853074086u, 0, 8, &be_const_str_SPI_MOSI);
...
be_define_const_str(SYMBOL_RIGHT, "SYMBOL_RIGHT", 2984010648u, 0, 12, &be_const_str_rad);
...
be_define_const_str(MHZ_TXD, "MHZ_TXD", 3310158233u, 0, 7, &be_const_str_RXD);
be_define_const_str(RXD, "RXD", 2311579049u, 0, 3, &be_const_str_bus);
be_define_const_str(bus, "bus", 1607822841u, 0, 3, NULL);
be_define_const_str(NRF24_CS, "NRF24_CS", 555833194u, 0, 8, &be_const_str_PWM1);
be_define_const_str(PWM1, "PWM1", 1353352426u, 0, 4, &be_const_str_PZEM004_RX);
be_define_const_str(PZEM004_RX, "PZEM004_RX", 3411153194u, 0, 10, NULL);
be_define_const_str(EPAPER42_CS, "EPAPER42_CS", 3274717451u, 0, 11, &be_const_str_SSD1331_DC);
be_define_const_str(SSD1331_DC, "SSD1331_DC", 3386560859u, 0, 10, &be_const_str_abs);
be_define_const_str(abs, "abs", 709362235u, 0, 3, &be_const_str_assert);
be_define_const_str(assert, "assert", 2774883451u, 0, 6, NULL);
be_define_const_str(OUTPUT_OPEN_DRAIN, "OUTPUT_OPEN_DRAIN", 2147249436u, 0, 17, &be_const_str_SYMBOL_PAUSE);
be_define_const_str(SYMBOL_PAUSE, "SYMBOL_PAUSE", 641998172u, 0, 12, NULL);
be_define_const_str(DSB_OUT, "DSB_OUT", 732335085u, 0, 7, &be_const_str_NRG_SEL_INV);
be_define_const_str(NRG_SEL_INV, "NRG_SEL_INV", 3567431069u, 0, 11, NULL);
be_define_const_str(HLW_CF, "HLW_CF", 3982619486u, 0, 6, NULL);
be_define_const_str(REL1, "REL1", 3142397887u, 0, 4, &be_const_str_TCP_RX);
be_define_const_str(TCP_RX, "TCP_RX", 3904354751u, 0, 6, &be_const_str_acos);
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_atan);
be_define_const_str(atan, "atan", 108579519u, 0, 4, NULL);
be_define_const_str(AS608_RX, "AS608_RX", 4275502016u, 0, 8, &be_const_str_HPMA_TX);
be_define_const_str(HPMA_TX, "HPMA_TX", 173233104u, 0, 7, &be_const_str_pop);
be_define_const_str(pop, "pop", 1362321360u, 0, 3, &be_const_str_str);
be_define_const_str(str, "str", 3259748752u, 0, 3, &be_const_str_for);
be_define_const_str(for, "for", 2901640080u, 54, 3, NULL);
be_define_const_str(SYMBOL_VOLUME_MID, "SYMBOL_VOLUME_MID", 158835057u, 0, 17, &be_const_str_TM1638STB);
be_define_const_str(TM1638STB, "TM1638STB", 823674593u, 0, 9, &be_const_str_collect);
be_define_const_str(collect, "collect", 2399039025u, 0, 7, &be_const_str_setmember);
be_define_const_str(setmember, "setmember", 1432909441u, 0, 9, NULL);
be_define_const_str(addr, "addr", 1087856498u, 0, 4, &be_const_str_isinstance);
be_define_const_str(isinstance, "isinstance", 3669352738u, 0, 10, &be_const_str_range);
be_define_const_str(range, "range", 4208725202u, 0, 5, NULL);
be_define_const_str(dot_p, ".p", 1171526419u, 0, 2, &be_const_str_split);
...
be_define_const_str(DSB, "DSB", 98073254u, 0, 3, &be_const_str___lower__);
...
be_define_const_str(SSD1331_CS, "SSD1331_CS", 4191047928u, 0, 10, &be_const_str_publish);
...
be_define_const_str(int, "int", 2515107422u, 0, 3, &be_const_str_register_button_encoder);
...
be_define_const_str(IRSEND, "IRSEND", 184848336u, 0, 6, &be_const_str__end_transmission);
be_define_const_str(_end_transmission, "_end_transmission", 3237480400u, 0, 17, &be_const_str_lv_roller);
be_define_const_str(lv_roller, "lv_roller", 661902064u, 0, 9, &be_const_str_except);
be_define_const_str(except, "except", 950914032u, 69, 6, NULL);
be_define_const_str(RFRECV, "RFRECV", 354742801u, 0, 6, &be_const_str_SSD1351_DC);
be_define_const_str(SSD1351_DC, "SSD1351_DC", 84950353u, 0, 10, &be_const_str_SYMBOL_REFRESH);
be_define_const_str(SYMBOL_REFRESH, "SYMBOL_REFRESH", 1266229761u, 0, 14, NULL);
be_define_const_str(DEEPSLEEP, "DEEPSLEEP", 189922226u, 0, 9, &be_const_str_WS2812);
...
be_define_const_str(I2C_SDA, "I2C_SDA", 1052592262u, 0, 7, &be_const_str_MAX7219CLK);
be_define_const_str(MAX7219CLK, "MAX7219CLK", 963568838u, 0, 10, &be_const_str_MIEL_HVAC_TX);
be_define_const_str(MIEL_HVAC_TX, "MIEL_HVAC_TX", 567403014u, 0, 12, &be_const_str_SYMBOL_WARNING);
...
be_define_const_str(lv_indev, "lv_indev", 225602374u, 0, 8, &be_const_str_lv_msgbox);
be_define_const_str(lv_msgbox, "lv_msgbox", 689085206u, 0, 9, &be_const_str_reverse_gamma10);
...
be_define_const_str(EPD_DATA, "EPD_DATA", 3799141097u, 0, 8, &be_const_str_SSPI_MOSI);
be_define_const_str(SSPI_MOSI, "SSPI_MOSI", 3745917497u, 0, 9, &be_const_str_TUYA_TX);
be_define_const_str(TUYA_TX, "TUYA_TX", 1541301465u, 0, 7, &be_const_str_lv_checkbox);
...
be_define_const_str(SM16716_DAT, "SM16716_DAT", 1905621806u, 0, 11, &be_const_str_TM1638DIO);
be_define_const_str(TM1638DIO, "TM1638DIO", 1408212414u, 0, 9, &be_const_str__cmd);
be_define_const_str(_cmd, "_cmd", 3419822142u, 0, 4, &be_const_str_calldepth);
...
be_define_const_str(SDCARD_CS, "SDCARD_CS", 3348952003u, 0, 9, &be_const_str_add_driver);
...
be_define_const_str(SHELLY_DIMMER_BOOT0, "SHELLY_DIMMER_BOOT0", 2948777716u, 0, 19, &be_const_str__timers);
...
be_define_const_str(INPUT_PULLUP, "INPUT_PULLUP", 2912931654u, 0, 12, &be_const_str_OUTPUT_HI);
be_define_const_str(OUTPUT_HI, "OUTPUT_HI", 3153592902u, 0, 9, NULL);
be_define_const_str(HJL_CF, "HJL_CF", 786158487u, 0, 6, NULL);
be_define_const_str(WEBCAM_HSD, "WEBCAM_HSD", 2648502504u, 0, 10, &be_const_str_ceil);
be_define_const_str(ceil, "ceil", 1659167240u, 0, 4, &be_const_str_set_light);
be_define_const_str(set_light, "set_light", 3176076152u, 0, 9, NULL);
be_define_const_str(srand, "srand", 465518633u, 0, 5, NULL);
be_define_const_str(WEBCAM_SIOD, "WEBCAM_SIOD", 302703242u, 0, 11, &be_const_str_save_before_restart);
...
be_define_const_str(SYMBOL_MUTE, "SYMBOL_MUTE", 563116043u, 0, 11, &be_const_str_input);
be_define_const_str(input, "input", 4191711099u, 0, 5, NULL);
be_define_const_str(WINDMETER_SPEED, "WINDMETER_SPEED", 1980822204u, 0, 15, &be_const_str_write);
be_define_const_str(write, "write", 3190202204u, 0, 5, NULL);
be_define_const_str(char, "char", 2823553821u, 0, 4, &be_const_str_get_free_heap);
be_define_const_str(get_free_heap, "get_free_heap", 625069757u, 0, 13, &be_const_str_lv_bar);
be_define_const_str(lv_bar, "lv_bar", 1582673229u, 0, 6, NULL);
be_define_const_str(ADC_LIGHT, "ADC_LIGHT", 3982461502u, 0, 9, &be_const_str_lv_calendar);
...
be_define_const_str(LE01MR_TX, "LE01MR_TX", 1589687023u, 0, 9, &be_const_str_SYMBOL_BATTERY_1);
be_define_const_str(SYMBOL_BATTERY_1, "SYMBOL_BATTERY_1", 629036063u, 0, 16, &be_const_str_event);
be_define_const_str(event, "event", 4264611999u, 0, 5, &be_const_str_class);
be_define_const_str(class, "class", 2872970239u, 57, 5, NULL);
be_define_const_str(AS3935, "AS3935", 603621745u, 0, 6, &be_const_str_WE517_TX);
be_define_const_str(WE517_TX, "WE517_TX", 2954817217u, 0, 8, NULL);
be_define_const_str(lv_tabview, "lv_tabview", 2109024786u, 0, 10, &be_const_str_lv_textarea);
be_define_const_str(lv_textarea, "lv_textarea", 2864635074u, 0, 11, &be_const_str_web_add_button);
...
be_define_const_str(ROT1A_NP, "ROT1A_NP", 2322706903u, 0, 8, &be_const_str_iter);
be_define_const_str(iter, "iter", 3124256359u, 0, 4, &be_const_str_lv_img);
be_define_const_str(lv_img, "lv_img", 2474052327u, 0, 6, NULL);
be_define_const_str(DCKI, "DCKI", 3846847480u, 0, 4, &be_const_str_IEM3000_RX);
be_define_const_str(IEM3000_RX, "IEM3000_RX", 1117811096u, 0, 10, &be_const_str_fromstring);
be_define_const_str(fromstring, "fromstring", 610302344u, 0, 10, NULL);
be_define_const_str(CC1101_GDO2, "CC1101_GDO2", 974166265u, 0, 11, &be_const_str_WEBCAM_PCLK);
be_define_const_str(WEBCAM_PCLK, "WEBCAM_PCLK", 3813770649u, 0, 11, &be_const_str__drivers);
...
be_define_const_str(INPUT_PULLDOWN, "INPUT_PULLDOWN", 1172232591u, 0, 14, &be_const_str_MAX31855CS);
be_define_const_str(MAX31855CS, "MAX31855CS", 753620511u, 0, 10, &be_const_str_SYMBOL_IMAGE);
be_define_const_str(SYMBOL_IMAGE, "SYMBOL_IMAGE", 815601151u, 0, 12, &be_const_str_return);
be_define_const_str(return, "return", 2246981567u, 60, 6, NULL);
be_define_const_str(CSE7761_RX, "CSE7761_RX", 65423248u, 0, 10, &be_const_str_write_bytes);
be_define_const_str(write_bytes, "write_bytes", 1227543792u, 0, 11, NULL);
be_define_const_str(pi, "pi", 1213090802u, 0, 2, NULL);
be_define_const_str(__upper__, "__upper__", 3612202883u, 0, 9, &be_const_str_load_font);
be_define_const_str(load_font, "load_font", 1875840019u, 0, 9, &be_const_str_set);
be_define_const_str(set, "set", 3324446467u, 0, 3, NULL);
be_define_const_str(PN532_TXD, "PN532_TXD", 3093418644u, 0, 9, &be_const_str_setitem);
be_define_const_str(setitem, "setitem", 1554834596u, 0, 7, NULL);
be_define_const_str(SDM72_TX, "SDM72_TX", 2042143269u, 0, 8, &be_const_str_TELEINFO_ENABLE);
...
be_define_const_str(WEBCAM_HREF, "WEBCAM_HREF", 3161890024u, 0, 11, &be_const_str_Wire);
be_define_const_str(Wire, "Wire", 1938276536u, 0, 4, &be_const_str_lv_cont);
...
be_define_const_str(KEY1_INV_NP, "KEY1_INV_NP", 3160558586u, 0, 11, &be_const_str_SYMBOL_DUMMY);
be_define_const_str(SYMBOL_DUMMY, "SYMBOL_DUMMY", 3621732138u, 0, 12, NULL);
be_define_const_str(SWT1_NP, "SWT1_NP", 4033043739u, 0, 7, &be_const_str_cmd);
be_define_const_str(cmd, "cmd", 4136785899u, 0, 3, NULL);
be_define_const_str(ARIRFRCV, "ARIRFRCV", 1120816444u, 0, 8, &be_const_str_NEOPOOL_TX);
be_define_const_str(NEOPOOL_TX, "NEOPOOL_TX", 2924925804u, 0, 10, &be_const_str_TELEINFO_RX);
be_define_const_str(TELEINFO_RX, "TELEINFO_RX", 1195717356u, 0, 11, &be_const_str_WIEGAND_D1);
...
be_define_const_str(DDS2382_RX, "DDS2382_RX", 432446462u, 0, 10, &be_const_str_ETH_PHY_POWER);
be_define_const_str(ETH_PHY_POWER, "ETH_PHY_POWER", 487529454u, 0, 13, &be_const_str_TM1638CLK);
be_define_const_str(TM1638CLK, "TM1638CLK", 3045182446u, 0, 9, &be_const_str_pin_mode);
...
be_define_const_str(OPEN_DRAIN, "OPEN_DRAIN", 677872608u, 0, 10, &be_const_str_WEBCAM_PSRCS);
be_define_const_str(WEBCAM_PSRCS, "WEBCAM_PSRCS", 624464864u, 0, 12, &be_const_str_lv_chart);
...
be_define_const_str(CSE7766_RX, "CSE7766_RX", 1546766819u, 0, 10, &be_const_str_SYMBOL_SHUFFLE);
be_define_const_str(SYMBOL_SHUFFLE, "SYMBOL_SHUFFLE", 1123310147u, 0, 14, NULL);
be_define_const_str(SSPI_MAX31865_CS1, "SSPI_MAX31865_CS1", 1256578724u, 0, 17, &be_const_str_continue);
...
be_define_const_str(delay, "delay", 1322381784u, 0, 5, &be_const_str_exp);
...
be_define_const_str(lv_slider, "lv_slider", 2274180781u, 0, 9, &be_const_str_lv_style);
be_define_const_str(lv_style, "lv_style", 4151611549u, 0, 8, NULL);
be_define_const_str(DHT11_OUT, "DHT11_OUT", 1645300734u, 0, 9, &be_const_str_SYMBOL_PLUS);
be_define_const_str(SYMBOL_PLUS, "SYMBOL_PLUS", 2860093262u, 0, 11, &be_const_str_WEBCAM_PWDN);
be_define_const_str(WEBCAM_PWDN, "WEBCAM_PWDN", 2219597454u, 0, 11, NULL);
be_define_const_str(HALLEFFECT, "HALLEFFECT", 3334305407u, 0, 10, &be_const_str_MHZ_RXD);
be_define_const_str(MHZ_RXD, "MHZ_RXD", 328619727u, 0, 7, &be_const_str_SAIR_TX);
be_define_const_str(SAIR_TX, "SAIR_TX", 268017311u, 0, 7, &be_const_str_sinh);
be_define_const_str(sinh, "sinh", 282220607u, 0, 4, NULL);
be_define_const_str(SWT1, "SWT1", 805224112u, 0, 4, &be_const_str_SYMBOL_EYE_CLOSE);
...
be_define_const_str(IBEACON_TX, "IBEACON_TX", 3471826977u, 0, 10, &be_const_str_SENSOR_END);
be_define_const_str(SENSOR_END, "SENSOR_END", 3512542657u, 0, 10, &be_const_str_SYMBOL_VIDEO);
...
be_define_const_str(CC1101_GDO0, "CC1101_GDO0", 940611027u, 0, 11, &be_const_str_PULLUP);
...
be_define_const_str(PROJECTOR_CTRL_RX, "PROJECTOR_CTRL_RX", 1542762460u, 0, 17, &be_const_str_every_100ms);
be_define_const_str(every_100ms, "every_100ms", 1546407804u, 0, 11, NULL);
be_define_const_str(sin, "sin", 3761252941u, 0, 3, &be_const_str_try_rule);
be_define_const_str(try_rule, "try_rule", 1986449405u, 0, 8, NULL);
be_define_const_str(SM2135_DAT, "SM2135_DAT", 2882726942u, 0, 10, &be_const_str_SYMBOL_CALL);
...
be_define_const_str(MCP39F5_TX, "MCP39F5_TX", 1332322047u, 0, 10, &be_const_str_SDM120_TX);
...
be_define_const_str(button_pressed, "button_pressed", 1694209616u, 0, 14, &be_const_str_number);
be_define_const_str(number, "number", 467038368u, 0, 6, NULL);
be_define_const_str(A4988_STP, "A4988_STP", 1622172049u, 0, 9, &be_const_str_MGC3130_RESET);
be_define_const_str(MGC3130_RESET, "MGC3130_RESET", 405013121u, 0, 13, &be_const_str_WEBCAM_XCLK);
...
be_define_const_str(exec_rules, "exec_rules", 1445221092u, 0, 10, &be_const_str_lv_switch);
...
be_define_const_str(pin_used, "pin_used", 4033854612u, 0, 8, &be_const_str_import);
be_define_const_str(import, "import", 288002260u, 66, 6, NULL);
be_define_const_str(true, "true", 1303515621u, 61, 4, NULL);
be_define_const_str(DDSU666_TX, "DDSU666_TX", 1880604150u, 0, 10, &be_const_str_SYMBOL_BULLET);
...
be_define_const_str(ADC_CT_POWER, "ADC_CT_POWER", 3382284599u, 0, 12, &be_const_str_SYMBOL_COPY);
be_define_const_str(SYMBOL_COPY, "SYMBOL_COPY", 4193681815u, 0, 11, &be_const_str_SYMBOL_UP);
be_define_const_str(SYMBOL_UP, "SYMBOL_UP", 3886401511u, 0, 9, &be_const_str_get);
be_define_const_str(get, "get", 1410115415u, 0, 3, &be_const_str_millis);
...
be_define_const_str(print, "print", 372738696u, 0, 5, &be_const_str_save);
...
be_define_const_str(BL0940_RX, "BL0940_RX", 2908993179u, 0, 9, &be_const_str_HRE_DATA);
...
be_define_const_str(SYMBOL_NEW_LINE, "SYMBOL_NEW_LINE", 2014334315u, 0, 15, &be_const_str_get_tasmota);
be_define_const_str(get_tasmota, "get_tasmota", 334356779u, 0, 11, NULL);
be_define_const_str(lv_imgbtn, "lv_imgbtn", 2402844429u, 0, 9, &be_const_str_lv_spinner);
be_define_const_str(lv_spinner, "lv_spinner", 3361501901u, 0, 10, NULL);
be_define_const_str(ADC_BUTTON_INV, "ADC_BUTTON_INV", 2027625326u, 0, 14, &be_const_str_try);
be_define_const_str(try, "try", 2887626766u, 68, 3, NULL);
be_define_const_str(SR04_TRIG, "SR04_TRIG", 68671263u, 0, 9, &be_const_str_SYMBOL_KEYBOARD);
...
be_define_const_str(get_power, "get_power", 3009799377u, 0, 9, &be_const_str_lv_objmask);
...
be_define_const_str(SOLAXX1_TX, "SOLAXX1_TX", 903770840u, 0, 10, &be_const_str_load_freetype_font);
be_define_const_str(load_freetype_font, "load_freetype_font", 2368447592u, 0, 18, NULL);
be_define_const_str(SYMBOL_BACKSPACE, "SYMBOL_BACKSPACE", 1997168681u, 0, 16, &be_const_str_SYMBOL_BATTERY_FULL);
be_define_const_str(SYMBOL_BATTERY_FULL, "SYMBOL_BATTERY_FULL", 2638935545u, 0, 19, &be_const_str_TCP_TX);
be_define_const_str(TCP_TX, "TCP_TX", 2762594089u, 0, 6, &be_const_str__write);
...
be_define_const_str(SYMBOL_EYE_OPEN, "SYMBOL_EYE_OPEN", 3449311676u, 0, 15, &be_const_str_SYMBOL_OK);
be_define_const_str(SYMBOL_OK, "SYMBOL_OK", 4033162940u, 0, 9, &be_const_str_chars_in_string);
be_define_const_str(chars_in_string, "chars_in_string", 3148785132u, 0, 15, &be_const_str_web_send_decimal);
...
be_define_const_str(CHANGE, "CHANGE", 4280911421u, 0, 6, &be_const_str_HIGH);
be_define_const_str(HIGH, "HIGH", 2066738941u, 0, 4, &be_const_str_as);
be_define_const_str(as, "as", 1579491469u, 67, 2, NULL);
be_define_const_str(ADC_INPUT, "ADC_INPUT", 2207556878u, 0, 9, &be_const_str_ZIGBEE_RX);
...
be_define_const_str(MIEL_HVAC_RX, "MIEL_HVAC_RX", 3720609648u, 0, 12, &be_const_str_find_op);
be_define_const_str(find_op, "find_op", 3766713376u, 0, 7, &be_const_str_lv_btn);
...
be_define_const_str(DHT11, "DHT11", 367083569u, 0, 5, &be_const_str_LOW);
be_define_const_str(LOW, "LOW", 3526092385u, 0, 3, &be_const_str_NRF24_DC);
be_define_const_str(NRF24_DC, "NRF24_DC", 688921313u, 0, 8, &be_const_str_map);
be_define_const_str(map, "map", 3751997361u, 0, 3, NULL);
be_define_const_str(SYMBOL_STOP, "SYMBOL_STOP", 2836505202u, 0, 11, NULL);
be_define_const_str(SDM72_RX, "SDM72_RX", 766750035u, 0, 8, &be_const_str_lv_linemeter);
be_define_const_str(lv_linemeter, "lv_linemeter", 1413069363u, 0, 12, &be_const_str_lv_page);
be_define_const_str(lv_page, "lv_page", 2373170067u, 0, 7, &be_const_str_elif);
be_define_const_str(elif, "elif", 3232090307u, 51, 4, NULL);
be_define_const_str(do, "do", 1646057492u, 65, 2, NULL);
be_define_const_str(lv_dropdown, "lv_dropdown", 2797165301u, 0, 11, &be_const_str_lv_tileview);
...
be_define_const_str(SI7021, "SI7021", 864377911u, 0, 6, &be_const_str_VL53L0X_XSHUT1);
...
be_define_const_str(A4988_ENA, "A4988_ENA", 1517502682u, 0, 9, &be_const_str_SPI_MISO);
be_define_const_str(SPI_MISO, "SPI_MISO", 150818010u, 0, 8, NULL);
be_define_const_str(NONE, "NONE", 1932136219u, 0, 4, NULL);
be_define_const_str(SYMBOL_BLUETOOTH, "SYMBOL_BLUETOOTH", 679376572u, 0, 16, &be_const_str_SYMBOL_FILE);
be_define_const_str(SYMBOL_FILE, "SYMBOL_FILE", 237085260u, 0, 11, NULL);
be_define_const_str(SYMBOL_VOLUME_MAX, "SYMBOL_VOLUME_MAX", 3582646093u, 0, 17, &be_const_str_floor);
be_define_const_str(floor, "floor", 3102149661u, 0, 5, NULL);
be_define_const_str(SYMBOL_DRIVE, "SYMBOL_DRIVE", 567203502u, 0, 12, &be_const_str_while);
