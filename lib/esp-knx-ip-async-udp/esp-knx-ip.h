...
#define MAX_CALLBACK_ASSIGNMENTS  20 // [Default 10] Maximum number of group address callbacks that can be stored
#define MAX_CALLBACKS             20 // [Default 10] Maximum number of callbacks that can be stored
