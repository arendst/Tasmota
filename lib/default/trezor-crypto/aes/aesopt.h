...
Issue Date: 20/12/2007
 ...
 AES bit sequence indexes map to higher numeric significance within bytes.
  ...
  struct trzr_aes_encrypt_ctx  (structure for the cipher encryption context)
  struct trzr_aes_decrypt_ctx  (structure for the cipher decryption context)
  ...
  AES_RETURN trzr_aes_encrypt(const unsigned char *in, unsigned char *out,
                                                  const trzr_aes_encrypt_ctx cx[1]);
  ...
  AES_RETURN trzr_aes_decrypt(const unsigned char *in, unsigned char *out,
                                                  const trzr_aes_decrypt_ctx cx[1]);
...
#if defined( ASM_X86_V1C ) && defined( trzr_aes_decrypt ) && !defined( ISB_SET )
#  define ISB_SET
#endif
