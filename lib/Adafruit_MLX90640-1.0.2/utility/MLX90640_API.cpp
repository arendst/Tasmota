...
#ifdef MLX90640_DEBUG
    Serial.print("ptatart = ");
    Serial.println(ptatArt);
#endif
...
#ifdef MLX90640_DEBUG
    Serial.print("KvPTAT: ");
    Serial.println(KvPTAT, 8);
    Serial.print("KtPTAT: ");
    Serial.println(KtPTAT);
    Serial.print("vPTAT25: ");
    Serial.println(vPTAT25);
    Serial.print("alphaPTAT: ");
    Serial.println(alphaPTAT);
#endif
}
...
#ifdef MLX90640_DEBUG
    Serial.print("ResolutionEE: ");
    Serial.println(resolutionEE);
#endif
}
...
void ExtractAlphaParameters(uint16_t *eeData, paramsMLX90640 *mlx90640) {
    ...
    Serial.println();
    Serial.print("alphascale: ");
    Serial.println(alphaScale);
#endif
}
...
void ExtractKtaPixelParameters(uint16_t *eeData, paramsMLX90640 *mlx90640) {
    ...
    Serial.println();
    Serial.print("ktascale: ");
    Serial.println(ktaScale1);
#endif
}
...
void ExtractKvPixelParameters(uint16_t *eeData, paramsMLX90640 *mlx90640) {
    ...
    Serial.println();
    Serial.print("kvscale: ");
    Serial.println(kvScale);
#endif
}
...
#ifdef MLX90640_DEBUG
    Serial.print("cpAlpha: ");
    Serial.print(alphaSP[0], 12);
    Serial.print(", ");
    Serial.println(alphaSP[1], 12);
    Serial.print("offsetSP: ");
    Serial.print(offsetSP[0]);
    Serial.print(", ");
    Serial.println(offsetSP[1]);
#endif
}
...
#ifdef MLX90640_DEBUG
    Serial.print("calibEE: ");
    Serial.println(calibrationModeEE);
    Serial.print("ilChess: ");
    Serial.print(ilChessC[0]);
    Serial.print(", ");
    Serial.print(ilChessC[1]);
    Serial.print(", ");
    Serial.println(ilChessC[2]);
#endif
}
...
int ExtractDeviatingPixels(uint16_t *eeData, paramsMLX90640 *mlx90640) {
    ...
    if (brokenPixCnt > 0) {
        ...
        warn = -3;
    } else if (outlierPixCnt > 0) {
        Serial.print("Outlier pixels: ");
        Serial.println(outlierPixCnt);
        warn = -4;
    } else if ((brokenPixCnt + outlierPixCnt) > 0) {
