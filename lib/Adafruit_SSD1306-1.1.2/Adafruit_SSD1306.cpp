...
Adafruit_SSD1306::Adafruit_SSD1306(int16_t width, int16_t height) :
...
void Adafruit_SSD1306::Updateframe() {
  display();
}
...
int16_t Adafruit_SSD1306::Begin(int16_t p1,int16_t p2,int16_t p3) {
  begin(p1,p2,p3);
}
