...
be_local_closure(LVGL_glob_make_cb,   /* name */
  be_nested_proto(
    ...
    /* K3   */  be_nested_str_weak(add_cb_event_closure),
    /* K4   */  be_nested_str_weak(_p),
    /* K5   */  be_nested_str_weak(get_event_cb),
    /* K6   */  be_nested_str_weak(lv_timer_cb),
    /* K7   */  be_nested_str_weak(timer_cb),
    /* K8   */  be_nested_str_weak(gen_cb),
    /* K9   */  be_const_int(0),
    /* K10  */  be_const_int(2),
    /* K11  */  be_nested_str_weak(lv_),
    /* K12  */  be_nested_str_weak(null_cb),
    /* K13  */  be_nested_str_weak(cb_do_nothing),
    }),
    be_str_weak(make_cb),
    &be_const_str_solidified,
    ( &(const binstruction[54]) {  /* code */
      ...
      0x7816000B,  //  0002  JMPF	R5	#000F
      0x8C140102,  //  0003  GETMET	R5	R0	K2
      0x5C1C0400,  //  0004  MOVE	R7	R2
      0x7C140400,  //  0005  CALL	R5	2
      0x8C140103,  //  0006  GETMET	R5	R0	K3
      0x881C0504,  //  0007  GETMBR	R7	R2	K4
...
be_local_class(LVGL_glob,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key_weak(create_custom_widget, 20), be_const_closure(LVGL_glob_create_custom_widget_closure) },
        { be_const_key_weak(widget_event_cb, -1), be_const_var(8) },
        { be_const_key_weak(event_cb, -1), be_const_var(2) },
        { be_const_key_weak(cb_do_nothing, 15), be_const_static_closure(LVGL_glob__anonymous__closure) },
        { be_const_key_weak(get_object_from_ptr, 9), be_const_closure(LVGL_glob_get_object_from_ptr_closure) },
        { be_const_key_weak(timer_cb, 22), be_const_var(3) },
        { be_const_key_weak(add_cb_event_closure, -1), be_const_closure(LVGL_glob_add_cb_event_closure_closure) },
        { be_const_key_weak(null_cb, -1), be_const_var(5) },
        ...
        { be_const_key_weak(init, -1), be_const_closure(LVGL_glob_init_closure) },
        { be_const_key_weak(register_obj, -1), be_const_closure(LVGL_glob_register_obj_closure) },
        { be_const_key_weak(get_event_cb, 10), be_const_closure(LVGL_glob_get_event_cb_closure) },
        { be_const_key_weak(lvgl_timer_dispatch, -1), be_const_closure(LVGL_glob_lvgl_timer_dispatch_closure) },
        { be_const_key_weak(make_cb, 14), be_const_closure(LVGL_glob_make_cb_closure) },
        { be_const_key_weak(widget_dtor_cb, 18), be_const_var(7) },
        ...
        { be_const_key_weak(cb_obj, -1), be_const_var(0) },
        { be_const_key_weak(deregister_obj, -1), be_const_closure(LVGL_glob_deregister_obj_closure) },
        { be_const_key_weak(widget_struct_by_class, 1), be_const_var(10) },
        { be_const_key_weak(widget_cb, 0), be_const_closure(LVGL_glob_widget_cb_closure) },
    })),
