...
const be_ntv_func_def_t lv_func[] = {
  ...
  { "theme_copy", { (const void*) &lv_theme_copy, "", "(lv.theme)(lv.theme)" } },
  { "theme_create", { (const void*) &lv_theme_create, "lv.theme", "" } },
  { "theme_delete", { (const void*) &lv_theme_delete, "", "(lv.theme)" } },
...
const be_const_member_t lv0_constants[] = {
    ...
    { "ARCLABEL_OVERFLOW_CLIP", be_cconst_int(LV_ARCLABEL_OVERFLOW_CLIP) },
    { "ARCLABEL_OVERFLOW_ELLIPSIS", be_cconst_int(LV_ARCLABEL_OVERFLOW_ELLIPSIS) },
    { "ARCLABEL_OVERFLOW_VISIBLE", be_cconst_int(LV_ARCLABEL_OVERFLOW_VISIBLE) },
    ...
    { "BLUR_QUALITY_AUTO", be_cconst_int(LV_BLUR_QUALITY_AUTO) },
    { "BLUR_QUALITY_PRECISION", be_cconst_int(LV_BLUR_QUALITY_PRECISION) },
    { "BLUR_QUALITY_SPEED", be_cconst_int(LV_BLUR_QUALITY_SPEED) },
    ...
    { "CHART_TYPE_CURVE", be_cconst_int(LV_CHART_TYPE_CURVE) },
    ...
    { "DRAW_TASK_TYPE_BLUR", be_cconst_int(LV_DRAW_TASK_TYPE_BLUR) },
    ...
    { "EVENT_STATE_CHANGED", be_cconst_int(LV_EVENT_STATE_CHANGED) },
    { "EVENT_STYLE_CHANGED", be_cconst_int(LV_EVENT_STYLE_CHANGED) },
    { "EVENT_TRIPLE_CLICKED", be_cconst_int(LV_EVENT_TRIPLE_CLICKED) },
    { "EVENT_UPDATE_LAYOUT_COMPLETED", be_cconst_int(LV_EVENT_UPDATE_LAYOUT_COMPLETED) },
    ...
    { "FS_RES_DRIVE_LETTER_ALREADY_USED", be_cconst_int(LV_FS_RES_DRIVE_LETTER_ALREADY_USED) },
    ...
    { "STATE_ALT", be_cconst_int(LV_STATE_ALT) },
    ...
    { "STYLE_BLUR_BACKDROP", be_cconst_int(LV_STYLE_BLUR_BACKDROP) },
    { "STYLE_BLUR_QUALITY", be_cconst_int(LV_STYLE_BLUR_QUALITY) },
    { "STYLE_BLUR_RADIUS", be_cconst_int(LV_STYLE_BLUR_RADIUS) },
    ...
    { "STYLE_DROP_SHADOW_COLOR", be_cconst_int(LV_STYLE_DROP_SHADOW_COLOR) },
    { "STYLE_DROP_SHADOW_OFFSET_X", be_cconst_int(LV_STYLE_DROP_SHADOW_OFFSET_X) },
    { "STYLE_DROP_SHADOW_OFFSET_Y", be_cconst_int(LV_STYLE_DROP_SHADOW_OFFSET_Y) },
    { "STYLE_DROP_SHADOW_OPA", be_cconst_int(LV_STYLE_DROP_SHADOW_OPA) },
    { "STYLE_DROP_SHADOW_QUALITY", be_cconst_int(LV_STYLE_DROP_SHADOW_QUALITY) },
    { "STYLE_DROP_SHADOW_RADIUS", be_cconst_int(LV_STYLE_DROP_SHADOW_RADIUS) },
