...
const be_const_member_t lv0_constants[] = {
    ...
    { "FT_FONT_STYLE_BOLD", LV_FT_FONT_STYLE_BOLD },
    { "FT_FONT_STYLE_ITALIC", LV_FT_FONT_STYLE_ITALIC },
    { "FT_FONT_STYLE_NORMAL", LV_FT_FONT_STYLE_NORMAL },
    ...
    { "GRID_FR", (int32_t) LV_GRID_FR(0) },
    { "GRID_TEMPLATE_LAST", LV_GRID_TEMPLATE_LAST },
    ...
    { "OBJ_FLAG_FLEX_IN_NEW_TRACK", LV_OBJ_FLAG_FLEX_IN_NEW_TRACK },
