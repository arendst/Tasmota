...
const be_ntv_func_def_t lv_obj_func[] = {
  ...
  { "get_local_style_prop", { (const void*) &lv_obj_get_local_style_prop, "i", "(lv.lv_obj)(lv.lv_style_prop)(lv.lv_style_value)i" } },
  ...
  { "get_style_prop", { (const void*) &lv_obj_get_style_prop, "i", "(lv.lv_obj)i(lv.lv_style_prop)" } },
  ...
  { "refresh_style", { (const void*) &lv_obj_refresh_style, "", "(lv.lv_obj)i(lv.lv_style_prop)" } },
  ...
  { "remove_local_style_prop", { (const void*) &lv_obj_remove_local_style_prop, "b", "(lv.lv_obj)(lv.lv_style_prop)i" } },
  ...
  { "set_local_style_prop", { (const void*) &lv_obj_set_local_style_prop, "", "(lv.lv_obj)(lv.lv_style_prop)ii" } },
