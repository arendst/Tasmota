...
const char HTTP_HEAD[] PROGMEM =
  ...
  "td{padding:0px;}"
  "button{border:0;border-radius:0.3rem;background-color:" WEB_BC1 ";color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%;-webkit-transition-duration:0.4s;transition-duration:0.4s;}"
  "button:hover{background-color:" WEB_BC2 ";}"
