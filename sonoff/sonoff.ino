...
enum TasmotaCommands {
  ...
  CMND_I2CSCAN, CMND_SERIALSEND, CMND_BAUDRATE, CMND_SERIALDELIMITER, CMND_TELEREFRESH };
...
const char kTasmotaCommands[] PROGMEM =
  ...
  D_CMND_I2CSCAN "|" D_CMND_SERIALSEND "|" D_CMND_BAUDRATE "|" D_CMND_SERIALDELIMITER "|" D_CMND_TELEREFRESH;
...
#endif  // USE_I2C
	else if (CMND_TELEREFRESH == command_code) {
      tele_period = Settings.tele_period -2;
	  // Now we let the 1 second tick run the telemetry as usual
	}
