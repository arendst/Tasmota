...
#ifdef USE_PZEM_004T
uint8_t PZEM_004T_flg =0;                      // power meter PZEM_004T use
#endif //USE_PZEM_004T
...
*/
      ...
      snprintf_P(mqtt_data, sizeof(mqtt_data), S_JSON_COMMAND_INDEX_NVALUE, command, index, (int)RtcSettings.pulse_counter[index -1]);
    }
...
//  AddLog(LOG_LEVEL_DEBUG);
  ...
  analogWriteFreq(Settings.pwm_frequency);   // Default is 1000 (core_esp8266_wiring_pwm.c)
#ifdef USE_PZEM_004T
  PZEM_004T_flg = ((pin[GPIO_PZEM004T_TX] < 99) && (pin[GPIO_PZEM004T_RX] < 99));
#endif //USE_PZEM_004T
