...
#define VERSION                0x02000900   // 2.0.9
    ...
    if (pw > sysCfg.hlw_mpl) {
      if (!hlw_mplh_counter) {
        ...
        if (!hlw_mplh_counter) {
          ...
          snprintf_P(svalue, sizeof(svalue), PSTR("%d%s"), pw, (sysCfg.mqtt_units) ? " W" : "");
          mqtt_publish(stopic, svalue);
          snprintf_P(svalue, sizeof(svalue), PSTR("light 0"));
          do_cmnd(svalue);
