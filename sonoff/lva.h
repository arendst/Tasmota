...
build_flags = ${common.build_flags} -D_LVA
...
\*****************************************************************************************************/
  ...
  //#define _LVA_DEBUG // включить отладку LVA внимание быдлокод
  ...
  #ifdef D_PROGRAMNAME
    #undef D_PROGRAMNAME
    #define D_PROGRAMNAME           "Sonoff-Tasmota+LVA"
  #endif
