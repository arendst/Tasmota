...
//    strncpy_P(mqtt_fulltopic, PSTR("%prefix%/%topic%/"), sizeof(mqtt_fulltopic));  // Make MQTT topic as short as possible to make this process posible within MQTT_MAX_PACKET_SIZE
  }
