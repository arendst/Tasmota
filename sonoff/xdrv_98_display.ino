...
#ifdef USE_DISPLAY
/*********************************************************************************************\
 * Model  Display          Libraries needed
 * -----  ---------------  ----------------------------------------
 *   1    I2C LCD          LiquidCrystal_I2C
 *   2    I2C SSD 1306     Adafruit_SSD1306 and Adafruit_GFX
 *   3    I2C 8x8 Matrix   Adafruit_LED_Backpack and Adafruit_GFX
 *   4    SPI TFT ILI9341  TasmotaTFT and Adafruit_GFX
 *   5    SPI TFT ILI9481  TasmotaTFT and Adafruit_GFX
\*********************************************************************************************/
