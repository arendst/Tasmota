...
#define D_CONFIGURE_HOME_ASSISTANT "Configure Home Assistant"
...
#define D_HOME_ASSISTANT_PARAMETERS "Home Assistant parameters"
#define D_HOME_ASSISTANT_DISCOVERY_ENABLE "Enable Discovery"
