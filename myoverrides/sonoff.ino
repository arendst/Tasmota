 ...
 */
  ...
  MQTT_server_start(MQTT_PORT, max_subscriptions, max_retained_topics);

/*
 * Subscribe to anything
 */
 //  Serial.println("Subscribe to anything");
//  MQTT_local_subscribe((unsigned char *)"stat/"MQTT_TOPIC"/RESULT", 0);
