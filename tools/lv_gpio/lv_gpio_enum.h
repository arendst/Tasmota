...
DISPLAY_RESET = GPIO_DISPLAY_RESET
OLED_RESET = GPIO_DISPLAY_RESET     // backward-compat alias
IRSEND = GPIO_IRSEND
IRRECV = GPIO_IRRECV
RFSEND = GPIO_RFSEND
RFRECV = GPIO_RFRECV
...
GM861_TX = GPIO_GM861_TX
GM861_RX = GPIO_GM861_RX
...
ADC_VOLTAGE = GPIO_ADC_VOLTAGE
ADC_CURRENT = GPIO_ADC_CURRENT

ASR650X_TX = GPIO_ASR650X_TX
ASR650X_RX = GPIO_ASR650X_RX

BL0906_RX = GPIO_BL0906_RX

BP1658CJ_CLK = GPIO_BP1658CJ_CLK
BP1658CJ_DAT = GPIO_BP1658CJ_DAT

DALI_RX = GPIO_DALI_RX
DALI_TX = GPIO_DALI_TX
DALI_RX_INV = GPIO_DALI_RX_INV
DALI_TX_INV = GPIO_DALI_TX_INV

DINGTIAN_CLK = GPIO_DINGTIAN_CLK
DINGTIAN_SDI = GPIO_DINGTIAN_SDI
DINGTIAN_Q7 = GPIO_DINGTIAN_Q7
DINGTIAN_PL = GPIO_DINGTIAN_PL
DINGTIAN_RCK = GPIO_DINGTIAN_RCK

HSDIO_CMD = GPIO_HSDIO_CMD
HSDIO_CLK = GPIO_HSDIO_CLK
HSDIO_RST = GPIO_HSDIO_RST
HSDIO_D0 = GPIO_HSDIO_D0
HSDIO_D1 = GPIO_HSDIO_D1
HSDIO_D2 = GPIO_HSDIO_D2
HSDIO_D3 = GPIO_HSDIO_D3

I2C_SER_TX = GPIO_I2C_SER_TX
I2C_SER_RX = GPIO_I2C_SER_RX

LD2402_TX = GPIO_LD2402_TX
LD2402_RX = GPIO_LD2402_RX

LD2410_TX = GPIO_LD2410_TX
LD2410_RX = GPIO_LD2410_RX

LD2410S_TX = GPIO_LD2410S_TX
LD2410S_RX = GPIO_LD2410S_RX

MBR_TX_ENA = GPIO_MBR_TX_ENA
NRG_MBS_TX_ENA = GPIO_NRG_MBS_TX_ENA
MBS_RX_ENA = GPIO_MBS_RX_ENA

MCP23XXX_INT = GPIO_MCP23XXX_INT
MCP23SXX_CS = GPIO_MCP23SXX_CS

MKSKYBLU_TX = GPIO_MKSKYBLU_TX
MKSKYBLU_RX = GPIO_MKSKYBLU_RX

PCF8574_INT = GPIO_PCF8574_INT

TM1640CLK = GPIO_TM1640CLK
TM1640DIN = GPIO_TM1640DIN

TWAI_TX = GPIO_TWAI_TX
TWAI_RX = GPIO_TWAI_RX
TWAI_BO = GPIO_TWAI_BO
TWAI_CLK = GPIO_TWAI_CLK

V9240_TX = GPIO_V9240_TX
V9240_RX = GPIO_V9240_RX

VID6608_F = GPIO_VID6608_F
VID6608_CW = GPIO_VID6608_CW
